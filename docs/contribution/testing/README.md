...
[End-to-end tests](https://github.com/poocommerce/poocommerce/tree/trunk/plugins/poocommerce/tests/e2e-pw) are powered by Playwright. The test site is spun up using `wp-env`.

## API testing

[API tests](https://github.com/poocommerce/poocommerce/tree/trunk/plugins/poocommerce/tests/e2e-pw/tests/api-tests) are part of the Playwright suite and use the same `wp-env` test environment as end-to-end tests.
