...
| Workflow | Trigger | What it does |
| -------- | ------- | ------------ |
| [Release: Release events proxy](https://github.com/poocommerce/poocommerce/blob/trunk/.github/workflows/release-release-events-proxy.yml) | Release published or prereleased | Delegates to [`release-new-release-published`](https://github.com/poocommerce/poocommerce/blob/trunk/.github/workflows/release-new-release-published.yml) to run post-release actions: sends Slack notifications, updates the global changelog for stable releases, bumps the minimum [security-support](/docs/contribution/releases/security-support) version when the release is the first of a new major version, and calls *Generate Number of Commits and Contributors* for beta releases. |
