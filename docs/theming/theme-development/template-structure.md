...
If you are a theme developer or using a theme with custom templates, you must declare PooCommerce theme support using the `add_theme_support` function. See [Declaring PooCommerce Support in Themes](/docs/theming/theme-development/classic-theme-developer-handbook/#declaring-poocommerce-support).
