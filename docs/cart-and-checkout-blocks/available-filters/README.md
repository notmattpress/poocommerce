...
This document lists the filters that are currently available to extensions and offers usage information for each one of them. Information on registering filters can be found on the [Checkout - Filter Registry](../../../plugins/poocommerce/client/blocks/packages/checkout/filter-registry/README.md) page.
