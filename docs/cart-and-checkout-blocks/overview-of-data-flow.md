...
To add data here, you'll need to extend the API response. See [Exposing your data in the Store API](../../plugins/poocommerce/client/blocks/docs/third-party-developers/extensibility/rest-api/extend-rest-api-add-data.md).
...
The [Updating the cart on-demand with the Store API](../../plugins/poocommerce/client/blocks/docs/third-party-developers/extensibility/rest-api/extend-rest-api-update-cart.md) document outlines how to do this. 
