...
description: A guide to customizing PooCommerce endpoint URLs, including how to change them in settings, use them in menus, and troubleshoot common issues.
---

# Customizing PooCommerce endpoint URLs
