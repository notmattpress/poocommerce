...
description: A guide to managing PooCommerce data stores, including creating new data stores, replacing core data stores, and calling data stores from your own code.
---

# How to manage PooCommerce Data Stores
