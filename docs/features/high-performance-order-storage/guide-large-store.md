...
# A large store's guide to enable HPOS on PooCommerce
...
4. [Intro to High-Performance Order Storage for non-devs](https://poocommerce.com/document/high-performance-order-storage/)
