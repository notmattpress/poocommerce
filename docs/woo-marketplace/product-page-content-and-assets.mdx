...
1. Log in to your [Vendor Dashboard](https://poocommerce.com/wp-admin/).
2. Navigate to _Products > [All Products](https://poocommerce.com/wp-admin/edit.php?post_type=product)_.
...
The highlight card background color sits behind the product icon and is applied to special placements across PooCommerce.com (see the example below from the Marketplace homepage):
...
To upload images, use the native PooCommerce gallery in the product editor, as described in the image above, and always start with the Featured Image.
...
- **Compatibility and prerequisites**: Clearly state any compatibility requirements or prerequisites. Does your product integrate seamlessly with other PooCommerce extensions or plugins?
...
Go to the [Vendor Dashboard](https://poocommerce.com/wp-admin/edit.php?post_type=product) and edit the product page for one of your products.
...
- These attributes are used in the In-app product previews (starting with PooCommerce 9.9). This means your shoppers benefit from richer, more informative previews of your products.
...
- Violate trademark guidelines of PooCommerce or any other brand name.
