...
We look forward to reviewing your extension, theme, or integration for listing in the PooCommerce.com Marketplace. Before getting started, make sure you have [signed up for a vendor account](https://poocommerce.com/partners/), and are logged into your [vendor dashboard](https://poocommerce.com/wp-admin/).
...
- **Trademark compliance**: Ensure that product names do not violate Woo's [trademark guidelines](https://poocommerce.com/trademark-guidelines/#sg-trademarks). Select a unique name that builds your brand and sets your product apart from others. [Review our product name guidelines](https://poocommerce.com/document/product-page-content-and-assets/#section-14).
...
- Products must support the two latest **major releases** of both [PooCommerce](https://wordpress.org/plugins/poocommerce/) and [WordPress](https://wordpress.org/download/).
- Products must adhere to foundational guidelines outlined in our [developer hub](https://developer.poocommerce.com/).
- If your pricing model is based on a standard, tiered monthly subscription, we require you to implement the [SaaS Billing API](https://poocommerce.com/document/billing-api-for-saas-products/). API keys and sandbox access are granted manually after products are submitted for Marketplace consideration.
...
- Ensure that your product's [critical flows](https://developer.poocommerce.com/testing-extensions-and-maintaining-quality-code/critical-flows/) have been thoroughly tested. See an example of [critical flows in the core PooCommerce plugin](https://developer.poocommerce.com/docs/contribution/testing/core-critical-flows/).
- Extensions must adhere to [development best practices](https://developer.poocommerce.com/docs/extensions/best-practices-extensions/extension-development-best-practices/) and [UX guidelines](https://developer.poocommerce.com/docs/extensions/ux-guidelines-extensions/).
- Themes must adhere to [theme development](https://developer.poocommerce.com/docs/theming/block-theme-development/theming-woo-blocks/), [design](https://developer.poocommerce.com/docs/user-experience-guidelines/ux-guidelines-themes/), and [UX guidelines](https://developer.poocommerce.com/docs/user-experience-guidelines/ux-guidelines-themes/).
...
- Does the product have a single core purpose and use PooCommerce features as much as possible?
...
- [Product Add-Ons](https://poocommerce.com/products/product-add-ons/)
- [Product Bundles](https://poocommerce.com/products/product-bundles/)
- [Min/Max Quantities](https://poocommerce.com/products/minmax-quantities/)
- [Shipment Tracking](https://poocommerce.com/products/shipment-tracking/)

</details>

<details>
<summary>Compatibility with core PooCommerce features</summary>

Visitors expect the PooCommerce.com Marketplace to be the leading source of extensions and themes for the optimal ecommerce experience. This means we only accept submissions which are compatible with the latest enhancements to the core PooCommerce platform and overall merchant experience.

[Review Woo's public roadmap](https://developer.poocommerce.com/roadmap/) for primary initiatives and expectations.

<details>
<summary>Block editor compatibility</summary>

As we evolve within the WordPress ecosystem, we're placing a strong emphasis on block editor compatibility for PooCommerce extensions. While we continue to support classic and hybrid approaches, prioritizing block editor compatibility ensures your extensions align with the latest trends and offer users a more intuitive and cohesive experience.

- **Cart and Checkout blocks**: The block-based Cart and Checkout is now the default experience in PooCommerce, offering a more streamlined and visually cohesive shopping experience. As a developer, prioritizing compatibility with these default blocks ensures your extensions and themes seamlessly integrate with the enhanced default shopping flow. [Review Cart and Checkout block architecture](https://developer.poocommerce.com/2023/09/18/architecture-of-cart-and-checkout-blocks/).
...
High-Performance Order Storage (HPOS) is the **default experience for new PooCommerce stores**. It moves order data from the WordPress post and postmeta tables to dedicated order tables to improve scalability and reliability.

:::info
**All new extension submissions must be HPOS-compatible.** View our [HPOS recipe book](https://developer.poocommerce.com/docs/hpos-extension-recipe-book/) for ways to support HPOS in your product.
:::
...
2. **Code review**: to ensure the submitted product's code is original, secure, and aligned with overall WordPress and PooCommerce quality standards.
