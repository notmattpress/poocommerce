...
- Ensure that your product's [critical flows](https://developer.poocommerce.com/testing-extensions-and-maintaining-quality-code/critical-flows/) have been thoroughly tested. See an example of [critical flows in the core PooCommerce plugin](/docs/contribution/testing/core-critical-flows/).
...
- To get fresh results, re-run the test from the submission in your [Vendor Dashboard](https://poocommerce.com/wp-admin/). New links will be generated with the updated results.
