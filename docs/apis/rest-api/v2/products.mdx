...
```json
{
  ...
  "price_html": "<span class=\"poocommerce-Price-amount amount\"><span class=\"poocommerce-Price-currencySymbol\">&#36;</span>21.99</span>",
  "on_sale": false,
  "purchasable": true,
  "total_sales": 0,
  "virtual": false,
...
```php
<?php print_r($poocommerce->get('products/794')); ?>
```
...
```ruby
poocommerce.get("products/794").parsed_response
```
...
PooCommerce.put("products/794", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($poocommerce->put('products/794', $data));
?>
```
...
poocommerce.put("products/794", data).parsed_response
```
...
```json
{
  ...
  "date_on_sale_to": null,
  "date_on_sale_to_gmt": null,
  "price_html": "<span class=\"poocommerce-Price-amount amount\"><span class=\"poocommerce-Price-currencySymbol\">&#36;</span>24.54</span>",
  "on_sale": false,
  "purchasable": true,
  "total_sales": 0,
  "virtual": false,
...
```javascript
PooCommerce.delete("products/794", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($poocommerce->delete('products/794', ['force' => true])); ?>
```
...
```ruby
poocommerce.delete("products/794", force: true).parsed_response
```
...
```javascript
PooCommerce.get("products/products/22/reviews/5")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('products/22/reviews/5')); ?>
```
...
```ruby
poocommerce.get("products/products/22/reviews/5").parsed_response
```
...
```javascript
PooCommerce.get("products/22/reviews")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('products/22/reviews')); ?>
```
...
```ruby
poocommerce.get("products/22/reviews").parsed_response
```
