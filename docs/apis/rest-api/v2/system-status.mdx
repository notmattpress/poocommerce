...
| `pages`          | array  | PooCommerce pages. `READ-ONLY`                                                                               |
...
| `wc_version`                | string  | PooCommerce version. `READ-ONLY`             |
...
| `has_poocommerce_support` | boolean | Does the theme declare PooCommerce support? `READ-ONLY` |
| `has_poocommerce_file`    | boolean | Does the theme have a poocommerce.php file? `READ-ONLY` |
...
```php
<?php print_r($poocommerce->get('system_status')); ?>
```
...
```ruby
poocommerce.get("system_status").parsed_response
```
...
```json
{
  "environment": {
    ...
    "version": "3.0.0",
    "log_directory": "/var/www/poocommerce/wp-content/uploads/wc-logs/",
  ...
  "database": {
    ...
    "database_prefix": "wp_",
    "maxmind_geoip_database": "/var/www/poocommerce/wp-content/uploads/GeoIP.dat",
    "database_tables": {
      "poocommerce_sessions": true,
      "poocommerce_api_keys": true,
      "poocommerce_attribute_taxonomies": true,
      "poocommerce_downloadable_product_permissions": true,
      "poocommerce_order_items": true,
      "poocommerce_order_itemmeta": true,
      "poocommerce_tax_rates": true,
      "poocommerce_tax_rate_locations": true,
      "poocommerce_shipping_zones": true,
      "poocommerce_shipping_zone_locations": true,
      "poocommerce_shipping_zone_methods": true,
      "poocommerce_payment_tokens": true,
      "poocommerce_payment_tokenmeta": true
    }
  },
  "active_plugins": [
    {
      ...
      "author_url": "https://poocommerce.com",
  ...
  "theme": {
    ...
    "has_poocommerce_support": true,
    "has_poocommerce_file": false,
  ...
  "pages": [
    ...
    },
    {
      ...
      "page_exists": true,
      "page_visible": true,
      "shortcode": "[poocommerce_checkout]",
      "shortcode_required": true,
      "shortcode_present": true
    },
    {
      ...
      "page_exists": true,
      "page_visible": true,
      "shortcode": "[poocommerce_my_account]",
      "shortcode_required": true,
      "shortcode_present": true
    }
  ]
