...
PooCommerce.post("products/attributes", data)
  .then((response) => {
...
print_r($poocommerce->post('products/attributes', $data));
?>
```
...
poocommerce.post("products/attributes", data).parsed_response
```
...
```javascript
PooCommerce.get("products/attributes/1")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('products/attributes/1')); ?>
```
...
```ruby
poocommerce.get("products/attributes/1").parsed_response
```
...
```javascript
PooCommerce.get("products/attributes")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('products/attributes')); ?>
```
...
```ruby
poocommerce.get("products/attributes").parsed_response
```
...
PooCommerce.put("products/attributes/1", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($poocommerce->put('products/attributes/1', $data));
?>
```
...
poocommerce.put("products/attributes/1", data).parsed_response
```
...
```javascript
PooCommerce.delete("products/attributes/1", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($poocommerce->delete('products/attributes/1', ['force' => true])); ?>
```
...
```ruby
poocommerce.delete("products/attributes/1", force: true).parsed_response
```
...
PooCommerce.post("products/attributes/batch", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($poocommerce->post('products/attributes/batch', $data));
?>
```
...
poocommerce.post("products/attributes/batch", data).parsed_response
```
