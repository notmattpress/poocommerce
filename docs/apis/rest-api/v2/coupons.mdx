...
print_r($poocommerce->post('coupons', $data));
?>
```
...
poocommerce.post("coupons", data).parsed_response
```
...
```php
<?php print_r($poocommerce->get('coupons/719')); ?>
```
...
```ruby
poocommerce.get("coupons/719").parsed_response
```
...
```php
<?php print_r($poocommerce->get('coupons')); ?>
```
...
```ruby
poocommerce.get("coupons").parsed_response
```
...
PooCommerce.put("coupons/719", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($poocommerce->put('coupons/719', $data)); 
?>
```
...
poocommerce.put("coupons/719", data).parsed_response
```
...
```javascript
PooCommerce.delete("coupons/719", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($poocommerce->delete('coupons/719', ['force' => true])); ?>
```
...
```ruby
poocommerce.delete("coupons/719", force: true).parsed_response
```
...
PooCommerce.post("coupons/batch", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($poocommerce->post('coupons/batch', $data));
?>
```
...
poocommerce.post("coupons/batch", data).parsed_response
```
