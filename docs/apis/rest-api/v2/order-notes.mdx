...
PooCommerce.post("orders/723/notes", data)
  .then((response) => {
...
print_r($poocommerce->post('orders/723/notes', $data));
?>
```
...
poocommerce.post("orders/723/notes", data).parsed_response
```
...
```javascript
PooCommerce.get("orders/723/notes/281")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('orders/723/notes/281')); ?>
```
...
```ruby
poocommerce.get("orders/723/notes/281").parsed_response
```
...
```javascript
PooCommerce.get("orders/723/notes")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('orders/723/notes')); ?>
```
...
```ruby
poocommerce.get("orders/723/notes").parsed_response
```
...
```javascript
PooCommerce.delete("orders/723/notes/281", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($poocommerce->delete('orders/723/notes/281', ['force' => true])); ?>
```
...
```ruby
poocommerce.delete("orders/723/notes/281", force: true).parsed_response
```
