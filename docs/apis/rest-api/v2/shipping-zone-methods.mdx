...
PooCommerce.post("shipping/zones/5/methods", data)
  .then((response) => {
...
print_r($poocommerce->post('shipping/zones/5/methods', $data));
?>
```
...
poocommerce.post("shipping/zones/5/methods", data).parsed_response
```
...
```javascript
PooCommerce.get("shipping/zones/5/methods/26")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('shipping/zones/5/methods/26')); ?>
```
...
```ruby
poocommerce.get("shipping/zones/5/methods/26").parsed_response
```
...
```javascript
PooCommerce.get("shipping/zones/5/methods")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('shipping/zones/5/methods')); ?>
```
...
```ruby
poocommerce.get("shipping/zones/5/methods").parsed_response
```
...
PooCommerce.put("shipping/zones/5/methods/26", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($poocommerce->put('shipping/zones/5/methods/26', $data));
?>
```
...
poocommerce.put("shipping/zones/5/methods/26", data).parsed_response
```
...
```javascript
PooCommerce.delete("shipping/zones/5/methods/26", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($poocommerce->delete('shipping/zones/5/methods/26', ['force' => true])); ?>
```
...
```ruby
poocommerce.delete("shipping/zones/5/methods/26", force: true).parsed_response
```
