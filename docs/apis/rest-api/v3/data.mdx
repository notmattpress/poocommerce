...
```php
<?php print_r($poocommerce->get('data')); ?>
```
...
```ruby
poocommerce.get("data").parsed_response
```
...
```javascript
PooCommerce.get( 'data/continents' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php
print_r($poocommerce->get('data/continents'));
?>
```
...
```ruby
poocommerce.get("data/continents").parsed_response
```
...
```javascript
PooCommerce.get( 'data/continents/eu' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php
print_r($poocommerce->get('data/continents/eu'));
?>
```
...
```ruby
poocommerce.get("data/continents/eu").parsed_response
```
...
```javascript
PooCommerce.get( 'data/countries' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php
print_r($poocommerce->get('data/countries'));
?>
```
...
```ruby
poocommerce.get("data/countries").parsed_response
```
...
```javascript
PooCommerce.get( 'data/countries/br' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php
print_r($poocommerce->get('data/countries/br'));
?>
```
...
```ruby
poocommerce.get("data/countries/br").parsed_response
```
...
```javascript
PooCommerce.get( 'data/currencies' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php
print_r($poocommerce->get('data/currencies'));
?>
```
...
```ruby
poocommerce.get("data/currencies").parsed_response
```
...
```javascript
PooCommerce.get( 'data/currencies/brl' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php
print_r($poocommerce->get('data/currencies/brl'));
?>
```
...
```ruby
poocommerce.get("data/currencies/brl").parsed_response
```
...
```javascript
PooCommerce.get( 'data/currencies/current' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php
print_r($poocommerce->get('data/currencies/current'));
?>
```
...
```ruby
poocommerce.get("data/currencies/current").parsed_response
```
