...
PooCommerce.post( 'shipping/zones', data )
	.then( ( response ) => {
...
print_r($poocommerce->post('shipping/zones', $data));
?>
```
...
poocommerce.post("shipping/zones", data).parsed_response
```
...
```javascript
PooCommerce.get( 'shipping/zones/5' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php print_r($poocommerce->get('shipping/zones/5')); ?>
```
...
```ruby
poocommerce.get("shipping/zones/5").parsed_response
```
...
```javascript
PooCommerce.get( 'shipping/zones' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php print_r($poocommerce->get('shipping/zones')); ?>
```
...
```ruby
poocommerce.get("shipping/zones").parsed_response
```
...
PooCommerce.put( 'shipping/zones/5', data )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
print_r($poocommerce->put('shipping/zones/5', $data));
?>
```
...
poocommerce.put("shipping/zones/5", data).parsed_response
```
...
```javascript
PooCommerce.delete( 'shipping/zones/5', {
	force: true,
} )
	.then( ( response ) => {
		console.log( response.data );
...
```php
<?php print_r($poocommerce->delete('shipping/zones/5', ['force' => true])); ?>
```
...
```ruby
poocommerce.delete("shipping/zones/5", force: true).parsed_response
```
