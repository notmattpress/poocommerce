...
```php
<?php print_r($poocommerce->get('reports')); ?>
```
...
```ruby
poocommerce.get("reports").parsed_response
```
...
print_r($poocommerce->get('reports/sales', $query));
?>
```
...
poocommerce.get("reports/sales", query).parsed_response
```
...
```javascript
PooCommerce.get( 'reports/top_sellers', {
	period: 'last_month',
} )
	.then( ( response ) => {
		console.log( response.data );
...
print_r($poocommerce->get('reports/top_sellers', $query));
?>
```
...
poocommerce.get("reports/top_sellers", query).parsed_response
```
...
```javascript
PooCommerce.get( 'reports/coupons/totals' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php
print_r($poocommerce->get('reports/coupons/totals'));
?>
```
...
```ruby
poocommerce.get("reports/coupons/totals").parsed_response
```
...
```javascript
PooCommerce.get( 'reports/customers/totals' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php
print_r($poocommerce->get('reports/customers/totals'));
?>
```
...
```ruby
poocommerce.get("reports/customers/totals").parsed_response
```
...
```javascript
PooCommerce.get( 'reports/orders/totals' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php
print_r($poocommerce->get('reports/orders/totals'));
?>
```
...
```ruby
poocommerce.get("reports/orders/totals").parsed_response
```
...
```javascript
PooCommerce.get( 'reports/products/totals' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php
print_r($poocommerce->get('reports/products/totals'));
?>
```
...
```ruby
poocommerce.get("reports/products/totals").parsed_response
```
...
```javascript
PooCommerce.get( 'reports/reviews/totals' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php
print_r($poocommerce->get('reports/reviews/totals'));
?>
```
...
```ruby
poocommerce.get("reports/reviews/totals").parsed_response
```
