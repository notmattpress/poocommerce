...
Requests/responses are logged using the PooCommerce logging system. Each delivery log includes:
...
Delivery logs can be accessed in "PooCommerce" > "Status" > "Logs".

### Visual interface

You can find the Webhooks interface going to "PooCommerce" > "Settings" > "Advanced" > "Webhooks", see our [Visual Webhooks docs](https://docs.poocommerce.com/document/webhooks/) for more details.
