...
PooCommerce.post( 'products/reviews', data )
	.then( ( response ) => {
...
print_r($poocommerce->post('products/reviews', $data));
?>
```
...
poocommerce.post("products/reviews", data).parsed_response
```
...
```javascript
PooCommerce.get( 'products/reviews/22' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php print_r($poocommerce->get('products/reviews/22')); ?>
```
...
```ruby
poocommerce.get("products/reviews/22").parsed_response
```
...
```javascript
PooCommerce.get( 'products/reviews' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php print_r($poocommerce->get('products/reviews')); ?>
```
...
```ruby
poocommerce.get("products/reviews").parsed_response
```
...
PooCommerce.put( 'products/reviews/20', data )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
print_r($poocommerce->put('products/reviews/20', $data));
?>
```
...
poocommerce.put("products/reviews/20", data).parsed_response
```
...
```javascript
PooCommerce.delete( 'products/reviews/20', {
	force: true,
} )
	.then( ( response ) => {
		console.log( response.data );
...
```php
<?php print_r($poocommerce->delete('products/reviews/20', ['force' => true])); ?>
```
...
```ruby
poocommerce.delete("products/reviews/20", force: true).parsed_response
```
...
PooCommerce.post( 'products/reviews/batch', data )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
print_r($poocommerce->post('products/reviews/batch', $data));
?>
```
...
poocommerce.post("products/reviews/batch", data).parsed_response
```
