...
PooCommerce.post( 'products/22/variations', data )
	.then( ( response ) => {
...
print_r($poocommerce->post('products/22/variations', $data));
?>
```
...
poocommerce.post("products/22/variations", data).parsed_response
```
...
```javascript
PooCommerce.get( 'products/22/variations/732' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php print_r($poocommerce->get('products/22/variations/732')); ?>
```
...
```ruby
poocommerce.get("products/22/variations/732").parsed_response
```
...
```javascript
PooCommerce.get( 'products/22/variations' )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
```php
<?php print_r($poocommerce->get('products/22/variations')); ?>
```
...
```ruby
poocommerce.get("products/22/variations").parsed_response
```
...
PooCommerce.put( 'products/22/variations/733', data )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
print_r($poocommerce->put('products/22/variations/733', $data));
?>
```
...
poocommerce.put("products/22/variations/733", data).parsed_response
```
...
```javascript
PooCommerce.delete( 'products/22/variations/733', {
	force: true,
} )
	.then( ( response ) => {
		console.log( response.data );
...
```php
<?php print_r($poocommerce->delete('products/22/variations/733', ['force' => true])); ?>
```
...
```ruby
poocommerce.delete("products/22/variations/733", force: true).parsed_response
```
...
PooCommerce.post( 'products/22/variations/batch', data )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
print_r($poocommerce->post('products/22/variations/batch', $data));
?>
```
...
poocommerce.post("products/22/variations/batch", data).parsed_response
```
	...
	"create": [
		{
			...
			"image": {
				...
				"src": "https://example.com/wp-content/plugins/poocommerce/assets/images/placeholder.png",
				"name": "Placeholder",
				"alt": "Placeholder"
			},
			"gallery_image_ids": [],
