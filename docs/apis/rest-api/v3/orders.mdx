...
| `version`              | string    | Version of PooCommerce which last updated the order. `READ-ONLY`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
print_r($poocommerce->post('orders', $data));
?>
```
...
poocommerce.post("orders", data).parsed_response
```
...
```php
<?php print_r($poocommerce->get('orders/727')); ?>
```
...
```ruby
poocommerce.get("orders/727").parsed_response
```
...
```php
<?php print_r($poocommerce->get('orders')); ?>
```
...
```ruby
poocommerce.get("orders").parsed_response
```
...
PooCommerce.put( 'orders/727', data )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
print_r($poocommerce->put('orders/727', $data));
?>
```
...
poocommerce.put("orders/727", data).parsed_response
```
...
```php
<?php print_r($poocommerce->delete('orders/727', ['force' => true])); ?>
```
...
```ruby
poocommerce.delete("orders/727", force: true).parsed_response
```
...
PooCommerce.post( 'orders/batch', data )
	.then( ( response ) => {
		console.log( response.data );
	} )
	.catch( ( error ) => {
...
print_r($poocommerce->post('orders/batch', $data));
?>
```
...
poocommerce.post("orders/batch", data).parsed_response
```
