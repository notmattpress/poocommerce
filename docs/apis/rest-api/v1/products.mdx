...
| `price_html`         | string    | Price formatted in HTML, e.g. `<del><span class=\"poocommerce-Price-amount amount\"><span class=\"poocommerce-Price-currencySymbol\">&#36;&nbsp;3.00</span></span></del> <ins><span class=\"poocommerce-Price-amount amount\"><span class=\"poocommerce-Price-currencySymbol\">&#36;&nbsp;2.00</span></span></ins>` `READ-ONLY` |
...
PooCommerce.post("products", data)
  .then((response) => {
...
print_r($poocommerce->post('products', $data));
?>
```
...
poocommerce.post("products", data).parsed_response
```
...
```json
{
  ...
  "date_on_sale_from": "",
  "date_on_sale_to": "",
  "price_html": "<span class=\"poocommerce-Price-amount amount\"><span class=\"poocommerce-Price-currencySymbol\">&#82;&#36;</span>21,99</span>",
  "on_sale": false,
  "purchasable": true,
  "total_sales": 0,
  "virtual": false,
...
curl -X POST https://example.com/wp-json/wc/v1/products \
  ...
  "images": [
    {
      "src": "http://demo.woothemes.com/poocommerce/wp-content/uploads/sites/56/2013/06/T_4_front.jpg",
      "position": 0
    },
    {
      "src": "http://demo.woothemes.com/poocommerce/wp-content/uploads/sites/56/2013/06/T_4_back.jpg",
      "position": 1
    },
    {
    ...
    {
      "src": "http://demo.woothemes.com/poocommerce/wp-content/uploads/sites/56/2013/06/T_3_back.jpg",
      "position": 3
    }
  ],
  "attributes": [
...
```json
{
  ...
  "date_on_sale_from": "",
  "date_on_sale_to": "",
  "price_html": "<span class=\"poocommerce-Price-amount amount\"><span class=\"poocommerce-Price-currencySymbol\">&#82;&#36;</span>19,99</span>",
  "on_sale": false,
  "purchasable": true,
  "total_sales": 0,
  "virtual": false,
...
```php
<?php print_r($poocommerce->get('products/162')); ?>
```
...
```ruby
poocommerce.get("products/162").parsed_response
```
...
```php
<?php print_r($poocommerce->get('products')); ?>
```
...
```ruby
poocommerce.get("products").parsed_response
```
...
PooCommerce.put("products/162", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($poocommerce->put('products/162', $data));
?>
```
...
poocommerce.put("products/162", data).parsed_response
```
...
```json
{
  ...
  "date_on_sale_from": "",
  "date_on_sale_to": "",
  "price_html": "<span class=\"poocommerce-Price-amount amount\"><span class=\"poocommerce-Price-currencySymbol\">&#82;&#36;</span>24,54</span>",
  "on_sale": false,
  "purchasable": true,
  "total_sales": 0,
  "virtual": false,
...
```javascript
PooCommerce.delete("products/162", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($poocommerce->delete('products/162', ['force' => true])); ?>
```
...
```ruby
poocommerce.delete("products/162", force: true).parsed_response
```
  ...
  "create": [
    {
      ...
      "downloads": [
        {
          "name": "Woo Single",
          "file": "http://demo.woothemes.com/poocommerce/wp-content/uploads/sites/56/2013/06/cd_4_angle.jpg"
        }
      ],
      "categories": [
        {
      ...
      "images": [
        {
          "src": "http://demo.woothemes.com/poocommerce/wp-content/uploads/sites/56/2013/06/cd_4_angle.jpg",
          "position": 0
        }
      ]
    },
...
PooCommerce.post("products/batch", data)
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
print_r($poocommerce->post('products/batch', $data));
?>
```
...
poocommerce.post("products/batch", data).parsed_response
```
  ...
  "update": [
    {
      ...
      "date_on_sale_from": "",
      "date_on_sale_to": "",
      "price_html": "<span class=\"poocommerce-Price-amount amount\"><span class=\"poocommerce-Price-currencySymbol\">&#82;&#36;</span>29,99</span>",
      "on_sale": false,
      "purchasable": true,
      "total_sales": 0,
      "virtual": false,
...
```javascript
PooCommerce.get("products/162/reviews/9")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```ruby
poocommerce.get("products/162/reviews/9").parsed_response
```
...
```javascript
PooCommerce.get("products/162/reviews")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('products/162/reviews')); ?>
```
...
```ruby
poocommerce.get("products/162/reviews").parsed_response
```
