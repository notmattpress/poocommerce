...
PooCommerce.post("orders/116/refunds", data)
  .then((response) => {
...
print_r($poocommerce->post('orders/116/refunds', $data));
?>
```
...
poocommerce.post("orders/116/refunds", data).parsed_response
```
...
```javascript
PooCommerce.get("orders/116/refunds/150")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('orders/116/refunds/150')); ?>
```
...
```ruby
poocommerce.get("orders/116/refunds/150").parsed_response
```
...
```javascript
PooCommerce.get("orders/116/refunds")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('orders/116/refunds')); ?>
```
...
```ruby
poocommerce.get("orders/116/refunds").parsed_response
```
...
```javascript
PooCommerce.delete("orders/116/refunds/150", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($poocommerce->delete('orders/116/refunds/150', ['force' => true])); ?>
```
...
```ruby
poocommerce.delete("orders/116/refunds/150", force: true).parsed_response
```
