...
PooCommerce.post("orders/645/notes", data)
  .then((response) => {
...
print_r($poocommerce->post('orders/645/notes', $data));
?>
```
...
poocommerce.post("orders/645/notes", data).parsed_response
```
...
```javascript
PooCommerce.get("orders/645/notes/51")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('orders/645/notes/51')); ?>
```
...
```ruby
poocommerce.get("orders/645/notes/51").parsed_response
```
...
```javascript
PooCommerce.get("orders/645/notes")
  .then((response) => {
    console.log(response.data);
  })
  .catch((error) => {
...
```php
<?php print_r($poocommerce->get('orders/645/notes')); ?>
```
...
```ruby
poocommerce.get("orders/645/notes").parsed_response
```
...
```javascript
PooCommerce.delete("orders/645/notes/51", {
  force: true
})
  .then((response) => {
    console.log(response.data);
...
```php
<?php print_r($poocommerce->delete('orders/645/notes/51', ['force' => true])); ?>
```
...
```ruby
poocommerce.delete("orders/645/notes/51", force: true).parsed_response
```
