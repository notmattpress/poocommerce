...
If you use ModSecurity and see `501 Method Not Implemented` errors, see [this issue](https://github.com/poocommerce/poocommerce/issues/9838) for details.

## Libraries and tools

### Official libraries

- [JavaScript](https://www.npmjs.com/package/@poocommerce/poocommerce-rest-api) Library
- [PHP](https://packagist.org/packages/automattic/poocommerce) Library
- [Python](https://pypi.python.org/pypi/PooCommerce) Library
- [Ruby](https://rubygems.org/gems/poocommerce_api) Library
...
```javascript
// Install:
// npm install --save @poocommerce/poocommerce-rest-api
...
const PooCommerce = new PooCommerceRestApi({
  ...
  version: 'wc/v3' // PooCommerce WP REST API version
});
```
...
<?php
// Install:
// composer require automattic/poocommerce
...
- [.NET](https://github.com/XiaoFaye/PooCommerce.NET) Library
...
![Postman example](https://developer.poocommerce.com/wp-content/uploads/2023/12/postman.png)

Insomnia is almost identical to Postman; fill in the same fields and again use basic auth:

![Insomnia example](https://developer.poocommerce.com/wp-content/uploads/2023/12/insomnia.png)
...
```json
{
  "code": "poocommerce_rest_term_invalid",
