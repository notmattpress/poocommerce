...
## Add to Wishlist Button - poocommerce/add-to-wishlist-button

Lets shoppers add the current product to their wishlist from the single-product page.

- **Name:** poocommerce/add-to-wishlist-button
- **Category:** poocommerce
- **Ancestor:** poocommerce/add-to-cart-with-options
...
## Coupon Code - poocommerce/coupon-code

Include a coupon code to entice customers to make a purchase.

- **Name:** poocommerce/coupon-code
- **Category:** poocommerce
...
## Dropdown - poocommerce/dropdown

Display options in a dropdown.

- **Name:** poocommerce/dropdown
- **Category:** poocommerce
- **Ancestor:** poocommerce/add-to-cart-with-options-variation-selector-attribute
- **Supports:** interactivity, poocommerce (innerBlockDisplayStyle)
...
- **Category:** poocommerce
- **Ancestor:** poocommerce/product-filter-attribute, poocommerce/product-filter-taxonomy, poocommerce/product-filter-status, poocommerce/add-to-cart-with-options-variation-selector-attribute
- **Supports:** interactivity, spacing (padding), typography (fontSize), poocommerce (innerBlockDisplayStyle)
...
## Availability Filter - poocommerce/product-filter-status
...
## Viewer - poocommerce/product-gallery-large-image
...
## Saved for Later - poocommerce/saved-for-later

Display items the shopper has saved from their cart for later.

- **Name:** poocommerce/saved-for-later
- **Category:** poocommerce
...
## Wishlist - poocommerce/wishlist

Display the shopper's wishlist.

- **Name:** poocommerce/wishlist
- **Category:** poocommerce
