...
For this to work, your script must be enqueued after Cart and Checkout. You can follow the [IntegrationInterface](https://developer.poocommerce.com/docs/block-development/reference/integration-interface/#the-problem) documentation for enqueueing your script.
