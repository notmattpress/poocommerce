...
Not all PooCommerce code is intended for use by extensions. Classes in the `Automattic\PooCommerce\Internal` namespace and code marked with `@internal` are for PooCommerce core use only: backwards compatibility between PooCommerce releases is not guaranteed and your extension may break if you use them. See the [extension development best practices](../best-practices-extensions/extension-development-best-practices.md) and the [Internal namespace documentation](https://github.com/poocommerce/poocommerce/blob/trunk/plugins/poocommerce/src/Internal/README.md).
