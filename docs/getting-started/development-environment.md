...
To load the PooCommerce plugin into your local develop environment, you can create a symbolic link from the PooCommerce plugin in your cloned repository to your local WordPress develoment environment.
