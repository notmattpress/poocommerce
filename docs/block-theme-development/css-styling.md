...
PooCommerce Blocks follows BEM for class names, as [stated in our coding guidelines](../../plugins/poocommerce/client/blocks/docs/contributors/coding-guidelines.md). All classes start with one of these two prefixes:
