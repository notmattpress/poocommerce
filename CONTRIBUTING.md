...
See the [unit tests README](plugins/poocommerce/tests/README.md), [E2E tests README](plugins/poocommerce/tests/e2e/README.md), and [performance tests README](plugins/poocommerce/tests/performance/README.md) for full details.
