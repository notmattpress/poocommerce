...
## [4.0.0](https://www.npmjs.com/package/@poocommerce/eslint-plugin/v/4.0.0) - 2026-08-06 
...
-   Major [ **BREAKING CHANGE** ] - Replace the `@poocommerce/dependency-group` rule with `import/order`. The custom rule is removed (rule, test, docs, and export); the recommended config now enforces import grouping via `import/order` and no longer requires the `/* External/Internal dependencies */` comment blocks. [#66086]

## [3.0.0](https://www.npmjs.com/package/@poocommerce/eslint-plugin/v/3.0.0) - 2026-06-10 
