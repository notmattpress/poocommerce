...
| `poocommerce_email_editor_setting_sidebar_email_status_component`  | `JSX.Element` EmailStatus        | `JSX.Element` Email status component       | Add a custom email status component to the Email settings sidebar                                                   |
