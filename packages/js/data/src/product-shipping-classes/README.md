...
This data store provides functions to interact with the [Product Shipping Class REST endpoints](https://developer.poocommerce.com/docs/apis/rest-api/v3/product-shipping-classes/).
