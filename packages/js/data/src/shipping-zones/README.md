...
This data store provides functions to interact with the [Shipping Zones REST endpoints](https://developer.poocommerce.com/docs/apis/rest-api/v3/shipping-zones/).
