...
| `poocommerce_email_blocks_renderer_parsed_blocks` | `Array` Parsed blocks data  z             | `Array` Parsed blocks data                                    | You can modify the parsed blocks before they are processed by email renderer. |
