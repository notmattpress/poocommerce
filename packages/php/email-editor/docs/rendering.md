...
Integrations can pass an optional boolean `is_rtl` value through the `poocommerce_email_editor_rendering_email_context` filter:

```php
add_filter(
    'poocommerce_email_editor_rendering_email_context',
