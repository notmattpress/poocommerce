...
class Email_Api_Controller_Test extends Email_Editor_Integration_Test_Case {
	...
	public function testSendPreviewEmailDataReturnsBadRequestWhenSendingFails(): void {
		...
		add_filter( 'poocommerce_email_editor_send_preview_email', $filter, PHP_INT_MAX, 1 );
		...
		try {
			...
			remove_filter( 'poocommerce_email_editor_send_preview_email', $filter, PHP_INT_MAX );
		}
	}
}
