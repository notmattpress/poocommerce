...
class TemplatesRegistryTest extends TestCase {
	...
	public function testRegisterAndGetTemplateByName(): void {
		...
		$template->method( 'get_name' )->willReturn( 'poocommerce//email-general' );
		...
		$retrieved_template = $this->registry->get_by_name( 'poocommerce//email-general' );

		$this->assertNotNull( $retrieved_template );
		$this->assertSame( 'poocommerce//email-general', $retrieved_template->get_name() );
