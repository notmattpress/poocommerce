...
-   Major [ **BREAKING CHANGE** ] - Updated post type for theme from `mailpoet_email_theme` to `poocommerce_email_theme` for consistency with PooCommerce naming conventions. [#55938]
-   Major [ **BREAKING CHANGE** ] - Updated user theme post name from `wp-global-styles-mailpoet` to `wp-global-styles-poocommerce-email` to align with PooCommerce naming standards. [#55938]
