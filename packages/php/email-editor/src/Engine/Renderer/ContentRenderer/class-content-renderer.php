...
class Content_Renderer {
	...
	private function initialize() {
		...
		add_filter( 'poocommerce_blocks_renderer_parsed_blocks', array( $this, 'preprocess_parsed_blocks' ) );

		do_action( 'poocommerce_blocks_renderer_initialized', $this->blocks_registry );
	}
	...
	private function reset(): void {
		...
		remove_filter( 'poocommerce_blocks_renderer_parsed_blocks', array( $this, 'preprocess_parsed_blocks' ) );
	}
	...
	private function inline_styles( $html, WP_Post $post, $template = null ) {
      ...
      ',
		...
		$styles = '<style>' . wp_strip_all_tags( (string) apply_filters( 'poocommerce_email_content_renderer_styles', $styles, $post ) ) . '</style>';
