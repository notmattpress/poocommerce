...
use Automattic\PooCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\Post_Template;
...
class Initializer {
	...
	public function initialize(): void {
		...
		add_action( 'poocommerce_email_editor_render_start', array( $this, 'reset_renderers' ) );
	}
