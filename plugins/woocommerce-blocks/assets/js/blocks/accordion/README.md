...
A group of headers and associated expandable content. ([Source](poocommerce/poocommerce/tree/trunk/plugins/poocommerce-blocks/assets/js/blocks/accordion/accordion-group))
...
Accordion header. ([Source](poocommerce/poocommerce/tree/trunk/plugins/poocommerce-blocks/assets/js/blocks/accordion/inner-blocks/accordion-header))
...
A single accordion that displays a header and expandable content. ([Source](poocommerce/poocommerce/tree/trunk/plugins/poocommerce-blocks/assets/js/blocks/accordion/inner-blocks/accordion-item))
...
Accordion Panel ([Source](poocommerce/poocommerce/tree/trunk/plugins/poocommerce-blocks/assets/js/blocks/accordion/inner-blocks/accordion-panel))
