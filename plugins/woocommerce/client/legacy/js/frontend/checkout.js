...
jQuery( function( $ ) {
				...
				if ( validate_email ) {
					if ( $this.val() ) {
						...
						if ( ! pattern.test( $this.val() ) ) {
							$this.attr( 'aria-invalid', 'true' );
							$parent.removeClass( 'poocommerce-validated' ).addClass( 'poocommerce-invalid poocommerce-invalid-email' ); // eslint-disable-line max-len
							validated = false;
						}
					}
				}
	...
	var wc_checkout_coupons = {
		init: function() {
			...
			$( document.body ).on( 'keydown', '.poocommerce-remove-coupon', this.on_keydown_remove_coupon );
