		...
		do_variation_action: function () {
			...
			switch ( do_variation_action ) {
				...
				case 'variable_unset_cogs_value':
					if (
						! window.confirm (
							poocommerce_admin_meta_boxes_variations.i18n_variation_cost_remove_warning
							)
					) {
						cancel = true;
					}
				...
				case 'variable_sale_schedule':
					...
					if ( false === data.date_to && false === data.date_from ) {
						...
						if (
							...
							window.alert(
								poocommerce_admin_meta_boxes_variations.i18n_scheduled_sale_end_before_start
							);
							cancel = true;
						}
					}
			...
			if ( cancel ) {
				...
				if ( 'delete_all' === do_variation_action && data.allowed ) {
					$( '#variable_product_options' )
						...
						.removeClass( 'variation-needs-update' );
					$( '.generate_variations' ).text(
						poocommerce_admin_meta_boxes_variations.i18n_generate_variations
					);
					run_bulk_action();
				} else if (
					! wc_meta_boxes_product_variations_ajax.check_for_changes(
