...
const CustomizeStoreController = () => {
	...
	const marketplaceUrl = useMemo( () => {
		...
		return 'https://poocommerce.com/product-category/themes/';
	}, [] );

	useEffect( () => {
		document.body.classList.add( 'poocommerce-customize-store' );
		return () => {
			document.body.classList.remove( 'poocommerce-customize-store' );
		};
	}, [] );
	...
	return (
		<div className="poocommerce-customize-store__container">
			<div className="poocommerce-customize-store-sidebar">
				...
				<VStack
					className="poocommerce-edit-site-sidebar-navigation-screen__main"
					spacing={ 0 }
					justify="flex-start"
				>
					<HStack
			...
			<div className="poocommerce-customize-store-main">
				<div className="poocommerce-customize-store-banner">
					<div className="poocommerce-customize-store-banner-content">
						<div className="poocommerce-customize-store__banner-actions">
							<h2>{ __( 'Design your own', 'poocommerce' ) }</h2>
							<p>
								{ __(
							...
							<Button
								...
								href={ designUrl }
							>
								{ __( 'Start designing', 'poocommerce' ) }
							</Button>
						</div>
					</div>
					<div className="poocommerce-banner-visual">
						<img
							src={ banner1Shape }
							alt=""
							className="poocommerce-banner-shape"
						/>
						<img
							src={ banner1Illu }
							alt=""
							className="poocommerce-banner-icon"
						/>
					</div>
				</div>

				<div className="poocommerce-customize-store-banner pick-your-theme-banner">
					<div className="poocommerce-customize-store-banner-content">
						<div className="poocommerce-customize-store__banner-actions">
							<h2>
								{ __(
...
// These will be removed in Phase 2 cleanup (see https://github.com/poocommerce/poocommerce/pull/61991).
// ============================================================================
