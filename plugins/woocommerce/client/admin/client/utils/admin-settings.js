...
export const deprecatedAdminProperties = {
	onboarding: {
		...
		euCountries:
			'Deprecated: wcSettings.admin.onboarding.euCountries is deprecated. Please use `/wc/v3/data/continents/eu` from the REST API. See https://developer.poocommerce.com/docs/apis/rest-api/v3/data/#list-all-continents for more information.',
		localInfo:
