...
export default function LockLabel( { message }: { message: string } ) {
	return (
		<div className="poocommerce-fulfillment-lock-label">
			<span className="poocommerce-fulfillment-lock-label__icon">
				<svg
					width="10"
					height="15"
					viewBox="0 0 10 15"
			...
			<span className="poocommerce-fulfillment-lock-label__text">
				{ message ||
					__(
