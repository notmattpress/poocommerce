...
const WCSHIPPING_LINK_SELECTOR = 'a[href*="poocommerce-shipping-settings"]';
	...
	if ( isWcShippingSectionPresent && isUspsDhlEligible ) {
		tourConfig.steps.push( {
			...
			meta: {
				...
				descriptions: {
					desktop: __(
						'Print USPS, UPS, and DHL labels straight from your Woo dashboard and save on shipping thanks to discounted rates. You can manage PooCommerce Shipping in this section.',
						'poocommerce'
					),
				},
			},
