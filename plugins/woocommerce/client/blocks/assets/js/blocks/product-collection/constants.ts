 ...
 * This file defines constants for use in `plugins/poocommerce/client/blocks/packages/public-api/blocks-registry/product-collection/register-product-collection.tsx`.
...
export const productTemplateBlockName = 'poocommerce/product-template';
