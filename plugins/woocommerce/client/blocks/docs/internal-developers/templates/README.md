...
-   At the beginning of the project, we unintentionally [used the incorrect PooCommerce plugin slug](https://github.com/poocommerce/poocommerce-gutenberg-products-block/issues/5423). This has resulted in us maintaining both the incorrect and correct slugs. We reference these via `BlockTemplateUtils::DEPRECATED_PLUGIN_SLUG` and `BlockTemplateUtils::PLUGIN_SLUG`.
