...
- [poocommerce_valid_order_statuses_for_payment](#poocommerce_valid_order_statuses_for_payment)
...
```php
apply_filters( 'poocommerce_thankyou_order_received_title', string $title, \WC_Order $order )
```
...
```php
apply_filters( 'poocommerce_valid_order_statuses_for_payment', array $valid_order_statuses, \WC_Order $order )
```
