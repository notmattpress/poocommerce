...
test.describe( 'PooCommerce Email Settings', () => {
	...
	test( 'Live preview when changing email settings', async ( {
		...
		const emailFields = [
			{ id: 'poocommerce_email_background_color', value: '#012345' },
			{ id: 'poocommerce_email_base_color', value: '#6789ab' },
			{ id: 'poocommerce_email_body_background_color', value: '#cdef01' },
			{ id: 'poocommerce_email_footer_text_color', value: '#234567' },
			// This color is ligtened in styles and not used with this specific value so can't be tested
			// { id: 'poocommerce_email_text_color', value: '#89abcd' },
			{ id: 'poocommerce_email_footer_text', value: 'New footer value' },
		];
