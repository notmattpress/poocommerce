...
```bash
pnpm exec allure generate --clean plugins/poocommerce/tests/e2e-pw/test-results/allure-results --output plugins/poocommerce/tests/e2e-pw/test-results/allure-report
pnpm exec allure open plugins/poocommerce/tests/e2e-pw/test-results/allure-report
```
