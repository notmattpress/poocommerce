...
# poocommerce_tax_rates table, so a re-seed turns three rates into six at
# exit 0. The duplicates do not change any total, since PooCommerce still
...
$rate_ids = $wpdb->get_col( "SELECT tax_rate_id FROM {$wpdb->prefix}poocommerce_tax_rates" );
...
// poocommerce_calc_taxes. Blocks specs expect PooCommerce's defaults.
$tax_option_defaults = array(
	'poocommerce_prices_include_tax'    => 'no',
	'poocommerce_tax_based_on'          => 'shipping',
	'poocommerce_shipping_tax_class'    => 'inherit',
	'poocommerce_tax_round_at_subtotal' => 'no',
	'poocommerce_tax_display_shop'      => 'excl',
	'poocommerce_tax_display_cart'      => 'excl',
	'poocommerce_price_display_suffix'  => '',
	'poocommerce_tax_total_display'     => 'itemized',
);
