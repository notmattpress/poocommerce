...
test.describe.serial( 'Shipping zones API tests', () => {
	...
	test( 'cannot delete the default shipping zone "Locations not covered by your other zones"', async ( {
		request,
	} ) => {
	...
	test( 'can add a shipping region to a shipping zone', async ( {
		request,
	} ) => {
	...
	test( 'can update a shipping region on a shipping zone', async ( {
		request,
	} ) => {
	...
	test( 'can clear/delete a shipping region on a shipping zone', async ( {
		request,
	} ) => {
		//GB and US locations exist initially
		//update the locations of the shipping zone regions to contain an individual state
