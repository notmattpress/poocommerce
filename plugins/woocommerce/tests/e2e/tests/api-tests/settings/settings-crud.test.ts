				...
				expect( responseJSON ).toEqual(
					expect.arrayContaining( [
						expect.objectContaining( {
							...
							label: 'PooCommerce Analytics',
							description:
								"Enable PooCommerce Analytics to track your store's key metrics and view them in a detailed dashboard. All data stays within your store.",
							type: 'checkbox',
							default: 'yes',
							value: expect.any( String ),
						} ),
