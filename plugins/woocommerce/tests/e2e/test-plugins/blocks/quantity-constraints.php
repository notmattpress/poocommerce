...
add_action(
	...
	function () {
		...
		add_filter(
			'poocommerce_quantity_input_min',
		...
		add_filter(
			'poocommerce_quantity_input_step',
		...
		add_filter(
			'poocommerce_quantity_input_max',
		...
		add_filter(
			'poocommerce_is_sold_individually',
