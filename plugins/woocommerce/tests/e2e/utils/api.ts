...
export const create = {
	 ...
	 *
	 * @see {@link [Batch update product variations](https://developer.poocommerce.com/docs/apis/rest-api/v3/product-variations/#batch-update-product-variations)}
	 * @param {number|string} productId  Product ID to add variations to
	 * @param {object[]}      variations Array of variations to add. See [Product variation properties](https://developer.poocommerce.com/docs/apis/rest-api/v3/product-variations/#product-variation-properties)
