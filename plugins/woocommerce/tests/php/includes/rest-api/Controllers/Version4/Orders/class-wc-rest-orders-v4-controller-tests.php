...
use Automattic\PooCommerce\RestApi\Routes\V4\Orders\Controller as OrdersController;
use Automattic\PooCommerce\RestApi\Routes\V4\Orders\Schema\OrderSchema;
use Automattic\PooCommerce\RestApi\Routes\V4\Orders\Schema\OrderItemSchema;
use Automattic\PooCommerce\RestApi\Routes\V4\Orders\Schema\OrderCouponSchema;
use Automattic\PooCommerce\RestApi\Routes\V4\Orders\Schema\OrderFeeSchema;
use Automattic\PooCommerce\RestApi\Routes\V4\Orders\Schema\OrderTaxSchema;
use Automattic\PooCommerce\RestApi\Routes\V4\Orders\Schema\OrderShippingSchema;
...
class WC_REST_Orders_V4_Controller_Tests extends WC_REST_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		$collection_query = new \Automattic\PooCommerce\RestApi\Routes\V4\Orders\CollectionQuery();
		$update_utils     = new \Automattic\PooCommerce\RestApi\Routes\V4\Orders\UpdateUtils();
