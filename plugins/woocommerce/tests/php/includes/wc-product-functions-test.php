...
class WC_Product_Functions_Tests extends \WC_Unit_Test_Case {
	 ...
	 */
	public function test_poocommerce_variable_add_to_cart_skips_gallery_snapshot_when_feature_off() {
		...
		// option (poocommerce_remote_variant_assignment) that other tests in the same worker
