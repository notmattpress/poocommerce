...
class WC_Order_Step_Logger_Functions_Test extends \WC_Unit_Test_Case {
	...
	/**
	 * @testdox Order step logging can be disabled entirely via the poocommerce_order_step_logging_enabled filter.
	 */
	public function test_wc_log_order_step_can_be_disabled_via_filter(): void {
		Constants::set_constant( 'WC_LOG_THRESHOLD', WC_Log_Levels::DEBUG );

		add_filter( 'poocommerce_order_step_logging_enabled', '__return_false' );
		...
		remove_filter( 'poocommerce_order_step_logging_enabled', '__return_false' );
