...
class WC_Product_Variation_Data_Store_CPT_Test extends WC_Unit_Test_Case {
	...
	public function tearDown(): void {
		...
		remove_all_filters( 'poocommerce_load_product_cogs_overrides_parent_value_flag' );
		remove_all_filters( 'poocommerce_save_product_cogs_overrides_parent_value_flag' );
	}
	...
	/**
	 * @testdox Loaded Cost of Goods Sold "value overrides parent" flag can be modified using the poocommerce_load_product_cogs_overrides_parent_value_flag filter.
	 *
	 * @testWith [true]
	 *           [false]
	 *
	...
	public function test_cogs_override_flag_loaded_value_can_be_altered_via_filter( bool $flag_value ) {
		...
		add_filter( 'poocommerce_load_product_cogs_overrides_parent_value_flag', fn( $value, $product ) => ! $value, 10, 2 );
	...
	/**
	 * @testdox Saved Cost of Goods Sold "value overrides parent" flag can be modified using the poocommerce_save_product_cogs_overrides_parent_value_flag filter.
	 *
	 * @testWith [true]
	 *           [false]
	 *
	...
	public function test_cogs_saved_override_flag_can_be_altered_via_filter( bool $flag_value ) {
		...
		// phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed
		add_filter( 'poocommerce_save_product_cogs_overrides_parent_value_flag', fn( $value, $product ) => ! $value, 10, 2 );
	...
	/**
	 * @testdox Saving of the Cost of Goods Sold "value overrides parent" flag can be suppressed using the poocommerce_save_product_cogs_overrides_parent_value_flag filter with a return value of null.
	 *
	 * @testWith [true]
	 *           [false]
	 *
	...
	public function test_cogs_saved_override_flag_saving_can_be_suppressed_via_filter( bool $flag_value ) {
		...
		// phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed
		add_filter( 'poocommerce_save_product_cogs_overrides_parent_value_flag', fn( $value, $product ) => null, 10, 2 );
