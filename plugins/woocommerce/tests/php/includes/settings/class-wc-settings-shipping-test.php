...
class WC_Settings_Shipping_Test extends WC_Settings_Unit_Test_Case {
	...
	public function test_get_sections_returns_fixed_sections_and_one_section_per_shipping_method_with_settings() {
		...
		$previous_fulfillments_enabled = get_option( 'poocommerce_feature_fulfillments_enabled', null );
		...
		try {
			...
			if ( null === $previous_fulfillments_enabled ) {
				...
				update_option( 'poocommerce_feature_fulfillments_enabled', $previous_fulfillments_enabled );
			}
		}
	}
	...
	public function test_get_options_settings_returns_all_settings() {
		...
		$expected = array(
			...
			'poocommerce_shipping_hide_rates_when_free'  => 'checkbox',
