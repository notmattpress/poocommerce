...
class BlockTypesController extends WC_Unit_Test_Case {
	 ...
	 */
	private const PROBE_BLOCK = 'poocommerce/classic-theme-fallback-probe';
	...
	public function test_register_block_patterns_registers_installed_cart_page_patterns(): void {
		...
		$slugs = array( 'poocommerce/cart-empty-message', 'poocommerce/cart-new-in-store-message', 'poocommerce/cart-cross-sells-message' );
