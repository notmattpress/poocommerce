...
class OrderControllerTests extends \WC_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		$this->checkout_phone_field_option_value   = get_option( 'poocommerce_checkout_phone_field', $missing_option );
	...
	public function tearDown(): void {
		try {
			...
			if ( $this->checkout_phone_field_option_existed ) {
				update_option( 'poocommerce_checkout_phone_field', $this->checkout_phone_field_option_value );
			} else {
