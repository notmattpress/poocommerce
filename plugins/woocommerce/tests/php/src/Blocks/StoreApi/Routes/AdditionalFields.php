...
class AdditionalFields extends MockeryTestCase {
	...
	public function test_invalid_rules_schema() {
		$doing_it_wrong_mocker = $this->add_doing_it_wrong_error_mocker( 'poocommerce_register_additional_checkout_field', 'Unable to register field with id: "namespace/test-id". The rules must be an array.' );
		\poocommerce_register_additional_checkout_field(
			array(
	...
	public function test_invalid_validation_rules_schema() {
		$doing_it_wrong_mocker = $this->add_doing_it_wrong_error_mocker( 'poocommerce_register_additional_checkout_field', 'Unable to register field with id: "namespace/test-id". The properties must match schema: {properties}' );
		\poocommerce_register_additional_checkout_field(
			array(
				'id'       => 'namespace/test-id',
				'label'    => 'Test Field',
		...
		$doing_it_wrong_mocker = $this->add_doing_it_wrong_error_mocker( 'poocommerce_register_additional_checkout_field', 'Unable to register field with id: "namespace/test-id". The validation rules must be an array.' );
		\poocommerce_register_additional_checkout_field(
			array(
				'id'       => 'namespace/test-id',
				'label'    => 'Test Field',
	...
	public function test_invalid_required_rules_schema() {
		$doing_it_wrong_mocker = $this->add_doing_it_wrong_error_mocker( 'poocommerce_register_additional_checkout_field', 'Unable to register field with id: "namespace/test-id". The required rules must be an array.' );
		\poocommerce_register_additional_checkout_field(
			array(
				'id'       => 'namespace/test-id',
				'label'    => 'Test Field',
