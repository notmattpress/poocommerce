...
class ActivityPanelCountsTest extends WC_REST_Unit_Test_Case {
	...
	public function test_filtered_default_actionable_statuses_drive_default_count() {
		...
		add_filter( 'poocommerce_analytics_settings_default_actionable_order_statuses', $add_completed );
		$this->reregister_routes();
		...
		remove_filter( 'poocommerce_analytics_settings_default_actionable_order_statuses', $add_completed );
