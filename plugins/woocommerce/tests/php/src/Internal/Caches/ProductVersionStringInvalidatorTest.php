...
class ProductVersionStringInvalidatorTest extends \WC_Unit_Test_Case {
	...
	public function test_new_product_invalidates_list_version_string() {
		...
		$this->sut->handle_poocommerce_new_product( 123 );
	...
	public function test_new_variation_invalidates_variations_list_version_string() {
		...
		$this->sut->handle_poocommerce_new_product_variation( 456, $variation );
	...
	public function test_deleted_product_invalidates_list_version_string() {
		...
		$this->sut->handle_poocommerce_before_delete_product( 123 );
	...
	public function test_trashed_product_invalidates_list_version_string() {
		...
		$this->sut->handle_poocommerce_trash_product( 123 );
	...
	public function test_trashed_variation_invalidates_variations_list_version_string() {
		...
		$this->sut->handle_poocommerce_trash_product_variation( $variation_id );
	...
	public function test_deleted_variation_invalidates_variations_list_version_string() {
		...
		$this->sut->handle_poocommerce_before_delete_product_variation( $variation_id );
	...
	public function test_string_cached_parent_id_is_normalized_and_parent_invalidated(): void {
		...
		wp_cache_set( "wc_variation_parent_{$variation_id}", (string) $parent_id, 'poocommerce' );
		$this->version_generator->generate_version( "product_{$parent_id}" );

		$this->sut->handle_poocommerce_updated_product_attribute_summary( $variation_id );
