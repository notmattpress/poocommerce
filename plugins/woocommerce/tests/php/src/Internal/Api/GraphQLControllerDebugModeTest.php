...
class GraphQLControllerDebugModeTest extends WC_REST_Unit_Test_Case {
	...
	/**
	 * @testdox the poocommerce_graphql_can_use_debug_mode filter can grant debug mode to a user the principal would deny.
	 */
	public function test_filter_can_grant_debug_mode_to_low_privilege_user(): void {
		...
		add_filter( 'poocommerce_graphql_can_use_debug_mode', $filter, 10, 3 );
		...
		try {
			...
			remove_filter( 'poocommerce_graphql_can_use_debug_mode', $filter, 10 );
		}
	...
	/**
	 * @testdox the poocommerce_graphql_can_use_debug_mode filter can revoke debug mode from an admin.
	 */
	public function test_filter_can_revoke_debug_mode_from_admin(): void {
		$filter = function (): bool {
			return false;
		};
		add_filter( 'poocommerce_graphql_can_use_debug_mode', $filter );
		...
		try {
			...
			remove_filter( 'poocommerce_graphql_can_use_debug_mode', $filter );
		}
	...
	/**
	 * @testdox the poocommerce_graphql_can_use_debug_mode filter must return strictly true; truthy non-bool denies.
	 */
	...
	/**
	 * @testdox the poocommerce_graphql_can_use_debug_mode filter is not invoked when _debug=1 is absent.
	 */
	...
	/**
	 * @testdox a throw from the poocommerce_graphql_can_use_debug_mode filter callback denies debug mode (fail-closed).
	 *
