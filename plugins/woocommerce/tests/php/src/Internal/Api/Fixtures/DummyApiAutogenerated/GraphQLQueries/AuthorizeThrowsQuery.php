...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\Authorization\AuthorizeThrowsQuery as AuthorizeThrowsQueryCommand;
...
class AuthorizeThrowsQuery {
	public static function get_field_definition(): array {
		return array(
			...
			'description' => __( 'authorize() throws to verify exception translation', 'poocommerce' ),
			'args'        => array(
				'kind' => array(
					'type'        => Type::nonNull( Type::string() ),
					'description' => __( 'Which exception class authorize() should raise.', 'poocommerce' ),
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( AuthorizeThrowsQueryCommand::class );
