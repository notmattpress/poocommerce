...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Mutations\DeleteWidget as DeleteWidgetCommand;
...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApiAutogenerated\GraphQLTypes\Output\OperationResult as OperationResultType;
...
class DeleteWidget {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Delete a widget', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'id'    => array(
					...
					'description' => __( 'The widget id to delete', 'poocommerce' ),
				),
				'force' => array(
					'type'         => Type::nonNull( Type::boolean() ),
					'description'  => __( 'When true, ignore \"not found\" errors', 'poocommerce' ),
					'defaultValue' => false,
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( DeleteWidgetCommand::class );
