...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\FailingQuery as FailingQueryCommand;
...
class FailingQuery {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Always throws an exception', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'kind' => array(
					...
					'description'  => __( 'What kind of failure to raise', 'poocommerce' ),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( FailingQueryCommand::class );
