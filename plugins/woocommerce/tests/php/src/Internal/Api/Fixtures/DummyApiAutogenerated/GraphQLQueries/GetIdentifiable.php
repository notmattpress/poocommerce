...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\GetIdentifiable as GetIdentifiableCommand;
...
class GetIdentifiable {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Return either a Widget or a Gadget, both of which implement Named', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'kind' => array(
					...
					'description' => __( 'Which kind of object to return', 'poocommerce' ),
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( GetIdentifiableCommand::class );
