...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\Authorization\IgnoredAuthorizeQuery as IgnoredAuthorizeQueryCommand;
...
class IgnoredAuthorizeQuery {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'authorize() with #[Ignore] is skipped; the cap check applies', 'poocommerce' ),
			'authorization' => array(
				array(
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( IgnoredAuthorizeQueryCommand::class );
