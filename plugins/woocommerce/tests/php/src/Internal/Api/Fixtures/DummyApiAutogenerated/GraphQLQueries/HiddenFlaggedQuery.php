...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\HiddenFlaggedQuery as HiddenFlaggedQueryCommand;
...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApiAutogenerated\GraphQLTypes\Output\RuntimeMetaProbe as RuntimeMetaProbeType;
...
class HiddenFlaggedQuery {
	public static function get_field_definition(): array {
		return array(
			...
			'description' => __( 'Probe query for runtime metadata visibility under #[HiddenFromMetadataQuery].', 'poocommerce' ),
			'args'        => array(),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( HiddenFlaggedQueryCommand::class );
