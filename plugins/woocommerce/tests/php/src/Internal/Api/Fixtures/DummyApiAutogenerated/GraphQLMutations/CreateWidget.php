...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Mutations\CreateWidget as CreateWidgetCommand;
...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApiAutogenerated\GraphQLTypes\Input\CreateWidget as CreateWidgetInput;
...
class CreateWidget {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Create a new widget', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'input'          => array(
					...
					'description' => __( 'The data for the new widget', 'poocommerce' ),
				),
				'related_inputs' => array(
					'type'         => Type::listOf( Type::nonNull( CreateWidgetInput::get() ) ),
					'description'  => __( 'Related widget inputs for array input generation coverage', 'poocommerce' ),
					'defaultValue' => null,
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( CreateWidgetCommand::class );
		...
		if ( isset( $execute_args['input'] ) && $execute_args['input'] instanceof \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\InputTypes\CreateWidgetInput ) {
	...
	public static function compute_preauthorized( \Automattic\PooCommerce\Api\Infrastructure\Principal $principal ): bool {
		return ( new \Automattic\PooCommerce\Api\Attributes\RequiredCapability( 'manage_options' ) )->authorize( $principal );
	}

	private static function convert_create_widget_input( array $data ): \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\InputTypes\CreateWidgetInput {
		$input = new \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\InputTypes\CreateWidgetInput();
