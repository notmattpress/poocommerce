...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\Authorization\ComposedAuthorizeQuery as ComposedAuthorizeQueryCommand;
...
class ComposedAuthorizeQuery {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Composes #[RequiredCapability] with authorize() via $_preauthorized', 'poocommerce' ),
			'authorization' => array(
				array(
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( ComposedAuthorizeQueryCommand::class );
