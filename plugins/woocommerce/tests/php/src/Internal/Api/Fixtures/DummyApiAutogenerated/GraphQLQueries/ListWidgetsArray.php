...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\ListWidgetsArray as ListWidgetsArrayCommand;
...
class ListWidgetsArray {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'List widgets without pagination.', 'poocommerce' ),
			'authorization' => array(
				array(
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( ListWidgetsArrayCommand::class );
