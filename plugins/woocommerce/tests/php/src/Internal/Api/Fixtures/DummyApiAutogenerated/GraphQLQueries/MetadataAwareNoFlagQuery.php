...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\Authorization\MetadataAwareNoFlagQuery as MetadataAwareNoFlagQueryCommand;
...
class MetadataAwareNoFlagQuery {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Exercises RequiresInternalFlag without the matching #[Internal] entry.', 'poocommerce' ),
			'authorization' => array(
				array(
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( MetadataAwareNoFlagQueryCommand::class );
