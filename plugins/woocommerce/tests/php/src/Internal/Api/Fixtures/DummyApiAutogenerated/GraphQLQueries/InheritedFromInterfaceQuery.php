...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\Inheritance\InheritedFromInterfaceQuery as InheritedFromInterfaceQueryCommand;
...
class InheritedFromInterfaceQuery {
	public static function get_field_definition(): array {
		return array(
			...
			'description' => __( 'Inherits manage_options from a PHP interface', 'poocommerce' ),
			'args'        => array(),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( InheritedFromInterfaceQueryCommand::class );
