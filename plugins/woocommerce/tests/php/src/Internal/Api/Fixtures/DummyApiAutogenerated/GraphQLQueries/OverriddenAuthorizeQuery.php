...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\Authorization\OverriddenAuthorizeQuery as OverriddenAuthorizeQueryCommand;
...
class OverriddenAuthorizeQuery {
	public static function get_field_definition(): array {
		return array(
			...
			'description' => __( 'authorize() supersedes the cap inherited from the parent', 'poocommerce' ),
			'args'        => array(),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( OverriddenAuthorizeQueryCommand::class );
