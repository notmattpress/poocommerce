...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\Authorization\AuthorizeOnlyQuery as AuthorizeOnlyQueryCommand;
...
class AuthorizeOnlyQuery {
	public static function get_field_definition(): array {
		return array(
			...
			'description' => __( 'Authorization decided solely by authorize()', 'poocommerce' ),
			'args'        => array(
				'allow' => array(
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( AuthorizeOnlyQueryCommand::class );
