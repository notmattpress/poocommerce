...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\Authorization\MetadataAwareInternalQuery as MetadataAwareInternalQueryCommand;
...
class MetadataAwareInternalQuery {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( '[Internal] Exercises RequiresInternalFlag against a class that carries #[Internal].', 'poocommerce' ),
			'metadata'      => array(
				'internal' => true,
			),
			'authorization' => array(
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( MetadataAwareInternalQueryCommand::class );
	...
	public static function compute_preauthorized( \Automattic\PooCommerce\Api\Infrastructure\Principal $principal ): bool {
		return ( new \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Attributes\RequiresInternalFlag() )->authorize(
			$principal,
			_metadata: array(
				'query' =>
				array(
