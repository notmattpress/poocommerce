...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\GetWidget as GetWidgetCommand;
...
class GetWidget {
	public static function get_field_definition(): array {
		return array(
			'type'          => WidgetType::get(),
			'description'   => __( 'Fetch a single widget by ID', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'id' => array(
					...
					'description' => __( 'The ID of the widget to fetch', 'poocommerce' ),
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( GetWidgetCommand::class );
