...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\GetGreeting as GetGreetingCommand;
...
class GetGreeting {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Build a greeting', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'name' => array(
					'type'         => Type::string(),
					'description'  => __( 'Who to greet (defaults to \"world\")', 'poocommerce' ),
					'defaultValue' => null,
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( GetGreetingCommand::class );
