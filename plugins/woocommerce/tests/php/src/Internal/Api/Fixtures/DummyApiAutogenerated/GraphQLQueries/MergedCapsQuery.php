...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\Inheritance\MergedCapsQuery as MergedCapsQueryCommand;
...
class MergedCapsQuery {
	public static function get_field_definition(): array {
		return array(
			...
			'description' => __( 'Merges caps from a parent class and a trait', 'poocommerce' ),
			'args'        => array(),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Infrastructure\ClassResolver::resolve_class( MergedCapsQueryCommand::class );
