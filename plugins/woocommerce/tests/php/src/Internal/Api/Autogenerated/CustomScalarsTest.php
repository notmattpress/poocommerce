...
use Automattic\PooCommerce\Api\Infrastructure\Schema\AST\StringValueNode;
...
class CustomScalarsTest extends AutogeneratedTestCase {
	...
	public function test_parse_value_rejects_malformed_input(): void {
		$this->expectException( \Automattic\PooCommerce\Api\Infrastructure\Schema\Error::class );
