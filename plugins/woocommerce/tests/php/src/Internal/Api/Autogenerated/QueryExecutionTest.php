...
use Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Queries\GetWidget;
...
class QueryExecutionTest extends AutogeneratedTestCase {
	...
	public function test_resolver_routes_through_container(): void {
		...
		$override = new class() extends GetWidget {
			 ...
			 */
			public function execute( int $id ): ?\Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Types\Widget {
				unset( $id );
				$widget                                = new \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Types\Widget();
				$widget->id                            = 999;
				$widget->label                         = 'OVERRIDDEN';
				$widget->slug                          = 'overridden';
				$widget->caption                       = null;
				$widget->color                         = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Enums\Color::Blue;
				$widget->priority                      = \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApi\Enums\Priority::Normal;
				$widget->tag_ids                       = array();
				$widget->featured_reviews              = array();
				$reviews                               = new \Automattic\PooCommerce\Api\Pagination\Connection();
				$reviews->edges                        = array();
				$reviews->nodes                        = array();
				$reviews->page_info                    = new \Automattic\PooCommerce\Api\Pagination\PageInfo();
