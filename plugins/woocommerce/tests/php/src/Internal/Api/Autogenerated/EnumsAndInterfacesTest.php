...
class EnumsAndInterfacesTest extends AutogeneratedTestCase {
	...
	public function test_enum_value_is_php_enum_case(): void {
		...
		$this->assertSame( PriorityEnum::High, \Automattic\PooCommerce\Tests\Internal\Api\Fixtures\DummyApiAutogenerated\GraphQLTypes\Enums\Priority::get()->getValue( 'HIGH' )->value );
	}
