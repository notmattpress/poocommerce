 ...
 *
 * @package PooCommerce\Tests\Internal\RestApi\Routes\V4\Settings\Email
 */

declare(strict_types=1);

namespace Automattic\PooCommerce\Tests\Internal\RestApi\Routes\V4\Settings\Email;
...
class EmailSettingsControllerTest extends WC_REST_Unit_Test_Case {
	...
	public function test_get_item_without_block_email_editor() {
		...
		$this->assertContains( 'poocommerce_email_reply_to_enabled', $field_ids );
		$this->assertContains( 'poocommerce_email_reply_to_name', $field_ids );
		$this->assertContains( 'poocommerce_email_reply_to_address', $field_ids );
