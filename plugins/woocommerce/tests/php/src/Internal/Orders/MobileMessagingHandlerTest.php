...
class MobileMessagingHandlerTest extends \WC_Unit_Test_Case {
	...
	public static function wpSetUpBeforeClass(): void {
		self::$initial_country  = self::get_raw_option_state( 'poocommerce_default_country' );
		self::$initial_currency = self::get_raw_option_state( 'poocommerce_currency' );
	}
	...
	public static function wpTearDownAfterClass(): void {
		try {
			self::restore_raw_option_state( 'poocommerce_default_country', self::$initial_country );
		} finally {
			self::restore_raw_option_state( 'poocommerce_currency', self::$initial_currency );
		}
	}
