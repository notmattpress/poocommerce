...
use Automattic\PooCommerce\Internal\VariationGallery\Migration as VariationGalleryMigration;
...
class WC_Unit_Tests_Bootstrap {
	...
	public function install_wc() {
		...
		// because install_wc() includes uninstall.php, which deletes every 'poocommerce_%'
		// option. This still runs on `setup_theme`, in time for the `init` feature check.
		update_option( 'poocommerce_feature_customer_stock_notifications_enabled', 'yes' );
