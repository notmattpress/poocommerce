...
class WC_Tests_CRUD_Orders extends WC_Unit_Test_Case {
	...
	public function test_get_formatted_order_total() {
		...
		$this->assertEquals( '<span class="poocommerce-Price-amount amount"><bdi class="poocommerce-Price-bidi"><span class="poocommerce-Price-currencySymbol">&#36;</span>100.00</bdi></span>', $object->get_formatted_order_total() );
	}
