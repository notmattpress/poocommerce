...
class WC_Tests_Formatting_Functions extends WC_Unit_Test_Case {
	...
	public function test_wc_price() {
		...
		// Aria hidden option.
		$this->assertEquals( '<span class="poocommerce-Price-amount amount" aria-hidden="true"><bdi>-<span class="poocommerce-Price-currencySymbol">&#36;</span>1.17</bdi></span>', wc_price( -1.17, array( 'aria-hidden' => true ) ) );
	...
	public function test_wc_format_price_range() {
		$this->assertEquals( '<span class="poocommerce-Price-amount amount" aria-hidden="true"><bdi><span class="poocommerce-Price-currencySymbol">&#36;</span>10.00</bdi></span> <span aria-hidden="true">&ndash;</span> <span class="poocommerce-Price-amount amount" aria-hidden="true"><bdi><span class="poocommerce-Price-currencySymbol">&#36;</span>5.00</bdi></span><span class="screen-reader-text">Price range: &#36;10.00 through &#36;5.00</span>', wc_format_price_range( '10', '5' ) );
	}
