...
class WC_Tests_Product_Data extends WC_Unit_Test_Case {
	...
	public function test_multiple_get_price_html_calls() {
		...
		$this->assertEquals( '<del aria-hidden="true"><span class="poocommerce-Price-amount amount"><bdi><span class="poocommerce-Price-currencySymbol" translate="no" dir="auto">&#36;</span>20.00</bdi></span></del> <span class="screen-reader-text">Original price was: &#036;20.00.</span><ins aria-hidden="true"><span class="poocommerce-Price-amount amount"><bdi><span class="poocommerce-Price-currencySymbol" translate="no" dir="auto">&#36;</span>16.00</bdi></span></ins><span class="screen-reader-text">Current price is: &#036;16.00.</span>', $product->get_price_html() );

		$product = wc_get_product( $product3_id );
		$this->assertEquals( $product3_id, $product->get_id() );
		$this->assertEquals( '<span class="poocommerce-Price-amount amount"><bdi><span class="poocommerce-Price-currencySymbol" translate="no" dir="auto">&#36;</span>50.00</bdi></span>', $product->get_price_html() );
	}
