...
class WC_Tests_Cart extends WC_Unit_Test_Case {
	...
	public function test_inclusive_tax_rounding_issue_20997() {
		...
		$expected_price = '<span class="poocommerce-Price-amount amount"><bdi class="poocommerce-Price-bidi"><span class="poocommerce-Price-currencySymbol">&euro;</span>68,50</bdi></span>';
		...
		$expected_price = '<span class="poocommerce-Price-amount amount"><bdi class="poocommerce-Price-bidi"><span class="poocommerce-Price-currencySymbol">&euro;</span>112,00</bdi></span>';
		$this->assertEquals( $expected_price, WC()->cart->get_total() );
		...
		$expected_price = '<span class="poocommerce-Price-amount amount"><bdi class="poocommerce-Price-bidi"><span class="poocommerce-Price-currencySymbol">&euro;</span>239,00</bdi></span>';
		$this->assertEquals( $expected_price, WC()->cart->get_total() );
