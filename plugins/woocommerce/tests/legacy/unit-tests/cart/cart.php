...
class WC_Tests_Cart extends WC_Unit_Test_Case {
	...
	public function test_inclusive_tax_rounding_issue_20997() {
		...
		$expected_price = '<span class="poocommerce-Price-amount amount"><bdi><span class="poocommerce-Price-currencySymbol" translate="no" dir="auto">&euro;</span>68,50</bdi></span>';
		...
		$expected_price = '<span class="poocommerce-Price-amount amount"><bdi><span class="poocommerce-Price-currencySymbol" translate="no" dir="auto">&euro;</span>112,00</bdi></span>';
		$this->assertEquals( $expected_price, WC()->cart->get_total() );
		...
		$expected_price = '<span class="poocommerce-Price-amount amount"><bdi><span class="poocommerce-Price-currencySymbol" translate="no" dir="auto">&euro;</span>239,00</bdi></span>';
		$this->assertEquals( $expected_price, WC()->cart->get_total() );
