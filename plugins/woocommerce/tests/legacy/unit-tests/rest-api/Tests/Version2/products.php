...
class Products_API_V2 extends WC_REST_Unit_Test_Case {
	...
	public function test_get_products() {
		...
		$external_product = \Automattic\PooCommerce\RestApi\UnitTests\Helpers\ProductHelper::create_external_product();
		$external_product->set_date_created( '2020-01-01 00:00:00' );
		$external_product->save();

		$simple_product = \Automattic\PooCommerce\RestApi\UnitTests\Helpers\ProductHelper::create_simple_product();
