...
class WC_Admin_Tests_Install extends WP_UnitTestCase {
	...
	public function test_enable_analytics_scheduled_import_preserves_existing_value() {
		...
		update_option( 'poocommerce_analytics_scheduled_import', 'no' );

		// Call the method which should not overwrite the existing value.
		WC_Install::enable_analytics_scheduled_import();

		// Verify the option remains 'no' (not overwritten).
		$this->assertEquals( 'no', get_option( 'poocommerce_analytics_scheduled_import' ) );
	}
	...
	public function test_enable_product_instance_caching_for_new_installation() {
		...
		delete_option( 'poocommerce_feature_product_instance_caching_enabled' );
		...
		$this->assertEquals( 'yes', get_option( 'poocommerce_feature_product_instance_caching_enabled' ) );
	}
