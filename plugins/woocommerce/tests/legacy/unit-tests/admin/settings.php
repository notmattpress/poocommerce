...
class WC_Tests_Admin_Settings extends WC_Unit_Test_Case {
	 ...
	 *
	 * Ensures that users without manage_poocommerce capability cannot save settings,
	 * even with a valid nonce (e.g., from a pre-opened admin tab before role downgrade).
	 */
	public function test_save_requires_manage_poocommerce_capability() {
		// Create a user without manage_poocommerce capability.
		...
		$_POST['_wpnonce']    = wp_create_nonce( 'poocommerce-settings' );
	 ...
	 */
	public function test_save_succeeds_with_manage_poocommerce_capability() {
		// Create a user with manage_poocommerce capability.
