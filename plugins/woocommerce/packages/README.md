...
You need Composer to use the packages. If you don't have it installed, go and check how to [install Composer](https://developer.poocommerce.com/docs/contribution/contributing/#setting-up-your-development-environment) and then continue here.
