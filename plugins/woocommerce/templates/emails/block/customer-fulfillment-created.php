...
<!-- wp:heading -->
<h2 class="wp-block-heading"> <?php echo esc_html__( 'Your item is on the way!', 'poocommerce' ); ?> </h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php
	echo esc_html__( 'Woo! Some items you purchased are being fulfilled. You can use the below information to track your shipment:', 'poocommerce' );
?></p>
<!-- /wp:paragraph -->
...
echo esc_html__( 'Please note that couriers may need some time to provide the latest shipping information.', 'poocommerce' );
?></p>
<!-- /wp:paragraph -->
