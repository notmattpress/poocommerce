 ...
 * 3. Content for specific emails that does not include the typical PooCommerce order details
 *
 ...
 */
do_action( 'poocommerce_email_general_block_content', $sent_to_admin, $plain_text, $email );
 ...
 */
$emails_without_order_details = apply_filters( 'poocommerce_emails_general_block_content_emails_without_order_details', array() );
