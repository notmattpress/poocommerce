...
<!-- wp:heading -->
<h2 class="wp-block-heading"> <?php echo esc_html__( 'Good things are heading your way!', 'poocommerce' ); ?> </h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p> <?php echo esc_html__( 'We’ve successfully processed your order, and it’s on its way to you.', 'poocommerce' ); ?> </p>
<!-- /wp:paragraph -->
