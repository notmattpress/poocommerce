...
printf( esc_html__( 'Partial refund: Order %s', 'poocommerce' ), '<!--[poocommerce/order-number]-->' );
?></h2>
<!-- /wp:heading -->
...
printf( esc_html__( 'Your order from %s has been partially refunded.', 'poocommerce' ), '<!--[poocommerce/site-title]-->' );
?></p>
<!-- /wp:paragraph -->
