...
<!-- wp:heading -->
<h2 class="wp-block-heading"> <?php echo esc_html__( 'Your order is on hold', 'poocommerce' ); ?> </h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p> <?php echo esc_html__( 'Thanks for your order. We’ve received it, and it’s currently on hold while we complete the next required step, such as confirming, clearing, or finalizing payment.', 'poocommerce' ); ?> </p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p> <?php echo esc_html__( 'We’ll send another update when your order moves forward. Here’s a summary of your order:', 'poocommerce' ); ?> </p>
<!-- /wp:paragraph -->
