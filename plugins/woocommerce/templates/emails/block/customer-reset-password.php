...
<!-- wp:heading -->
<h2> <?php echo esc_html__( 'Reset your password', 'poocommerce' ); ?> </h2>
<!-- /wp:heading -->
...
<?php
	...
	printf( esc_html__( 'Hi %s,', 'poocommerce' ), '<!--[poocommerce/shopper-username]-->' );
?>
</p>
<!-- /wp:paragraph -->
...
echo wp_kses( sprintf( __( 'Username: <b>%s</b>', 'poocommerce' ), '<!--[poocommerce/shopper-username]-->' ), array( 'b' => array() ) );
?>
</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p> <?php echo esc_html__( 'Thanks for reading.', 'poocommerce' ); ?> </p>
<!-- /wp:paragraph -->
