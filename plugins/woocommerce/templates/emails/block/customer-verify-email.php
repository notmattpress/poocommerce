...
<!-- wp:heading -->
<h2 class="wp-block-heading"> <?php echo esc_html__( 'Confirm your email address', 'poocommerce' ); ?> </h2>
<!-- /wp:heading -->
...
<p><?php
	...
	printf( esc_html__( "Once you've confirmed that %s is your email address, we'll link any past orders to your account.", 'poocommerce' ), '<!--[poocommerce/customer-email]-->' );
?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p> <?php echo esc_html__( "If you didn't request this email, there's nothing to worry about, and you can safely ignore it.", 'poocommerce' ); ?> </p>
<!-- /wp:paragraph -->
