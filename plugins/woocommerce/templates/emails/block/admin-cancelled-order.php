...
<?php
	...
	$text = __( 'We’re getting in touch to let you know that order #%1$s from %2$s has been cancelled.', 'poocommerce' );
	printf( esc_html( $text ), '<!--[poocommerce/order-number]-->', '<!--[poocommerce/shopper-full-name]-->' );
?>
</p>
<!-- /wp:paragraph -->
