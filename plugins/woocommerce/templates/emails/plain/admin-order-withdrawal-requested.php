 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/plain/admin-order-withdrawal-requested.php.
 *
...
echo esc_html__( 'A customer submitted an order withdrawal request.', 'poocommerce' ) . "\n\n";

if ( $matched_order instanceof WC_Order ) {
	echo esc_html__( 'PooCommerce matched this request to an order and added an order note.', 'poocommerce' ) . "\n\n";
} else {
	echo esc_html__( 'PooCommerce could not match this request to an order automatically, so no order note was added.', 'poocommerce' ) . "\n\n";
}
