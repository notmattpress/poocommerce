 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/plain/customer-review-request.php.
 *
...
echo esc_html__( 'We’d love to know what you thought of the products you ordered. Your review helps other shoppers make better decisions and helps us improve.', 'poocommerce' ) . "\n\n";

if ( ! empty( $review_order_url ) ) {
	echo esc_html__( 'Leave a review:', 'poocommerce' ) . "\n";
