 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/plain/customer-cancelled-order.php.
 *
...
$text = __( 'We’re sorry to let you know that your order #%1$s has been cancelled.', 'poocommerce' );
if ( $email_improvements_enabled ) {
	/* translators: %1$s: Order number */
	$text = __( 'We’re getting in touch to let you know that your order #%1$s has been cancelled.', 'poocommerce' );
}
echo sprintf( esc_html( $text ), esc_html( $order->get_order_number() ) ) . "\n\n";

/**
 * Hook: poocommerce_email_order_details.
 *
...
/**
 * Hook: poocommerce_email_order_meta.
 *
...
/**
 * Hook: poocommerce_email_customer_details.
 *
