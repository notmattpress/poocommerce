 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/plain/customer-order-withdrawal-requested.php.
 *
...
echo esc_html__( 'We have received your request to withdraw from the order below.', 'poocommerce' ) . "\n\n";
