...
echo sprintf( esc_html__( "If you'd like to continue with your purchase, please return to %s and try a different method of payment.", 'poocommerce' ), esc_html( $blogname ) ) . "\n\n";
