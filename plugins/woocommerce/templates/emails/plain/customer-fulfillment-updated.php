 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/plain/customer-fulfillment-updated.php.
 *
...
if ( '' !== $customer_note_text ) {
	echo esc_html__( 'Note from the store:', 'poocommerce' ) . "\n";
