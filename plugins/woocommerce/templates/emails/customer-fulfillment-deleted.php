 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/customer-fulfillment-deleted.php.
 *
...
<div class="email-introduction">
	<p><?php echo esc_html__( 'We wanted to let you know that one of the previously fulfilled shipments from your order has been removed from our system. This may have been due to a correction or an update in our fulfillment records. Don’t worry — this won’t affect any items you’ve already received.', 'poocommerce' ); ?></p>
</div>
