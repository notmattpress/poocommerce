...
$header_alignment = get_option( 'poocommerce_email_header_alignment', $email_improvements_enabled ? ( is_rtl() ? 'right' : 'left' ) : false );
$logo_image_width = get_option( 'poocommerce_email_header_image_width', '120' );
$default_font     = 'Helvetica';
$font_family      = $email_improvements_enabled ? get_option( 'poocommerce_email_font_family', $default_font ) : $default_font;
...
if ( $is_email_preview ) {
	...
	$logo_image_width_transient = get_transient( 'poocommerce_email_header_image_width' );
	$font_family_transient      = get_transient( 'poocommerce_email_font_family' );
