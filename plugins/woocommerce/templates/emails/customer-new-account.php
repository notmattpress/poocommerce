...
<?php if ( $email_improvements_enabled ) : ?>
	...
	<p><?php printf( esc_html__( 'Thanks for creating an account on %s. Here’s a copy of your user details.', 'poocommerce' ), esc_html( $blogname ) ); ?></p>
	...
	<p><a href="<?php echo esc_attr( wc_get_page_permalink( 'myaccount' ) ); ?>"><?php printf( esc_html__( 'My account', 'poocommerce' ) ); ?></a></p>
<?php else : ?>
