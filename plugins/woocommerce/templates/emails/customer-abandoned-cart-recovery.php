 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/customer-abandoned-cart-recovery.php.
 *
...
<p><?php esc_html_e( 'Your items are still in your cart. We\'ve saved everything, so come back when you\'re ready.', 'poocommerce' ); ?></p>

<?php if ( ! empty( $recovery_url ) ) : ?>
<p>
	<a href="<?php echo esc_url( $recovery_url ); ?>"><?php esc_html_e( 'Finish checking out', 'poocommerce' ); ?></a>
</p>
<?php endif; ?>
...
<p style="font-size: 12px; line-height: 16px; color: #4d4d4d; margin-top: 24px;">
	<a href="<?php echo esc_url( $unsubscribe_url ); ?>" style="color: #4d4d4d;">
		<?php esc_html_e( 'Unsubscribe from checkout recovery emails', 'poocommerce' ); ?>
	</a>
</p>
	<?php
endif;
