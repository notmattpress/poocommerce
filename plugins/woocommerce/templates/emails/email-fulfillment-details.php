...
if ( null === $fulfillment->get_date_deleted() ) {
	...
	echo wp_kses_post(
		sprintf(
			...
			__( 'You can access more details of your order by visiting <a href="%s" target="_blank">My Account > Orders</a>, and selecting the order you wish to see the latest status for.', 'poocommerce' ),
