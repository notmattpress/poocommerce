 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/admin-order-withdrawal-requested.php.
 *
...
<p><?php esc_html_e( 'A customer submitted an order withdrawal request.', 'poocommerce' ); ?></p>
<?php if ( $matched_order instanceof WC_Order ) : ?>
	<p><?php esc_html_e( 'PooCommerce matched this request to an order and added an order note.', 'poocommerce' ); ?></p>
<?php else : ?>
	<p><?php esc_html_e( 'PooCommerce could not match this request to an order automatically, so no order note was added.', 'poocommerce' ); ?></p>
<?php endif; ?>
...
<?php if ( $matched_order instanceof WC_Order ) : ?>
	...
	<?php if ( '' !== $matched_order->get_edit_order_url() ) : ?>
		<p><a href="<?php echo esc_url( $matched_order->get_edit_order_url() ); ?>"><?php esc_html_e( 'View matched order', 'poocommerce' ); ?></a></p>
	<?php endif; ?>
<?php endif; ?>
