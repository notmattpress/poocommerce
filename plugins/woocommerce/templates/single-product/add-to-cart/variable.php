				...
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					...
					<tr>
						<td colspan="2">
							 ...
							 */
							echo end( $attribute_keys ) === $attribute_name ? wp_kses_post( apply_filters( 'poocommerce_reset_variations_link', '<button class="reset_variations"  aria-label="' . esc_html__( 'Clear options', 'poocommerce' ) . '">' . esc_html__( 'Clear', 'poocommerce' ) . '</button>' ) ) : '';
							?>
						</td>
					</tr>
				<?php endforeach; ?>
