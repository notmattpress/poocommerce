				...
				<tr class="poocommerce-orders-table__row poocommerce-orders-table__row--status-<?php echo esc_attr( $order->get_status() ); ?> order">
					...
					?>
						...
						<?php endif; ?>
							 ...
							 * `poocommerce_my_account_my_orders_column_{$column_id}` action, the
							 ...
							 * @since 11.1.0
							 */
							$filtered_column_content = apply_filters( 'poocommerce_account_orders_column_content_' . $column_id, $column_content, $order, $column_id );
							...
							if ( is_string( $filtered_column_content ) ) {
								...
								wc_doing_it_wrong(
									...
									__( 'Filter callbacks must return a string (or stringable value) of safe, escaped HTML. Return an empty string to render an empty cell. The unfiltered column content was used instead.', 'poocommerce' ),
									'11.1.0'
								);
							}
