	...
	<div class="poocommerce-terms-and-conditions-wrapper">
		...
		<?php if ( wc_terms_and_conditions_checkbox_enabled() ) : ?>
			<p class="form-row validate-required">
				...
				<input type="checkbox" class="poocommerce-form__input poocommerce-form__input-checkbox input-checkbox" name="terms" <?php checked( apply_filters( 'poocommerce_terms_is_checked_default', isset( $_POST['terms'] ) ), true ); // phpcs:ignore WordPress.Security.NonceVerification.Missing, PooCommerce.Commenting.CommentHooks.MissingHookComment -- Presence check only, used to re-render the checkbox; WC_Checkout::process_checkout() verifies the checkout nonce. A docblock cannot precede this inline call without changing the rendered markup. ?> id="terms" />
