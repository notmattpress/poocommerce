...
class ReportCSVExporter extends \WC_CSV_Batch_Exporter {
	 ...
	 *
	 * Unlike the parent, this keeps the file so that the download link PooCommerce emails to the
	...
	public function prepare_data_to_export() {
		...
		// poocommerce_{$export_type}_export_batch_limit and can legitimately
