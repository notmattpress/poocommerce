...
use Automattic\PooCommerce\Admin\Overrides\Order as OverridesOrder;
...
class DataStore extends ReportsDataStore implements DataStoreInterface {
	...
	public static function init() {
		...
		add_action( 'poocommerce_created_customer', array( __CLASS__, 'merge_guest_customer_on_delayed_account_creation' ), 5, 2 );
	}
	 ...
	 *
	 * This runs on poocommerce_created_customer at priority 5, before the analytics
	 * hooks (poocommerce_new_customer) that call update_registered_customer(). It updates
