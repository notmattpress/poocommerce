...
class Controller extends GenericStatsController implements ExportableInterface {
	...
	public function get_export_columns() {
		 ...
		 */
		return apply_filters( 'poocommerce_report_revenue_stats_export_columns', $export_columns );
	}
	...
	public function prepare_item_for_export( $item ) {
		 ...
		 */
		return apply_filters( 'poocommerce_report_revenue_stats_prepare_export_item', $export_item, $item );
	}
}
