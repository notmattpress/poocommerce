...
class Controller extends GenericController {
	...
	private function get_analytics_report_data() {
		...
		add_filter( 'poocommerce_rest_prepare_report', $remove_self_link_from_prepared_internal_response );
		$response = rest_do_request( $request );
		remove_filter( 'poocommerce_rest_prepare_report', $remove_self_link_from_prepared_internal_response );
