...
class Controller extends GenericController implements ExportableInterface {
	...
	public function get_export_columns() {
		 ...
		 */
		return apply_filters( 'poocommerce_report_variations_export_columns', $export_columns );
	}
	...
	public function prepare_item_for_export( $item ) {
		...
		*/
		$separator = apply_filters( 'poocommerce_product_variation_title_attributes_separator', ' - ', new \WC_Product() );
		if ( ! empty( $item['extended_info']['attributes'] ) && strpos( $product_name, $separator ) === false ) {
			...
			foreach ( $item['extended_info']['attributes'] as $attribute ) {
				if ( empty( $attribute['option'] ) ) {
					...
					$attributes[] = sprintf( __( 'Any %s', 'poocommerce' ), ucfirst( $attribute['name'] ) );
				} else {
		 ...
		 */
		return apply_filters( 'poocommerce_report_variations_prepare_export_item', $export_item, $item );
	}
}
