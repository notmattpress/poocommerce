 ...
 * For new settings/options, use Settings REST API (https://developer.poocommerce.com/docs/apis/rest-api/v3/setting-options/#setting-option-properties) or create dedicated endpoints instead.
 *
 * Example:
 * - Use register_rest_route() to create a new endpoint
 * - Follow PooCommerce REST API standards
 * - Implement proper permission checks
 * - Add proper documentation
 * See Automattic\PooCommerce\Admin\API\OnboardingProfile for examples.
 */
...
class Options extends \WC_REST_Data_Controller {
	...
	public static function get_default_option_permissions() {
		...
		$legacy_whitelisted_options = array(
			...
			'poocommerce_woopayments_nox_profile',
			// WC Test helper options.
			'wc-admin-test-helper-rest-api-filters',
			'wc_admin_helper_feature_values',
		);

		return array_fill_keys( $legacy_whitelisted_options, $is_poocommerce_admin );
	}
