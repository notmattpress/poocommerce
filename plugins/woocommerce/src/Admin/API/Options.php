 ...
 * For new settings/options, use Settings REST API (https://poocommerce.github.io/poocommerce-rest-api-docs/#setting-option-properties) or create dedicated endpoints instead.
 *
 * Example:
