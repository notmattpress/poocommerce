...
class Notes extends \WC_REST_CRUD_Controller {
	 ...
	 * Track opened emails.
	 *
	 * @deprecated 10.6.0 This method is no longer functional as the email tracking feature was removed in PooCommerce 9.9.
	 *
	 * @param WP_REST_Request $request Request object.
	 */
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'layout'            => array(
					'description' => __( 'Deprecated. Always returns "plain". Inbox notes no longer support layout variants; this field will be removed in a future release.', 'poocommerce' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
				'image'             => array(
					'description' => __( 'Deprecated. Always returns an empty string. Inbox notes no longer render images; this field will be removed in a future release.', 'poocommerce' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
