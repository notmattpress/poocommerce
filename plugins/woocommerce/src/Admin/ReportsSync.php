...
class ReportsSync {
	...
	public static function init() {
		...
		add_action( 'add_option_poocommerce_date_type', array( ReportsCache::class, 'invalidate' ) );
		add_action( 'update_option_poocommerce_date_type', array( ReportsCache::class, 'invalidate' ) );
