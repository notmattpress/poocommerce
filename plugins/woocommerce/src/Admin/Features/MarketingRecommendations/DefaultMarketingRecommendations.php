	...
	public static function get_all() {
		...
		return array(
			...
			array(
				...
				'description'    => __( 'Automate Facebook & Instagram marketing with Kliken. Launch ads and schedule a month of posts in 5 minutes—first 5 free! Plans start at just $20/mo.', 'poocommerce' ),
				'url'            => "https://poocommerce.com/products/meta-ads-and-pixel/{$utm_string}",
				'direct_install' => true,
