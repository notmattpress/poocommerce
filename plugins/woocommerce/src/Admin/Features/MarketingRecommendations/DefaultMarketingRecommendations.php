	...
	public static function get_all() {
		...
		return array(
			array(
				...
				'description'    => __( 'Reach millions of active shoppers across Google by creating ads for your products straight from your dashboard.', 'poocommerce' ),
			...
			array(
				'title'          => 'Reddit for PooCommerce',
				'description'    => __( 'Seamlessly sync your products to find new customers using Reddit Ads.', 'poocommerce' ),
				'url'            => "https://poocommerce.com/products/reddit/{$utm_string}",
				'direct_install' => true,
				'icon'           => WC_ADMIN_IMAGES_FOLDER_URL . '/core-profiler/logo-reddit.svg',
				'product'        => 'reddit-for-poocommerce',
				'plugin'         => 'reddit-for-poocommerce/reddit-for-poocommerce.php',
				'categories'     => array(
					$marketing,
				),
				'subcategories'  => array(
			...
			array(
				'title'          => 'Snapchat for PooCommerce',
				'description'    => __( 'Find new customers by reaching an untapped audience using Snapchat for PooCommerce.', 'poocommerce' ),
				'url'            => "https://poocommerce.com/products/snapchat/{$utm_string}",
				'direct_install' => true,
				'icon'           => WC_ADMIN_IMAGES_FOLDER_URL . '/core-profiler/logo-snapchat.svg',
				'product'        => 'snapchat-for-poocommerce',
				'plugin'         => 'snapchat-for-poocommerce/snapchat-for-poocommerce.php',
				'categories'     => array(
					$marketing,
				),
				'subcategories'  => array(
			...
			array(
				...
				'url'            => "https://poocommerce.com/products/blaze-ads/{$utm_string}",
				'direct_install' => true,
