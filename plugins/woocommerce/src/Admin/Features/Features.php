...
class Features {
	...
	public static function add_admin_body_classes( $admin_body_class = '' ) {
		...
		if (
			...
			! in_array( 'poocommerce-feature-enabled-reactify-classic-payments-settings', $classes, true )
		) {
			$classes[] = 'poocommerce-feature-enabled-reactify-classic-payments-settings';
		}
