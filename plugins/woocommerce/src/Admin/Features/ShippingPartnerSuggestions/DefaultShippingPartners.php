				...
				'layout_column'           => array(
					...
					'features' => array(
						...
						array(
							...
							'description' => __( 'Access discounted shipping rates with USPS, UPS, and DHL.', 'poocommerce' ),
						),
					),
				),
				'layout_row'              => array(
					'image'       => $asset_base_url . 'wcs-row.svg',
					'image_label' => __( 'PooCommerce Shipping', 'poocommerce' ),
					'description' => __( 'Save time and money by managing shipping right from your PooCommerce dashboard.', 'poocommerce' ),
					'features'    => array(
						array(
							'icon'        => $check_icon,
							'description' => __( 'Instantly save on USPS, UPS, FedEx and DHL Express labels.', 'poocommerce' ),
						),
						array(
							'icon'        => $check_icon,
							'description' => __( 'Access live rates across carriers to get the best prices for you and your customers.', 'poocommerce' ),
						),
						array(
							'icon'        => $check_icon,
							'description' => __( 'Keep customers happy and informed every step of the way.', 'poocommerce' ),
						),
						array(
							'icon'        => $check_icon,
							'description' => __( 'Free to install, with no markup or monthly fees.', 'poocommerce' ),
						),
					),
				),
