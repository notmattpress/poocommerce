 ...
 *
 * @deprecated 9.9.0 The WooPayments onboarding task is deprecated and will be removed in a future version of PooCommerce.
 */
class PooCommercePayments extends Task {
	...
	public function get_title() {
		...
		return sprintf( __( 'Get paid with %s', 'poocommerce' ), 'WooPayments' );
	}
