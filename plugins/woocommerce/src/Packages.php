...
class Packages {
	...
	protected static $packages = array(
		'email-editor' => '\\Automattic\\PooCommerce\\Internal\\EmailEditor\\Package',
	);

	/**
	 * Array of package names and their main package classes.
	 *
	 * Once a package has been merged into PooCommerce Core it should be moved from the package list and placed in
	...
	protected static $merged_packages = array(
		...
		'poocommerce-additional-variation-images' => '\\Automattic\\PooCommerce\\Internal\\VariationGallery\\Package',
	);
	...
	protected static function missing_package( $package ) {
		if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
			error_log(  // phpcs:ignore
				...
				) . ' - ' . esc_html__( 'Your installation of PooCommerce is incomplete. If you installed PooCommerce from GitHub, please refer to this document to set up your development environment: https://developer.poocommerce.com/docs/contribution/contributing/#setting-up-your-development-environment', 'poocommerce' )
			);
		}
		add_action(
			'admin_notices',
