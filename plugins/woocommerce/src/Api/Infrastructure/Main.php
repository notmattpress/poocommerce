...
use Automattic\PooCommerce\Internal\Api\Autogenerated;
use Automattic\PooCommerce\Internal\Api\GraphQLEndpointRegistrar;
...
/**
 * Entry point for the PooCommerce GraphQL API.
 *
...
class Main {
	 ...
	 */
	public const OPTION_GET_ENDPOINT_ENABLED = 'poocommerce_graphql_get_endpoint_enabled';
	 ...
	 */
	public const OPTION_APQ_ENABLED = 'poocommerce_graphql_apq_enabled';
	 ...
	 */
	public const OPTION_ENDPOINT_URL = 'poocommerce_graphql_endpoint_url';
	 ...
	 */
	public const OPTION_MAX_QUERY_DEPTH = 'poocommerce_graphql_max_query_depth';
	 ...
	 */
	public const OPTION_MAX_QUERY_COMPLEXITY = 'poocommerce_graphql_max_query_complexity';
	 ...
	 */
	public const OPTION_OPCACHE_ENABLED = 'poocommerce_graphql_opcache_enabled';

	/**
	 * Option name for the "ObjectCache-based caching" setting.
	 */
	public const OPTION_OBJECT_CACHE_ENABLED = 'poocommerce_graphql_object_cache_enabled';
	 ...
	 */
	public const OPTION_QUERY_CACHE_TTL = 'poocommerce_graphql_query_cache_ttl';
	 ...
	 * endpoint" rule so both PooCommerce core's own endpoint and every sibling
	 ...
	 * Automattic\PooCommerce\Api\ namespace remain autoloadable — extensions
	...
	/**
	 * Hook callback: register PooCommerce core's GraphQL endpoint.
	 *
	 * @internal
	 */
	 ...
	 *
	 * Intended for sibling PooCommerce plugins that ship their own
	 ...
	 *
	 *     if ( method_exists( \Automattic\PooCommerce\Api\Infrastructure\Main::class, 'register_graphql_endpoint' ) ) {
	 *         \Automattic\PooCommerce\Api\Infrastructure\Main::register_graphql_endpoint(
	 *             __DIR__,
	 *             'my-plugin',
	 *             '/graphql'
	 *         );
