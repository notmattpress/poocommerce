...
class MiniCartContents extends AbstractBlock {
	...
	protected function render_experimental_iapi_mini_cart_contents( $attributes, $content, $block ) {
		ob_start();
		?>
		<div data-wp-interactive="poocommerce/mini-cart-contents" class="wp-block-poocommerce-mini-cart-contents">
			<div class="wc-block-components-drawer__close-wrapper">
				<button data-wp-on--click="poocommerce/mini-cart::callbacks.closeDrawer" class="wc-block-components-button wp-element-button wc-block-components-drawer__close contained" aria-label="Close" type="button">
