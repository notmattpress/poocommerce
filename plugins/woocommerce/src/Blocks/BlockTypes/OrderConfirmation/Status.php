	...
	protected function render_content( $order, $permission = false, $attributes = [], $content = '' ) {
		...
		switch ( $status ) {
			...
			case 'completed':
				...
				break;
			case 'failed':
				$default_order_failed_text = esc_html__( 'Your order cannot be processed as the originating bank/merchant has declined your transaction. Please attempt your purchase again.', 'poocommerce' );
				...
				// phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment
				$legacy_order_failed_text = apply_filters( 'poocommerce_thankyou_order_received_text', $default_order_failed_text, null );
				 ...
				 * @since 11.2.0
				 */
				$filtered_order_failed_text = apply_filters( 'poocommerce_thankyou_order_failed_text', $order_failed_text, $order );
