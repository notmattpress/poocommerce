			...
			<div class="<?php echo esc_attr( $content_class ); ?>">
				<div class="wc-block-product-filter-price-slider__left text">
					<?php if ( $show_input_fields ) : ?>
						<input
							class="min"
							type="text"
							data-wp-bind--value="poocommerce/product-filter-price::state.formattedMinPrice"
							data-wp-on--focus="actions.selectInputContent"
							data-wp-on--input="actions.debounceSetPrice"
							data-wp-on--change--set-price="poocommerce/product-filter-price::actions.setMinPrice"
							data-wp-on--change--navigate="poocommerce/product-filters::actions.navigate"
						/>
					<?php else : ?>
						<span data-wp-text="poocommerce/product-filter-price::state.formattedMinPrice"><?php echo wp_kses_post( $formatted_min_price ); ?></span>
					<?php endif; ?>
				</div>
				<div
				...
				>
					...
					<input
						...
						data-wp-bind--value="poocommerce/product-filter-price::state.minPrice"
						data-wp-bind--min="poocommerce/product-filter-price::context.minRange"
						data-wp-bind--max="poocommerce/product-filter-price::context.maxRange"
						data-wp-on--input--update-price="poocommerce/product-filter-price::actions.setMinPrice"
						data-wp-on--input--limit-range="actions.limitRange"
						data-wp-on--mouseup="poocommerce/product-filters::actions.navigate"
						data-wp-on--keyup="poocommerce/product-filters::actions.navigate"
						data-wp-on--touchend="poocommerce/product-filters::actions.navigate"
					/>
					<input
						type="range"
						class="max"
						min="<?php echo esc_attr( $min_range ); ?>"
						max="<?php echo esc_attr( $max_range ); ?>"
						data-wp-bind--value="poocommerce/product-filter-price::state.maxPrice"
						data-wp-bind--min="poocommerce/product-filter-price::context.minRange"
						data-wp-bind--max="poocommerce/product-filter-price::context.maxRange"
						data-wp-on--input--update-price="poocommerce/product-filter-price::actions.setMaxPrice"
						data-wp-on--input--limit-range="actions.limitRange"
						data-wp-on--mouseup="poocommerce/product-filters::actions.navigate"
						data-wp-on--keyup="poocommerce/product-filters::actions.navigate"
						data-wp-on--touchend="poocommerce/product-filters::actions.navigate"
				...
				<div class="wc-block-product-filter-price-slider__right text">
					<?php if ( $show_input_fields ) : ?>
						<input
							class="max"
							type="text"
							data-wp-bind--value="poocommerce/product-filter-price::state.formattedMaxPrice"
							data-wp-on--focus="actions.selectInputContent"
							data-wp-on--input="actions.debounceSetPrice"
							data-wp-on--change--set-price="poocommerce/product-filter-price::actions.setMaxPrice"
							data-wp-on--change--navigate="poocommerce/product-filters::actions.navigate"
						/>
					<?php else : ?>
					<span data-wp-text="poocommerce/product-filter-price::state.formattedMaxPrice"><?php echo wp_kses_post( $formatted_max_price ); ?></span>
					<?php endif; ?>
				</div>
			</div>
		</div>
