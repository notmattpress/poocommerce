...
class MiniCart extends AbstractBlock {
	...
	protected function render_experimental_iapi_mini_cart( $attributes, $content, $block ) {
		...
		<div <?php echo wp_interactivity_data_wp_context( $context ); ?> data-wp-interactive="poocommerce/mini-cart" class="<?php echo esc_attr( $wrapper_classes ); ?>" style="<?php echo esc_attr( $wrapper_styles ); ?>">
			<button data-wp-on--click="callbacks.openDrawer" class="wc-block-mini-cart__button" aria-label="<?php echo esc_attr( __( 'Cart', 'poocommerce' ) ); ?>">
