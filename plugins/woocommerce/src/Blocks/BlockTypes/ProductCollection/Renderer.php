...
class Renderer {
	...
	public function enhance_product_collection_with_interactivity( $block_content, $block ) {
		...
		if ( $is_product_collection_block ) {
			...
			$context                        = array(
				...
				'ariaLabelPrevious'  => __( 'Scroll products left', 'poocommerce' ),
				'ariaLabelNext'      => __( 'Scroll products right', 'poocommerce' ),
			);
	...
	public function extend_context_for_inner_blocks( $context ) {
		...
		$context['iapi/provider'] = 'poocommerce/product-collection';
