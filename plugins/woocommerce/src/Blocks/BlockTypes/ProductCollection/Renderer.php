...
class Renderer {
	...
	protected function render_interactivity_notices_region() {
		wp_enqueue_script_module( 'poocommerce/product-collection-notices' );
		...
		ob_start();
		?>
		<div class="wc-block-store-notices poocommerce alignwide wp-block-poocommerce-store-notices">
			<div data-wp-interactive="poocommerce/product-collection-notices" class="poocommerce-notices-wrapper">
				<template
