...
class SingleProductTemplateCompatibility extends AbstractTemplateCompatibility {
	...
	protected function set_hook_data() {
		$this->hook_data = array(
			...
			'poocommerce_before_add_to_cart_form'       => array(
				'block_names' => array( 'poocommerce/add-to-cart-with-options' ),
				'position'    => 'before',
				'hooked'      => array(),
			),
			'poocommerce_after_add_to_cart_form'        => array(
				'block_names' => array( 'poocommerce/add-to-cart-with-options' ),
				'position'    => 'after',
				'hooked'      => array(),
			),
	...
	private static function has_single_product_template_blocks( $parsed_blocks ) {
		$single_product_template_blocks = array( 'poocommerce/product-image-gallery', 'poocommerce/product-gallery', 'poocommerce/product-details', 'poocommerce/add-to-cart-form', 'poocommerce/add-to-cart-with-options', 'poocommerce/product-meta', 'poocommerce/product-price', 'poocommerce/breadcrumbs' );
