...
class SingleProductTemplate extends AbstractTemplate {
	...
	private static function replace_first_single_product_template_block_with_password_form( $parsed_blocks, $is_already_replaced ) {
		...
		$single_product_template_blocks = array( 'poocommerce/product-image-gallery', 'poocommerce/product-details', 'poocommerce/add-to-cart-form', 'poocommerce/product-meta', 'poocommerce/product-rating', 'poocommerce/product-price', 'poocommerce/related-products', 'poocommerce/add-to-cart-with-options', 'poocommerce/product-gallery', 'poocommerce/blockified-product-details', 'poocommerce/product-collection', 'core/post-title', 'core/post-excerpt' );
