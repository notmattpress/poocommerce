...
class OrderCountCacheService {
	...
	public const BACKGROUND_EVENT_HOOK = 'poocommerce_refresh_order_count_cache';
	 ...
	 *
	 * @internal
	 * @deprecated 10.7.0 Was used for handling `poocommerce_refresh_order_count_cache` actions.
	 *
