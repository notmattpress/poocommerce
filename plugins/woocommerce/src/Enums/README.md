...
- [CatalogSortOrder](./CatalogSortOrder.php) - Enumerates the possible values of the `poocommerce_default_catalog_orderby` option.
- [CatalogVisibility](./CatalogVisibility.php) - Enumerates the possible catalog visibility options for a product.
- [CurrencyPosition](./CurrencyPosition.php) - Enumerates the possible values of the `poocommerce_currency_pos` option.
- [DefaultCustomerAddress](./DefaultCustomerAddress.php) - Enumerates the possible values of the `poocommerce_default_customer_address` option.
- [DimensionUnit](./DimensionUnit.php) - Enumerates the possible values of the `poocommerce_dimension_unit` option.
...
- [StockDisplayFormat](./StockDisplayFormat.php) - Enumerates the possible values of the `poocommerce_stock_format` option.
- [TaxBasedOn](./TaxBasedOn.php) - Enumerates the possible values of the `poocommerce_tax_based_on` option.
- [TaxDisplayMode](./TaxDisplayMode.php) - Enumerates the possible values of the `poocommerce_tax_display_shop` and `poocommerce_tax_display_cart` options.
- [WeightUnit](./WeightUnit.php) - Enumerates the possible values of the `poocommerce_weight_unit` option.
