...
use Automattic\PooCommerce\Enums\StockDisplayFormat;
...
class ProductSchema extends AbstractSchema {
	...
	public function get_properties() {
		return [
			...
			'brands'                => [
				'description' => __( 'List of brands, if applicable.', 'poocommerce' ),
				'type'        => 'array',
				'context'     => [ 'view', 'edit', 'embed' ],
				'items'       => [
					'type'       => 'object',
					'properties' => [
						...
						'link' => [
							'description' => __( 'Brand link', 'poocommerce' ),
							'type'        => 'string',
							'context'     => [ 'view', 'edit', 'embed' ],
							'readonly'    => true,
						],
			...
			'grouped_products'      => [
				'description' => __( 'List of grouped product IDs, if applicable.', 'poocommerce' ),
				'type'        => 'array',
				'context'     => [ 'view', 'edit', 'embed' ],
				'items'       => [
					'description' => __( 'List of grouped product ids.', 'poocommerce' ),
					'type'        => 'integer',
					'context'     => [ 'view', 'edit', 'embed' ],
					'readonly'    => true,
				],
			...
			'weight'                => [
				'description' => sprintf(
					...
					__( 'Product weight (%s).', 'poocommerce' ),
					get_option( 'poocommerce_weight_unit' )
				),
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				...
				'properties'  => [
					'length' => [
						'description' => sprintf(
							...
							__( 'Product length (%s).', 'poocommerce' ),
							get_option( 'poocommerce_dimension_unit' )
						),
						'type'        => 'string',
						'context'     => [ 'view', 'edit' ],
						'readonly'    => true,
					...
					'width'  => [
						'description' => sprintf(
							/* translators: %s: dimension unit */
							__( 'Product width (%s).', 'poocommerce' ),
							get_option( 'poocommerce_dimension_unit' )
						),
						'type'        => 'string',
						'context'     => [ 'view', 'edit' ],
					...
					'height' => [
						'description' => sprintf(
							/* translators: %s: dimension unit */
							__( 'Product height (%s).', 'poocommerce' ),
							get_option( 'poocommerce_dimension_unit' )
						),
						'type'        => 'string',
						'context'     => [ 'view', 'edit' ],
			...
			'formatted_weight'      => [
				'description' => __( 'Product weight formatted for display (e.g. "2.5 kg").', 'poocommerce' ),
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
			],
			'formatted_dimensions'  => [
				'description' => __( 'Product dimensions formatted for display (e.g. "10 × 5 × 3 cm").', 'poocommerce' ),
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
			],
			'add_to_cart'           => [
				...
				'properties'  => [
					...
					'single_text' => [
						'description' => __( 'Button text in the single product page.', 'poocommerce' ),
						'type'        => 'string',
						'context'     => [ 'view', 'edit', 'embed' ],
						'readonly'    => true,
					],
			...
			'is_password_protected' => [
				'description' => __( 'Whether the product or its parent requires a password to access its content.', 'poocommerce' ),
				'type'        => 'boolean',
				'context'     => [ 'view', 'edit', 'embed' ],
				'readonly'    => true,
			],
	...
	protected function get_tax_display_mode( $tax_display_mode = '' ) {
		return in_array( $tax_display_mode, [ TaxDisplayMode::INCLUSIVE, TaxDisplayMode::EXCLUSIVE ], true ) ? $tax_display_mode : get_option( 'poocommerce_tax_display_shop' );
	}
