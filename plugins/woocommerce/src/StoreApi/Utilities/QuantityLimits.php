...
final class QuantityLimits {
	...
	public function validate_cart_item_quantity( $quantity, $cart_item ) {
		 ...
		 * poocommerce_store_api_validate_add_to_cart action for that. When an already-in-cart item is
		 ...
		 * @return \WP_Error|true
		 */
		$valid = apply_filters( 'poocommerce_store_api_cart_item_quantity_validation', true, $quantity, $product, $cart_item );
