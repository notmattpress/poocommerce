...
",
	...
	public function read_multiple( &$orders ) {
		...
		if ( $data_sync_enabled ) {
			...
			$should_sync_on_read = ! doing_action( 'poocommerce_deliver_webhook_async' ) && ! doing_action( 'wc-admin_import_orders' );
			 ...
			 * @since 8.1.0
			 */
			$data_sync_enabled = apply_filters( 'poocommerce_hpos_enable_sync_on_read', $should_sync_on_read );
		}
