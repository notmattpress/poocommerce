...
class WCTransactionalEmailPostsGenerator {
	...
	public function get_email_template( $email ) {
		 ...
		 * @since 10.7.0
		 */
		$template_html = apply_filters( 'poocommerce_email_block_template_html', $template_html, $email );
	...
	private function generate_single_template( $email_type, $email_data ) {
		 ...
		 */
		$post_data = apply_filters( 'poocommerce_email_content_post_data', $post_data, $email_type, $email_data );
