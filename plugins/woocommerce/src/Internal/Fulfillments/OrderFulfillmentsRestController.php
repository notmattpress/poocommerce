 ...
 *
 * @package Automattic\PooCommerce\Internal\Fulfillments
 */
class OrderFulfillmentsRestController extends RestApiControllerBase {
	...
	private function get_schema_for_get_fulfillments(): array {
		...
		$schema['properties'] = array(
			'fulfillment' => array(
				'description' => __( 'The fulfillment object.', 'poocommerce' ),
				'type'        => 'array',
				'required'    => true,
	...
	private function get_schema_for_create_fulfillment(): array {
		...
		$schema['properties'] = array(
			'fulfillment' => array(
				'description' => __( 'The created fulfillment object.', 'poocommerce' ),
				'type'        => 'object',
				'required'    => true,
				'schema'      => $this->get_read_schema_for_fulfillment(),
			),
	...
	private function get_schema_for_get_tracking_number_details(): array {
		...
		$schema['properties'] = array(
			'tracking_number_details' => array(
				'description' => __( 'The tracking number details.', 'poocommerce' ),
				'type'        => 'object',
				'required'    => true,
				'properties'  => array(
					'tracking_number'   => array(
	...
	private function get_read_schema_for_fulfillment() {
		return array(
			...
			'date_updated'   => array(
				'description' => __( 'The date the fulfillment was created.', 'poocommerce' ),
				'type'        => 'string',
				'context'     => array( 'view', 'edit' ),
				'readonly'    => true,
				'required'    => true,
