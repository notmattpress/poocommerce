	...
	protected function get_shipping_method_restriction_field_overrides( WC_Payment_Gateway $gateway ): array {
		...
		return array(
			'enable_for_methods' => array(
				...
				'desc'    => sprintf( __( 'Choose which shipping methods support %s.', 'poocommerce' ), $method_title ),
			...
			'enable_for_virtual' => array(
				...
				'type'  => 'checkbox',
				/* translators: %s: payment method title. */
				'desc'  => sprintf( __( 'Accept %s if the order is virtual', 'poocommerce' ), $method_title ),
			),
		);
	}
