				...
				array(
					...
					'args'                => array_merge(
						...
						array(
							...
							'username' => array(
								'required'    => false,
								'description' => __( 'New user username. Generated from email if not provided.', 'poocommerce' ),
								'type'        => 'string',
							),
							'password' => array(
								'required'    => false,
								'description' => __( 'New user password. Generated automatically if not provided.', 'poocommerce' ),
								'type'        => 'string',
							),
						)
					),
