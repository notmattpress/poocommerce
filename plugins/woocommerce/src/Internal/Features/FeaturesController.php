 ...
 *
 * Important: some of the features are defined from inside the 'poocommerce_register_feature_definitions' hook.
...
class FeaturesController {
	...
	public function __construct() {
		if ( did_action( 'init' ) ) {
			...
			add_filter( 'init', array( $this, 'register_additional_features' ), 1, 0 ); // This needs to have a higher $priority than the 'init' hooked in class-poocommerce.
		}
	...
	/**
	 * Function to trigger the 'poocommerce_register_feature_definitions' hook.
	 *
