...
use Automattic\PooCommerce\Admin\Features\Features as WCAdminFeatures;
...
class FeaturesController {
	...
	public function __construct() {
		...
		add_action( 'poocommerce_settings_advanced', array( $this, 'maybe_render_abandoned_cart_recovery_enabled_notice' ), 1 );
		add_filter( 'poocommerce_settings-advanced', array( $this, 'add_point_of_sale_setting_for_rest_api' ), 10, 1 ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
	}
	...
	private function init_feature_definitions(): void {
		...
		$legacy_features = array(
			'analytics'                            => array(
				'name'                         => __( 'PooCommerce Analytics', 'poocommerce' ),
				'description'                  => __( 'Enable PooCommerce Analytics to track your store\'s key metrics and view them in a detailed dashboard. All data stays within your store.', 'poocommerce' ),
			...
			ProductMediaGallery::FEATURE_ID        => array(
				'name'                         => __( 'Product gallery videos', 'poocommerce' ),
				'description'                  => __( 'Enable videos in product galleries.', 'poocommerce' ),
			...
			'order_withdrawal'                     => array(
				'name'                         => __( 'Order withdrawal', 'poocommerce' ),
				'description'                  => __( 'Enable the public order withdrawal feature for customer requests.', 'poocommerce' ),
				'learn_more_url'               => 'https://poocommerce.com/document/customer-order-withdrawal/',
				'enabled_by_default'           => false,
				'disable_ui'                   => false,
				'default_plugin_compatibility' => FeaturePluginCompatibility::COMPATIBLE,
				'is_experimental'              => false,
			...
			'deferred_transactional_emails'        => array(
				'name'                         => __( 'Deferred emails', 'poocommerce' ),
				'description'                  => __(
			...
			'customer_review_request'              => array(
				'name'                         => __( 'Customer review request (beta)', 'poocommerce' ),
				'description'                  => __(
			...
			'abandoned_cart_recovery'              => array(
				'name'                         => __( 'Abandoned cart recovery', 'poocommerce' ),
				'description'                  => __(
			...
			\Automattic\PooCommerce\Internal\VariationGallery\Package::FEATURE_ID => array(
				'name'                         => __( 'Variation gallery', 'poocommerce' ),
				'description'                  => __(
				...
				'option_key'                   => \Automattic\PooCommerce\Internal\VariationGallery\Package::ENABLE_OPTION_NAME,
				'is_experimental'              => true,
				'enabled_by_default'           => \Automattic\PooCommerce\Internal\VariationGallery\Package::is_in_canary_cohort(),
				'skip_compatibility_checks'    => true,
				'default_plugin_compatibility' => FeaturePluginCompatibility::COMPATIBLE,
			),
			'wc-visual-attribute'                  => array(
				'name'                         => __( 'Color swatches for attributes', 'poocommerce' ),
				'description'                  => __(
					'Add color swatches to product attribute values.',
					'poocommerce'
				),
				'option_key'                   => 'poocommerce_feature_wc_visual_attribute_enabled',
				'is_experimental'              => true,
				'enabled_by_default'           => false,
				'disable_ui'                   => false,
				'skip_compatibility_checks'    => true,
			...
			'dual_code_graphql_api'                => array(
				'name'                         => __( 'Dual Code & GraphQL API', 'poocommerce' ),
				'description'                  => __(
					'Experimental code-first API for PooCommerce with automatic GraphQL endpoint generation. Requires PHP 8.1 or later.',
					'poocommerce'
				),
				'enabled_by_default'           => false,
				'is_experimental'              => true,
			...
			'cart_save_for_later'                  => array(
				'name'                         => __( 'Save for Later in Cart', 'poocommerce' ),
				'description'                  => __(
				...
				'option_key'                   => 'poocommerce_cart_save_for_later_enabled',
				'default_plugin_compatibility' => FeaturePluginCompatibility::COMPATIBLE,
			),
			'product_wishlist'                     => array(
				'name'                         => __( 'Wishlists', 'poocommerce' ),
				'description'                  => __(
				...
				'is_experimental'              => true,
				'enabled_by_default'           => false,
				'option_key'                   => 'poocommerce_product_wishlist_enabled',
				'default_plugin_compatibility' => FeaturePluginCompatibility::COMPATIBLE,
			),
			...
			BlockEditorUnifiedAssets::FEATURE_NAME => array(
				'name'                         => __( 'Unified block editor assets', 'poocommerce' ),
				'description'                  => __( 'Load PooCommerce block editor scripts and styles from shared bundles to improve editor performance.', 'poocommerce' ),
		...
		wp_prime_option_caches(
			array_map(
				static fn( $slug, $definition ) => $definition['option_key'] ?? sprintf( 'poocommerce_feature_%s_enabled', $slug ),
	...
	/**
	 * Handler for the 'poocommerce_settings-advanced' hook, which defines the settings
	 * exposed in the wc/v3 settings REST API for the 'advanced' group. It appends the
	 * Point of Sale feature flag setting.
	 *
	 * This is a compatibility shim for the PooCommerce mobile apps: app versions released
	 * before the point_of_sale feature became always enabled (deprecated in 11.0.0) read and
	 * write this setting via wc/v3/settings/advanced/poocommerce_feature_point_of_sale_enabled
	...
	public function add_point_of_sale_setting_for_rest_api( $settings ): array {
		$settings[] = array(
			'id'          => 'poocommerce_feature_point_of_sale_enabled',
			'option_key'  => 'poocommerce_feature_point_of_sale_enabled',
			'label'       => __( 'Point of Sale', 'poocommerce' ),
			'description' => __( 'Enable Point of Sale functionality in the PooCommerce mobile apps.', 'poocommerce' ),
			'type'        => 'checkbox',
			'default'     => 'yes',
		);
		return $settings;
	 ...
	 * picks it up the next time `poocommerce_settings_advanced` fires.
	 *
	 ...
	 * configure it.
	 *
	 * Hooks into `poocommerce_settings_advanced` at priority 1, which fires
	...
	public function maybe_render_abandoned_cart_recovery_enabled_notice(): void {
		...
		printf(
			...
			esc_html__( 'Abandoned cart recovery is enabled.', 'poocommerce' ),
			esc_url( $settings_url ),
			esc_html__( 'Configure the recovery email →', 'poocommerce' )
		);
	}
