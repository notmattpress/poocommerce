...
use Automattic\PooCommerce\Api\Mutations\Products\UpdateProduct as UpdateProductCommand;
...
use Automattic\PooCommerce\Internal\Api\Autogenerated\GraphQLTypes\Input\UpdateProduct as UpdateProductInput;
...
class UpdateProduct {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Update an existing product.', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'input' => array(
					...
					'description' => __( 'The fields to update.', 'poocommerce' ),
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Api\Infrastructure\ClassResolver::resolve_class( UpdateProductCommand::class );
	...
	private static function convert_dimensions_input( array $data ): \Automattic\PooCommerce\Api\InputTypes\Products\DimensionsInput {
		$input = new \Automattic\PooCommerce\Api\InputTypes\Products\DimensionsInput();
	...
	private static function convert_update_product_input( array $data ): \Automattic\PooCommerce\Api\InputTypes\Products\UpdateProductInput {
		$input = new \Automattic\PooCommerce\Api\InputTypes\Products\UpdateProductInput();
