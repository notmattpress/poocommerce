...
use Automattic\PooCommerce\Api\Mutations\Coupons\CreateCoupon as CreateCouponCommand;
...
use Automattic\PooCommerce\Internal\Api\Autogenerated\GraphQLTypes\Input\CreateCoupon as CreateCouponInput;
...
class CreateCoupon {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Create a new coupon.', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'input' => array(
					...
					'description' => __( 'Data for the new coupon.', 'poocommerce' ),
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Api\Infrastructure\ClassResolver::resolve_class( CreateCouponCommand::class );
	...
	private static function convert_create_coupon_input( array $data ): \Automattic\PooCommerce\Api\InputTypes\Coupons\CreateCouponInput {
		$input = new \Automattic\PooCommerce\Api\InputTypes\Coupons\CreateCouponInput();
