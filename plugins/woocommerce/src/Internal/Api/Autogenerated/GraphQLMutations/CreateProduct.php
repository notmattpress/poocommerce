...
use Automattic\PooCommerce\Api\Mutations\Products\CreateProduct as CreateProductCommand;
...
use Automattic\PooCommerce\Internal\Api\Autogenerated\GraphQLTypes\Input\CreateProduct as CreateProductInput;
...
class CreateProduct {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Create a new product.', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'input' => array(
					...
					'description' => __( 'Data for the new product.', 'poocommerce' ),
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Api\Infrastructure\ClassResolver::resolve_class( CreateProductCommand::class );
	...
	public static function compute_preauthorized( \Automattic\PooCommerce\Api\Infrastructure\Principal $principal ): bool {
		return ( new \Automattic\PooCommerce\Api\Attributes\RequiredCapability( 'edit_products' ) )->authorize( $principal );
	}
	...
	private static function convert_create_product_input( array $data ): \Automattic\PooCommerce\Api\InputTypes\Products\CreateProductInput {
		$input = new \Automattic\PooCommerce\Api\InputTypes\Products\CreateProductInput();
