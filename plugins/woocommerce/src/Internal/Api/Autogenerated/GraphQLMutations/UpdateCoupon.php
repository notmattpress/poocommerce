...
use Automattic\PooCommerce\Api\Mutations\Coupons\UpdateCoupon as UpdateCouponCommand;
...
use Automattic\PooCommerce\Internal\Api\Autogenerated\GraphQLTypes\Input\UpdateCoupon as UpdateCouponInput;
...
class UpdateCoupon {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Update an existing coupon.', 'poocommerce' ),
			'authorization' => array(
				array(
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Api\Infrastructure\ClassResolver::resolve_class( UpdateCouponCommand::class );
	...
	private static function convert_update_coupon_input( array $data ): \Automattic\PooCommerce\Api\InputTypes\Coupons\UpdateCouponInput {
		$input = new \Automattic\PooCommerce\Api\InputTypes\Coupons\UpdateCouponInput();
