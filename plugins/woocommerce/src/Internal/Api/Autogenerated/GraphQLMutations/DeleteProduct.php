...
use Automattic\PooCommerce\Api\Mutations\Products\DeleteProduct as DeleteProductCommand;
...
class DeleteProduct {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Delete a product.', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'id'    => array(
					...
					'description' => __( 'The ID of the product to delete.', 'poocommerce' ),
				),
				'force' => array(
					'type'         => Type::nonNull( Type::boolean() ),
					'description'  => __( 'Whether to permanently delete the product (bypass trash).', 'poocommerce' ),
					'defaultValue' => false,
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Api\Infrastructure\ClassResolver::resolve_class( DeleteProductCommand::class );
