...
use Automattic\PooCommerce\Api\Queries\Products\GetProduct as GetProductCommand;
...
class GetProduct {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'Retrieve a single product by ID.', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				'id' => array(
					...
					'description' => __( 'The ID of the product to retrieve.', 'poocommerce' ),
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Api\Infrastructure\ClassResolver::resolve_class( GetProductCommand::class );
	...
	public static function compute_preauthorized( \Automattic\PooCommerce\Api\Infrastructure\Principal $principal ): bool {
		return ( new \Automattic\PooCommerce\Api\Attributes\RequiredCapability( 'read_product' ) )->authorize( $principal );
	}
}
