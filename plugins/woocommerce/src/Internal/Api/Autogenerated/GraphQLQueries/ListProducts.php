...
use Automattic\PooCommerce\Api\Queries\Products\ListProducts as ListProductsCommand;
...
use Automattic\PooCommerce\Internal\Api\Autogenerated\GraphQLTypes\Pagination\ProductConnection as ProductConnectionType;
...
class ListProducts {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'List products with cursor-based pagination and optional filtering.', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				...
				'product_type' => array(
					...
					'description'  => __( 'Filter by product type.', 'poocommerce' ),
					'defaultValue' => null,
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Api\Infrastructure\ClassResolver::resolve_class( ListProductsCommand::class );
		...
		$execute_args['filters']    = ResolverHelpers::create_input(
			fn() => new \Automattic\PooCommerce\Api\InputTypes\Products\ProductFilterInput(
				status: $args['status'],
	...
	public static function compute_preauthorized( \Automattic\PooCommerce\Api\Infrastructure\Principal $principal ): bool {
		return ( new \Automattic\PooCommerce\Api\Attributes\RequiredCapability( 'manage_poocommerce' ) )->authorize( $principal ) && ( new \Automattic\PooCommerce\Api\Attributes\RequiredCapability( 'edit_products' ) )->authorize( $principal );
	}
}
