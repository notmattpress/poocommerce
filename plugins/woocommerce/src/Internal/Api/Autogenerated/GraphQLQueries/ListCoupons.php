...
use Automattic\PooCommerce\Api\Queries\Coupons\ListCoupons as ListCouponsCommand;
...
use Automattic\PooCommerce\Internal\Api\Autogenerated\GraphQLTypes\Pagination\CouponConnection as CouponConnectionType;
...
class ListCoupons {
	public static function get_field_definition(): array {
		return array(
			...
			'description'   => __( 'List coupons with cursor-based pagination.', 'poocommerce' ),
			'authorization' => array(
				array(
			...
			'args'          => array(
				...
				'status' => array(
					...
					'description'  => __( 'Filter by coupon status.', 'poocommerce' ),
					'defaultValue' => null,
				),
			),
	...
	public static function resolve( mixed $root, array $args, mixed $context, ResolveInfo $info ): mixed {
		...
		$command = \Automattic\PooCommerce\Api\Infrastructure\ClassResolver::resolve_class( ListCouponsCommand::class );
