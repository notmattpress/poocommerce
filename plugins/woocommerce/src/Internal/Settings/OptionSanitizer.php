...
class OptionSanitizer {
	...
	public function __construct() {
		...
		add_filter( 'poocommerce_admin_settings_sanitize_option_poocommerce_notify_low_stock_amount', 'absint' );
	...
	public function sanitize_price_separator_setting( $option_id, $raw_value ) {
		...
		if ( null !== $raw_value ) {
			\WC_Admin_Settings::add_error( __( 'Thousand and decimal separators cannot contain numbers.', 'poocommerce' ) );
		}
