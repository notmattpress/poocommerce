...
<div class="wrap poocommerce-customer-stock-notifications">
	...
	<?php } else { ?>
		...
		<div class="poocommerce-BlankState poocommerce-BlankState--stock-notifications">
			...
			<a class="poocommerce-BlankState-cta button button-secondary" target="_blank" rel="noopener noreferrer" href="https://poocommerce.com/document/back-in-stock-notifications"><?php esc_html_e( 'Learn more', 'poocommerce' ); ?></a>
		</div>
