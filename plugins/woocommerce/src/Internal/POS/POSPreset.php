 ...
 *
 * Presets are UI-curated bundles of `poocommerce_pos_*` capabilities (Cashier / Manager /
 ...
 *
 * Constant class rather than a native PHP enum so it stays within PooCommerce's
 * PHP 7.4 minimum.
 *
 * @since 11.0.0
 * @internal
