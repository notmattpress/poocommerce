	...
	private function add_cogs_related_product_schema( array $schema, bool $for_variations_controller ): array {
		$schema['properties']['cost_of_goods_sold'] = array(
			...
			'properties'  => array(
				...
				'defined_value_overrides_parent' => array(
					'description' => __( 'Applies to variations only. If true, the defined value is the final effective value; if false, the effective value is the base value from the parent product plus the defined value.', 'poocommerce' ),
					'type'        => 'boolean',
					'default'     => false,
					'context'     => array( 'view', 'edit' ),
				),
		...
		if ( $for_variations_controller ) {
			$schema['properties']['cost_of_goods_sold']['properties']['defined_value_overrides_parent']['description'] =
				__( 'If true, the defined value is the final effective value; if false, the effective value is the base value from the parent product plus the defined value.', 'poocommerce' );
		}
