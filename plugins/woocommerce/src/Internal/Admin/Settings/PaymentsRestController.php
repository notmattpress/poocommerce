			...
			'properties'  => array(
				...
				'onboarding'     => array(
					...
					'properties'  => array(
						...
						'messages'                    => array(
							'type'                 => 'object',
							'description'          => esc_html__( 'Various messages to possibly show the user.', 'poocommerce' ),
							'context'              => array( 'view', 'edit' ),
							'readonly'             => true,
							'additionalProperties' => array(
								'type'        => 'string',
								'description' => esc_html__( 'Message to show the user.', 'poocommerce' ),
								'readonly'    => true,
							),
						),
						'steps'                       => array(
							'type'        => 'array',
							'description' => esc_html__( 'The onboarding steps in case this provider supports native in-context onboarding.', 'poocommerce' ),
							'context'     => array( 'view', 'edit' ),
							'readonly'    => true,
						),
						'_links'                      => array(
							...
							'properties' => array(
								...
								'disable_test_account' => array(
									'type'        => 'object',
									'description' => esc_html__( 'The link to disable the test account for the payment gateway.', 'poocommerce' ),
									'context'     => array( 'view', 'edit' ),
									'readonly'    => true,
									'properties'  => array(
										'href' => array(
											'type'        => 'string',
											'description' => esc_html__( 'The URL to POST to disable the test account for the payment gateway.', 'poocommerce' ),
											'context'     => array( 'view', 'edit' ),
											'readonly'    => true,
										),
									),
								...
								'reset'                => array(
									'type'        => 'object',
									'description' => esc_html__( 'The link to reset the provider state/account and restart the onboarding.', 'poocommerce' ),
									'context'     => array( 'view', 'edit' ),
									'readonly'    => true,
									'properties'  => array(
										'href' => array(
											'type'        => 'string',
											'description' => esc_html__( 'The URL to POST to for resetting the provider onboarding.', 'poocommerce' ),
											'context'     => array( 'view', 'edit' ),
											'readonly'    => true,
										),
									),
						...
						'recommended_payment_methods' => array(
							...
							'items'       => array(
								...
								'properties'  => array(
									...
									'notice'      => array(
										'type'        => 'object',
										'description' => esc_html__( 'An optional notice to display for this payment method (e.g., verification requirements).', 'poocommerce' ),
										'context'     => array( 'view', 'edit' ),
										'readonly'    => true,
										'properties'  => array(
											'badge'     => array(
												'type'     => 'string',
												'description' => esc_html__( 'Short text for a badge/chip displayed next to the payment method title.', 'poocommerce' ),
												'context'  => array( 'view', 'edit' ),
												'readonly' => true,
											),
											'message'   => array(
												'type'     => 'string',
												'description' => esc_html__( 'Warning message displayed when the payment method is enabled. Plain text only.', 'poocommerce' ),
												'context'  => array( 'view', 'edit' ),
												'readonly' => true,
											),
											'link_text' => array(
												'type'     => 'string',
												'description' => esc_html__( 'Text for the call-to-action link in the notice.', 'poocommerce' ),
												'context'  => array( 'view', 'edit' ),
												'readonly' => true,
											),
											'link_url'  => array(
												'type'     => 'string',
												'description' => esc_html__( 'URL for the call-to-action link in the notice.', 'poocommerce' ),
												'context'  => array( 'view', 'edit' ),
												'readonly' => true,
											),
										),
