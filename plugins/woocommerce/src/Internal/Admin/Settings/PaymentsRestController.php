		...
		return array(
			...
			'properties'  => array(
				...
				'short_description' => array(
					'type'        => 'string',
					'description' => esc_html__( 'The short description of the provider.', 'poocommerce' ),
					'readonly'    => true,
				),
				'supports'          => array(
				...
				'state'             => array(
					'type'        => 'object',
					'description' => esc_html__( 'The state of the provider.', 'poocommerce' ),
					'properties'  => array(
						'enabled'     => array(
							'type'        => 'boolean',
							'description' => esc_html__( 'Whether the provider is enabled for use.', 'poocommerce' ),
							'context'     => array( 'view', 'edit' ),
							'readonly'    => true,
						),
						'needs_setup' => array(
						...
						'test_mode'   => array(
							'type'        => 'boolean',
							'description' => esc_html__( 'Whether the provider is in test mode.', 'poocommerce' ),
							'context'     => array( 'view', 'edit' ),
							'readonly'    => true,
						),
						'dev_mode'    => array(
							'type'        => 'boolean',
							'description' => esc_html__( 'Whether the provider is in dev mode.', 'poocommerce' ),
							'context'     => array( 'view', 'edit' ),
							'readonly'    => true,
						),
					),
				...
				'_incentive'        => array(
					...
					'properties'  => array(
						...
						'description'       => array(
							'type'        => 'string',
							'description' => esc_html__( 'The incentive description. It can contain basic HTML.', 'poocommerce' ),
							'context'     => array( 'view', 'edit' ),
							'readonly'    => true,
						),
						'short_description' => array(
							'type'        => 'string',
							'description' => esc_html__( 'The short description of the incentive. It can contain basic HTML.', 'poocommerce' ),
							'context'     => array( 'view', 'edit' ),
							'readonly'    => true,
						),
						'cta_label'         => array(
	...
	private function get_schema_for_suggestion(): array {
		return array(
			...
			'properties'  => array(
				...
				'short_description' => array(
					'type'        => 'string',
					'description' => esc_html__( 'The short description of the suggestion.', 'poocommerce' ),
					'readonly'    => true,
				),
				'plugin'            => array(
					'type'       => 'object',
