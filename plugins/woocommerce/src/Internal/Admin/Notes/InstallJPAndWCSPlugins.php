...
class InstallJPAndWCSPlugins {
	...
	public function install_jp_and_wcs_plugins( $note ) {
		...
		// only requires `manage_poocommerce`, which `shop_manager` satisfies. Plugin install
		...
		if ( ! current_user_can( 'install_plugins' ) ) {
			throw new NoteActionForbiddenException(
				esc_html__( 'You do not have permissions to manage plugins. Please contact your site administrator.', 'poocommerce' )
			);
		}
