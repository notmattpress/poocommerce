	...
	public function render_features() {
		...
		?>
			<tr>
				...
				<td class="help"><?php echo wc_help_tip( esc_html__( 'Which features are enabled?', 'poocommerce' ) ); ?></td>
				<td>
					<?php
			...
			<tr>
				...
				<td class="help"><?php echo wc_help_tip( esc_html__( 'Which features are disabled?', 'poocommerce' ) ); ?></td>
				<td>
					<?php
	...
	public function render_daily_cron() {
		...
		?>
			<tr>
				...
				<td class="help"><?php echo wc_help_tip( esc_html__( 'Is the daily cron job active, when does it next run?', 'poocommerce' ) ); ?></td>
				<td>
					<?php
					if ( $next_action_time ) {
	...
	public function render_options() {
		...
		?>
			<tr>
				...
				<td class="help"><?php echo wc_help_tip( esc_html__( 'Do the important options return expected values?', 'poocommerce' ) ); ?></td>
				<td>
					<?php
	...
	public function render_notes() {
		...
		?>
			<tr>
				...
				<td class="help"><?php echo wc_help_tip( esc_html__( 'How many notes in the database?', 'poocommerce' ) ); ?></td>
				<td>
					<?php
	...
	public function render_onboarding_state() {
		...
		?>
			<tr>
				...
				<td class="help"><?php echo wc_help_tip( esc_html__( 'Was onboarding completed or skipped?', 'poocommerce' ) ); ?></td>
				<td>
					<?php
