...
class PageController {
	...
	public function setup(): void {
		...
		$page_name   = ( \WC_Admin_Menus::can_view_poocommerce_menu_item() ? 'poocommerce_page_wc-orders' : 'admin_page_wc-orders' ) . $page_suffix;
	...
	public function register_menu(): void {
		...
		foreach ( $order_types as $order_type ) {
			...
			add_submenu_page(
				\WC_Admin_Menus::can_view_poocommerce_menu_item() ? 'poocommerce' : 'admin.php',
