...
class ListTable extends WP_List_Table {
	...
	public function setup( $args = array() ): void {
		...
		add_action( 'poocommerce_order_list_table_restrict_manage_orders', array( $this, 'created_via_filter' ) );
	...
	public function render_blank_state(): void {
		?>
			<div class="poocommerce-BlankState poocommerce-BlankState--orders">
				...
				<div class="poocommerce-BlankState-buttons">
					<a class="poocommerce-BlankState-cta button button-secondary" target="_blank" rel="noopener noreferrer" href="https://poocommerce.com/document/managing-orders/?utm_source=blankslate&utm_medium=product&utm_content=ordersdoc&utm_campaign=poocommerceplugin"><?php esc_html_e( 'Learn more about orders', 'poocommerce' ); ?></a>
				</div>
	...
	public function created_via_filter() {
		...
		$created_via_options = array(
			''                   => __( 'All sales channels', 'poocommerce' ),
			'admin'              => __( 'Admin', 'poocommerce' ),
			'checkout,store-api' => __( 'Checkout', 'poocommerce' ),
			'pos-rest-api'       => __( 'Point of Sale', 'poocommerce' ),
		);
		?>
	...
	public function get_columns() {
		...
		return apply_filters(
			...
			array(
				...
				'order_status'     => esc_html_x( 'Status', 'Order status', 'poocommerce' ),
