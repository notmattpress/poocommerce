		...
		return array(
			...
			'poocommerce_approved_download_directories_sync' => array(
				...
				'good'  => array(
					...
					'description' => __( 'There is no completed approved download directory synchronization waiting for review.', 'poocommerce' ),
				),
				'fail'  => array(
					'label'       => __( 'PooCommerce approved download directories need review', 'poocommerce' ),
					'description' => __( 'Approved product download directory synchronization has completed. Review the list to confirm downloadable product files remain protected.', 'poocommerce' ),
					'actions'     => array(
						array(
			...
			'poocommerce_approved_download_directories_enforcement' => array(
				'label' => __( 'PooCommerce approved download directories', 'poocommerce' ),
				'badge' => 'security',
				'check' => fn() => Download_Directories::MODE_ENABLED === wc_get_container()->get( Download_Directories::class )->get_mode(),
				'good'  => array(
					'label'       => __( 'PooCommerce approved download directory rules are enforced', 'poocommerce' ),
					'description' => __( 'Downloadable product files are restricted to approved directories.', 'poocommerce' ),
				),
				'fail'  => array(
					'label'       => __( 'PooCommerce approved download directory rules are not enforced', 'poocommerce' ),
					'description' => __( 'Enable approved download directory rules to control which local and remote locations can be used for downloadable product files. This reduces the risk of exposing unintended files or connecting to unapproved remote locations.', 'poocommerce' ),
					'actions'     => array(
						array(
							'url'   => admin_url( 'admin.php?page=wc-settings&tab=products&section=download_urls' ),
							'label' => __( 'Review approved directory rules', 'poocommerce' ),
						),
						array(
							'url'     => 'https://poocommerce.com/document/approved-download-directories',
							'label'   => __( 'Learn more about approved directories', 'poocommerce' ),
