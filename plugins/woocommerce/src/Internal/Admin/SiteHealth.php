	...
	protected function get_poocommerce_site_health_tests(): array {
		return array(
			...
			'poocommerce_uploads_directory_protection' => array(
				...
				'fail'  => array(
					'status'      => 'critical',
					'label'       => __( 'PooCommerce uploads directory is browsable from the web', 'poocommerce' ),
					'description' => __( 'Directory browsing can expose downloadable product files. Configure your web server to prevent directory indexing for the PooCommerce uploads directory.', 'poocommerce' ),
					'actions'     => array(
						array(
