	...
	private function get_all_extensions_base_details(): array {
		...
		$this->extensions_base_details_memo = array(
			...
			self::KUSTOM_CHECKOUT   => array(
				'_type'       => self::TYPE_PSP,
				'title'       => esc_html__( 'Kustom Checkout', 'poocommerce' ),
				...
				'links'       => array(
					array(
						'_type' => PaymentsProviders::LINK_TYPE_ABOUT,
						'url'   => 'https://poocommerce.com/products/kustom-checkout/',
					),
					array(
						'_type' => PaymentsProviders::LINK_TYPE_TERMS,
					...
					array(
						'_type' => PaymentsProviders::LINK_TYPE_DOCS,
						'url'   => 'https://poocommerce.com/document/kustom-checkout/',
					),
					array(
						'_type' => PaymentsProviders::LINK_TYPE_SUPPORT,
						'url'   => 'https://poocommerce.com/my-account/contact-support/?select=kustom-checkout',
					),
				),
			),
			self::HELCIM            => array(
