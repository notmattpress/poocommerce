	...
	public static function get_plugin( $slug ) {
		$plugins = array(
			...
			'multichannel-by-cedcommerce'   => array(
				'name'             => __( 'Multichannel for PooCommerce', 'poocommerce' ),
				'description'      => __( 'Sync your sales data across platforms and manage everything from a unified dashboard.', 'poocommerce' ),
				...
				'learn_more_link'  => 'https://poocommerce.com/products/multichannel-by-cedcommerce-ebay-amazon-walmart-etsy-integration/?utm_source=marketing_task&utm_medium=product',
				'tags'             => array(
					'marketplace',
				),
			),
