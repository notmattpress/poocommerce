...
class Settings {
	...
	public function add_settings( $settings ) {
		...
		if ( Features::is_enabled( 'analytics-scheduled-import' ) ) {
			$settings[] = array(
				'id'          => 'poocommerce_analytics_immediate_import',
				'option_key'  => 'poocommerce_analytics_immediate_import',
				...
				'options'     => array(
					'no'  => __( 'Scheduled (recommended)', 'poocommerce' ),
					'yes' => __( 'Immediately', 'poocommerce' ),
				),
			);
