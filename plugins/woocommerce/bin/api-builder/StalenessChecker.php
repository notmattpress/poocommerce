...
class StalenessChecker {
	 ...
	 *
	 * @param string|null $api_dir           Absolute path to the code-API sources. Defaults to PooCommerce core's `src/Api`.
	 * @param string|null $autogenerated_dir Absolute path to the autogenerated output directory. Defaults to PooCommerce core's `src/Internal/Api/Autogenerated`.
	 */
