...
<div class="wp-block-group alignwide poocommerce-coming-soon-header has-background" style="padding-top:26px;padding-bottom:14px"><!-- wp:group {"align":"wide","layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"}} -->
...
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":1,"align":"wide","className":"poocommerce-coming-soon-banner","style":{"typography":{"fontSize":"48px","fontStyle":"normal","fontWeight":"400","lineHeight":"1.2"}},"fontFamily":"<?php echo esc_html( $heading_font_family ); ?>"} -->
<h1 class="wp-block-heading alignwide has-text-align-center poocommerce-coming-soon-banner has-<?php echo esc_html( $heading_font_family ); ?>-font-family" style="font-size:48px;font-style:normal;font-weight:400;line-height:1.2"><?php echo esc_html__( "Pardon our dust! We're working on something amazing — check back soon!", 'poocommerce' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
