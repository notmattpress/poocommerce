...
?>
<!-- wp:poocommerce/coming-soon {"comingSoonPatternId":"page-coming-soon-minimal-left-image","className":"poocommerce-coming-soon-entire-site poocommerce-coming-soon-minimal-left-image","style":{"color":{"background":"#f9f9f9","text":"#000000"},"elements":{"link":{"color":{"text":"#000000"}}}}} -->
<div class="wp-block-poocommerce-coming-soon poocommerce-coming-soon-entire-site poocommerce-coming-soon-minimal-left-image has-text-color has-background has-link-color" style="color:#000000;background-color:#f9f9f9"><!-- wp:cover {"customOverlayColor":"transparent","isUserOverlayColor":true,"minHeight":100,"minHeightUnit":"vh","className":"coming-soon-is-vertically-aligned-center coming-soon-cover","style":{"spacing":{"padding":{"top":"0px","bottom":"0px","left":"24px","right":"24px"}},"color":{"text":"inherit"},"elements":{"link":{"color":{"text":"inherit"}}}},"layout":{"type":"default"}} -->
...
<div class="wp-block-group alignfull" style="min-height:100vh"><!-- wp:group {"align":"wide","className":"poocommerce-coming-soon-header has-background","style":{"spacing":{"padding":{"top":"26px","bottom":"14px"}}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-column is-vertically-aligned-bottom poocommerce-coming-soon-minimal-left-image__content-image" style="flex-basis:481px"><!-- wp:image {"aspectRatio":"481/576","scale":"cover","style":{"border":{"radius":"16px"}}} -->
...
<h1 class="wp-block-heading is-style-default has-<?php echo esc_html( $heading_font_family ); ?>-font-family" style="margin-bottom:var(--wp--preset--spacing--30);font-size:38px;line-height:1.19"><?php echo esc_html__( 'Something big is brewing! Our store is in the works – Launching shortly!', 'poocommerce' ); ?></h1>
<!-- /wp:heading -->
