...
class WC_Post_Types {
	...
	public static function register_taxonomies() {
		...
		register_taxonomy(
			 ...
			 */
			apply_filters( 'poocommerce_taxonomy_objects_pos_product_visibility', array( 'product', 'product_variation' ) ),
			/**
			 ...
			 */
			apply_filters(
				'poocommerce_taxonomy_args_pos_product_visibility',
				array(
					'hierarchical'      => false,
					'show_ui'           => false,
					'show_in_nav_menus' => false,
					...
					'rewrite'           => false,
					'public'            => false,
					'label'             => _x( 'POS Product visibility', 'Taxonomy name', 'poocommerce' ),
				)
			)
		);
	...
	public static function register_post_types() {
		...
		$theme_support     = wc_current_theme_supports_poocommerce_or_fse();
	...
	private static function should_register_product_archive( bool $theme_support, bool $theme_unavailable ): bool {
		...
		return 'yes' === get_option( 'current_theme_supports_poocommerce' );
	}
	...
	public static function flush_rewrite_rules() {
		if ( wp_installing() ) {
			 ...
			 */
			wp_cache_delete( 'poocommerce_queue_flush_rewrite_rules', 'options' );
