...
class WC_Tax {
	...
	public static function calc_shipping_tax( $price, $rates ) {
		 ...
		 */
		$shipping_prices_include_tax = wc_string_to_bool( apply_filters( 'poocommerce_shipping_prices_include_tax', false ) );
	...
	public static function get_tax_location( $tax_class = '', $customer = null ) {
		...
		} elseif ( wc_prices_include_tax() || DefaultCustomerAddress::BASE === get_option( 'poocommerce_default_customer_address' ) || TaxBasedOn::BASE === get_option( 'poocommerce_tax_based_on' ) ) {
			$location = array(
	 ...
	 * 1. Uses the explicitly configured shipping tax class from PooCommerce settings if not set to 'inherit'
	...
	public static function get_shipping_tax_rates( $tax_class = null, $customer = null ) {
		 ...
		 */
		$tax_class = apply_filters( 'poocommerce_shipping_tax_class', $tax_class, $cart, $customer, $location );
