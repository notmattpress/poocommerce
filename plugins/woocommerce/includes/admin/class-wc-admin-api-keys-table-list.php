...
class WC_Admin_API_Keys_Table_List extends WP_List_Table {
	...
	public function prepare_items() {
		...
		$count = $wpdb->get_var( "SELECT COUNT(key_id) FROM {$wpdb->prefix}poocommerce_api_keys WHERE 1 = 1 {$search};" ); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- The search fragment is escaped and the table name is trusted.
