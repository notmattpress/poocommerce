...
class WC_Admin_List_Table_Coupons extends WC_Admin_List_Table {
	...
	protected function render_blank_state() {
		echo '<div class="poocommerce-BlankState poocommerce-BlankState--coupons">';
		...
		echo '<a class="poocommerce-BlankState-cta button button-secondary" href="' . esc_url( admin_url( 'post-new.php?post_type=shop_coupon' ) ) . '">' . esc_html__( 'Create your first coupon', 'poocommerce' ) . '</a>';
		echo '<a class="poocommerce-BlankState-cta button button-secondary" target="_blank" rel="noopener noreferrer" href="https://poocommerce.com/document/coupon-management/?utm_source=blankslate&utm_medium=product&utm_content=couponsdoc&utm_campaign=poocommerceplugin">' . esc_html__( 'Learn more about coupons', 'poocommerce' ) . '</a>';
		echo '</div>';
	}
