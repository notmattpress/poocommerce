...
class WC_Brands_Admin {
	...
	public function __construct() {
		...
		// https://poocommerce.com/document/product-csv-importer-exporter/
		// Import.
		...
		add_filter( 'poocommerce_product_importer_formatting_callbacks', array( $this, 'add_formatting_callback' ), 10, 2 );
	...
	public function taxonomy_description() {
		echo wp_kses_post( wpautop( __( 'Brands can be added and managed from this screen. You can optionally upload a brand image to display in brand widgets and on brand archives', 'poocommerce' ) ) );
	}
