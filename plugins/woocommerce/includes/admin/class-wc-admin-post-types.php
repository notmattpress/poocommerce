...
class WC_Admin_Post_Types {
	...
	public function bulk_and_quick_edit_save_post( $post_id, $post ) {
		...
		if ( ! empty( $request_data['poocommerce_quick_edit'] ) ) {
	...
	public function hidden_meta_boxes( $hidden, $screen ) {
		...
		if ( wc_get_page_screen_id( 'shop-order' ) === $screen->id ) {
			$hidden = array_merge( $hidden, array( 'poocommerce-order-downloads' ) );
		}
	...
	public function product_data_visibility() {
		...
		<div class="misc-pub-section misc-pub-catalog-visibility" id="catalog-visibility">
			...
			<div id="catalog-visibility-select" class="hide-if-js">
				...
				echo '<input type="checkbox" name="_featured" id="_featured" ' . checked( $current_featured, 'yes', false ) . ' /> <label for="_featured">' . esc_html__( 'This is a featured product', 'poocommerce' ) . '</label><br />';
				?>
				<p>
