...
class WC_Admin {
	...
	public function admin_redirects() {
		...
		if ( ! empty( $_GET['wc-install-plugin-redirect'] ) ) {
			...
			if ( wp_verify_nonce( $redirect_nonce, 'wc-install-plugin-redirect_' . $plugin_slug ) && current_user_can( 'install_plugins' ) && in_array( $plugin_slug, array( 'poocommerce-gateway-stripe' ), true ) ) {
