...
<div id="key-fields" class="settings-panel">
	...
	if ( 0 === intval( $key_id ) ) {
		...
		<p class="submit">
			...
			<a style="color: var(--wc-destructive, #cc1818); text-decoration: none; margin-left: 10px;" href="<?php echo esc_url( wp_nonce_url( add_query_arg( array( 'revoke-key' => $key_id ), admin_url( 'admin.php?page=wc-settings&tab=advanced&section=keys' ) ), 'revoke' ) ); ?>"><?php esc_html_e( 'Revoke key', 'poocommerce' ); ?></a>
		</p>
		<?php
	}
	?>
