...
if ( ! class_exists( 'WC_Settings_Page', false ) ) :
	...
	abstract class WC_Settings_Page {
		...
		public function add_settings_page_data( $pages ) {
			...
			$pages[ $this->id ]['start'] = $this->get_custom_view( 'poocommerce_before_settings_' . $this->id );
			$pages[ $this->id ]['end']   = $this->get_custom_view( 'poocommerce_after_settings_' . $this->id );
		...
		protected function get_section_settings_data( $section_id, $sections ) {
			...
			$custom_view = $this->get_custom_view( 'poocommerce_settings_' . $this->id, $section_id );
			...
			if ( $this->output_called ) {
				...
				foreach ( $section_settings as $section_setting ) {
					...
					if ( 'sectionend' === $section_setting['type'] && ! empty( $section_setting['id'] ) ) {
						$section_settings_data[] = $this->get_custom_view( 'poocommerce_settings_' . $section_setting['id'] . '_end' );
						$section_settings_data[] = $this->get_custom_view( 'poocommerce_settings_' . $section_setting['id'] . '_after' );
					}
					...
					if ( 'title' === $section_setting['type'] && ! empty( $section_setting['id'] ) ) {
						$section_settings_data[] = $this->get_custom_view( 'poocommerce_settings_' . $section_setting['id'] );
					}
				}
			}
