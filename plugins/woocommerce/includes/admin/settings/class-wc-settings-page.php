...
if ( ! class_exists( 'WC_Settings_Page', false ) ) :
	...
	abstract class WC_Settings_Page {
		...
		public function add_settings_ui_body_class( $classes ) {
			...
			if ( ! in_array( 'poocommerce-settings-ui-page', $body_classes, true ) ) {
				$classes       .= ' poocommerce-settings-ui-page';
				$body_classes[] = 'poocommerce-settings-ui-page';
			}

			if (
				$is_rendering_drill_down
				&& ! in_array( 'poocommerce-settings-ui-drill-down', $body_classes, true )
			) {
				$classes .= ' poocommerce-settings-ui-drill-down';
			}
