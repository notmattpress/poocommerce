...
class WC_Settings_Emails extends WC_Settings_Page {
	...
	protected function get_settings_for_default_section() {
		...
		if ( FeaturesUtil::feature_is_enabled( 'block_email_editor' ) ) {
			...
			$email_notifications_desc  = __( 'Manage email notifications sent from PooCommerce below or click on \'Edit template\' to customize your email template design.', 'poocommerce' );
		} else {
