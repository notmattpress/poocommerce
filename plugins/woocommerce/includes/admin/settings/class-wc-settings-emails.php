			...
			$settings = array_merge(
				...
				array(
					...
					array(
						...
						'desc'     => sprintf( __( 'Customize the color of your buttons and links. Default %s.', 'poocommerce' ), '<code>' . $base_color_default . '</code>' ),
					...
					array(
						...
						/* translators: %s: default color */
						'desc'     => sprintf( __( 'Select a color for the background of your emails. Default %s.', 'poocommerce' ), '<code>' . $bg_color_default . '</code>' ),
					...
					array(
						...
						/* translators: %s: default color */
						'desc'     => sprintf( __( 'Choose a background color for the content area of your emails. Default %s.', 'poocommerce' ), '<code>' . $body_bg_color_default . '</code>' ),
					...
					array(
						...
						/* translators: %s: default color */
						'desc'     => sprintf( __( 'Set the color of your headings and text. Default %s.', 'poocommerce' ), '<code>' . $body_text_color_default . '</code>' ),
					...
					array(
						...
						'desc'     => sprintf( __( 'Choose a color for your secondary text, such as your footer content. Default %s.', 'poocommerce' ), '<code>' . $footer_text_color_default . '</code>' ),
