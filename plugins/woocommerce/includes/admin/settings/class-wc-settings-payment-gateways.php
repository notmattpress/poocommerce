					...
					<tbody>
						...
						if ( PooCommercePayments::is_supported() ) {
							...
							$marketplace_cta = sprintf(
								wp_kses(
									/* translators: %s: URL to PooCommerce marketplace */
									__( 'Visit the <a href="%s" id="settings-other-payment-methods" style="text-decoration: underline;">Official PooCommerce Marketplace</a> to find additional payment providers.', 'poocommerce' ),
