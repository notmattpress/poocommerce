...
class WC_Settings_Shipping extends WC_Settings_Page {
	...
	protected function get_own_sections() {
		...
		if ( FeaturesUtil::feature_is_enabled( 'fulfillments' ) ) {
			$sections['fulfillment-providers'] = __( 'Shipping providers', 'poocommerce' );
		}
	...
	protected function get_settings_for_options_section() {
		$settings =
			array(
				...
				array(
					'desc'          => __( 'Hide shipping rates when free shipping is available', 'poocommerce' ),
					'id'            => 'poocommerce_shipping_hide_rates_when_free',
					'default'       => 'no',
					'type'          => 'checkbox',
					'autoload'      => false,
					'checkboxgroup' => 'end',
	...
	protected function zone_methods_screen( $zone_id ) {
		...
		$localized_object = array(
			...
			'strings'                 => array(
				...
				'invalid_number_format'               => __( 'Please enter a valid number.', 'poocommerce' ),
			),
		);
	...
	protected function output_shipping_providers_screen(): void {
		...
		wp_localize_script(
			...
			array(
				...
				'strings'                     => array(
					'unload_confirmation_msg' => __( 'Your changed data will be lost if you leave this page without saving.', 'poocommerce' ),
					'save_failed'             => __( 'Your changes were not saved. Please retry.', 'poocommerce' ),
					'delete_confirmation'     => __( 'Are you sure you want to delete this shipping provider?', 'poocommerce' ),
				),
			)
		);
		...
		$shipping_provider_columns = array(
			'wc-shipping-provider-name'                  => __( 'Name', 'poocommerce' ),
			'wc-shipping-provider-slug'                  => __( 'Slug', 'poocommerce' ),
			'wc-shipping-provider-tracking-url-template' => __( 'Tracking URL template', 'poocommerce' ),
			'wc-shipping-provider-icon'                  => __( 'Icon URL', 'poocommerce' ),
		);
