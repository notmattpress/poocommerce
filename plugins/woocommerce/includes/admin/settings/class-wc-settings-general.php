...
class WC_Settings_General extends WC_Settings_Page {
	...
	protected function get_settings_for_default_section() {
		...
		$address_autocomplete_setting_desc_tip           = __( 'Suggest full addresses for customer as they type.', 'poocommerce' );
		...
		try {
			...
			if ( ! $address_autocomplete_available ) {
				...
				$address_autocomplete_setting_desc_tip .= ' ' . sprintf( __( 'To use this feature, you need to install an address provider such as <a href="%s">WooPayments</a>.', 'poocommerce' ), 'https://poocommerce.com/products/poocommerce-payments/' );
			}
	...
	public function output() {
		...
		wc_enqueue_js(
			"
			var preferredProviderInput = document.querySelector( '#poocommerce_address_autocomplete_provider' );
			var autocompleteEnabledInput = document.querySelector( '#poocommerce_address_autocomplete_enabled' );
