 ...
 *
 * The architectural fix lives in https://github.com/poocommerce/poocommerce/issues/54657.
 */
if ( ! class_exists( '\Automattic\PooCommerce\Enums\DefaultCustomerAddress', false ) ) {
		...
		$settings =
			array(
				...
				array(
					...
					'class'    => 'wc-enhanced-select',
					'options'  => array(
						DefaultCustomerAddress::NO_DEFAULT => __( 'No location by default', 'poocommerce' ),
						DefaultCustomerAddress::BASE => __( 'Shop country/region', 'poocommerce' ),
						DefaultCustomerAddress::GEOLOCATION => __( 'Geolocate', 'poocommerce' ),
						DefaultCustomerAddress::GEOLOCATION_AJAX => __( 'Geolocate (with page caching support)', 'poocommerce' ),
					),
				),
