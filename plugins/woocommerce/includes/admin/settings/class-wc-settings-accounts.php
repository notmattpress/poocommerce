...
class WC_Settings_Accounts extends WC_Settings_Page {
	...
	protected function get_settings_for_default_section() {
		...
		$account_settings = array(
			...
			array(
				'title'             => __( 'Account creation options', 'poocommerce' ),
				'desc'              => __( 'Generate account login (recommended)', 'poocommerce' ),
				'desc_tip'          => __( 'Generate a login for the account using first and/or last name. If neither is usable (e.g. invalid or missing) the email address will be used. If this option is unchecked, customers will need to set a username during account creation', 'poocommerce' ),
