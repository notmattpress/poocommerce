...
class WC_Admin_API_Keys {
	...
	private static function table_list_output() {
		...
		if ( absint( $count ) && $count > 0 ) {
			...
			<a class="poocommerce-BlankState-cta button button-secondary" href="<?php echo esc_url( admin_url( 'admin.php?page=wc-settings&tab=advanced&section=keys&create-key=1' ) ); ?>"><?php esc_html_e( 'Create an API key', 'poocommerce' ); ?></a>
