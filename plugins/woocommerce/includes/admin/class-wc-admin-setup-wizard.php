...
class WC_Admin_Setup_Wizard {
				...
				<ul class="wc-wizard-services shipping">
					<li class="wc-wizard-service-item">
						<div class="wc-wizard-service-name">
							<p><?php esc_html_e( 'Shipping Zone', 'poocommerce' ); ?></p>
						</div>
						<div class="wc-wizard-service-description">
							<p><?php esc_html_e( 'Shipping Method', 'poocommerce' ); ?></p>
						</div>
					</li>
					<li class="wc-wizard-service-item">
						<div class="wc-wizard-service-name">
					...
					<li class="wc-wizard-service-item">
						<div class="wc-wizard-service-name">
							<p><?php esc_html_e( 'Locations not covered by your other zones', 'poocommerce' ); ?></p>
						</div>
						<div class="wc-wizard-service-description">
	...
	protected function get_wizard_available_in_cart_payment_gateways() {
		...
		$kustom_checkout_description = '<p>' . sprintf(
			/* translators: %s: URL */
			__( 'Full checkout experience with pay now, pay later and slice it. No credit card numbers, no passwords, no worries. <a href="%s" target="_blank">Learn more about Kustom</a>.', 'poocommerce' ),
			'https://poocommerce.com/products/kustom-checkout/'
		) . '</p>';
		...
		return array(
			...
			'klarna_checkout'     => array(
				'name'        => __( 'Kustom Checkout for PooCommerce', 'poocommerce' ),
