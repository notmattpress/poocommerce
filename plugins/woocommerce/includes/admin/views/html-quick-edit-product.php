...
<fieldset class="inline-edit-col-left">
	<div id="poocommerce-fields" class="inline-edit-col">
		...
		<div class="price_fields">
			...
			?>
			<label>
				<span class="title"><?php esc_html_e( 'Sale start', 'poocommerce' ); ?></span>
				<span class="input-text-wrap">
					<input type="text" name="_sale_price_dates_from" class="text sale_price_dates_from" placeholder="<?php echo esc_attr_x( 'From&hellip;', 'placeholder', 'poocommerce' ); ?> YYYY-MM-DD" value="" maxlength="10" pattern="<?php echo esc_attr( $date_input_html_pattern ); ?>">
				</span>
			</label>
			<br class="clear" />
			<label>
				<span class="title"><?php esc_html_e( 'Sale end', 'poocommerce' ); ?></span>
				<span class="input-text-wrap">
					<input type="text" name="_sale_price_dates_to" class="text sale_price_dates_to" placeholder="<?php echo esc_attr_x( 'To&hellip;', 'placeholder', 'poocommerce' ); ?> YYYY-MM-DD" value="" maxlength="10" pattern="<?php echo esc_attr( $date_input_html_pattern ); ?>">
				</span>
			</label>
			<br class="clear" />
		</div>
		...
		<?php if ( wc_get_container()->get( CostOfGoodsSoldController::class )->feature_is_enabled() ) : ?>
			<div class="cost_fields">
				<label>
					<span class="title"><?php esc_html_e( 'Cost', 'poocommerce' ); ?></span>
					<span class="input-text-wrap">
						<input type="text" name="_cogs_value" class="text wc_input_price cogs_value" placeholder="<?php esc_attr_e( 'Cost value', 'poocommerce' ); ?>" value="">
					</span>
				</label>
				<br class="clear" />
			</div>
				...
				<span class="input-text-wrap">
					<select class="visibility" name="_visibility">
						...
						$options = apply_filters(
							...
							array(
								CatalogVisibility::VISIBLE => __( 'Catalog &amp; search', 'poocommerce' ),
								CatalogVisibility::CATALOG => __( 'Catalog', 'poocommerce' ),
								CatalogVisibility::SEARCH  => __( 'Search', 'poocommerce' ),
