...
<table class="wc_status_table widefat" cellspacing="0" id="status">
	...
	<tbody>
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The root URL of your site.', 'poocommerce' ) ); ?></td>
			<td><?php echo esc_html( $environment['site_url'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Site address (URL)"><?php esc_html_e( 'Site address (URL)', 'poocommerce' ); ?>:</td>
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The homepage URL of your site.', 'poocommerce' ) ); ?></td>
			<td><?php echo esc_html( $environment['home_url'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="WC Version"><?php esc_html_e( 'PooCommerce version', 'poocommerce' ); ?>:</td>
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The version of PooCommerce installed on your site.', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Several PooCommerce extensions can write logs which makes debugging problems easier. The directory must be writable for this to happen.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The version of WordPress installed on your site.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Whether or not you have WordPress Multisite enabled.', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The maximum amount of memory (RAM) that your site can use at one time.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Displays whether or not WordPress is in Debug Mode.', 'poocommerce' ) ); ?></td>
			<td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Displays whether or not WP Cron Jobs are enabled.', 'poocommerce' ) ); ?></td>
			<td>
		...
		<tr>
			<td data-export-label="WP Environment Type"><?php esc_html_e( 'Environment type', 'poocommerce' ); ?>:</td>
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The current environment type set for this site.', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The current language used by WordPress. Default = English', 'poocommerce' ) ); ?></td>
...
<table class="wc_status_table widefat" cellspacing="0">
	...
	<tbody>
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Information about the web server that is currently hosting your site.', 'poocommerce' ) ); ?></td>
			<td><?php echo esc_html( $environment['server_info'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Server Architecture"><?php esc_html_e( 'Server architecture', 'poocommerce' ); ?>:</td>
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Information about the operating system your server is running.', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The version of PHP installed on your hosting server.', 'poocommerce' ) ); ?></td>
			<td>
		...
		<?php if ( function_exists( 'ini_get' ) ) : ?>
			<tr>
				...
				<td class="help"><?php echo wc_help_tip( esc_html__( 'The largest filesize that can be contained in one post.', 'poocommerce' ) ); ?></td>
				<td><?php echo esc_html( size_format( $environment['php_post_max_size'] ) ); ?></td>
			</tr>
			<tr>
				<td data-export-label="PHP Time Limit"><?php esc_html_e( 'PHP time limit', 'poocommerce' ); ?>:</td>
				<td class="help"><?php echo wc_help_tip( esc_html__( 'The amount of time (in seconds) that your site will spend on a single operation before timing out (to avoid server lockups)', 'poocommerce' ) ); ?></td>
				<td><?php echo esc_html( $environment['php_max_execution_time'] ); ?></td>
			</tr>
			<tr>
				<td data-export-label="PHP Max Input Vars"><?php esc_html_e( 'PHP max input vars', 'poocommerce' ); ?>:</td>
				<td class="help"><?php echo wc_help_tip( esc_html__( 'The maximum number of variables your server can use for a single function to avoid overloads.', 'poocommerce' ) ); ?></td>
		...
		if ( $environment['mysql_version'] ) :
			...
			<tr>
				...
				<td class="help"><?php echo wc_help_tip( esc_html__( 'The version of MySQL installed on your hosting server.', 'poocommerce' ) ); ?></td>
				<td>
					<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The largest filesize that can be uploaded to your WordPress installation.', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The default timezone for your server.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Payment gateways can use cURL to communicate with remote servers to authorize payments, other plugins may also use it when communicating with remote services.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Some webservices like shipping use SOAP to get information from remote servers, for example, live shipping quotes from FedEx require SOAP to be installed.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'HTML/Multipart emails use DOMDocument to generate inline CSS in templates.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'GZip (gzopen) is used to open the GEOIP database from MaxMind.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Multibyte String (mbstring) is used to convert character encoding, like for emails or converting characters to lowercase.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'PayPal uses this method of communicating when sending back transaction information.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'PooCommerce plugins may use this method of communication when checking for plugin updates.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
...
<table id="status-database" class="wc_status_table widefat" cellspacing="0">
	...
	<tbody>
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The database version for PooCommerce. This should be the same as your PooCommerce version.', 'poocommerce' ) ); ?></td>
...
<table class="wc_status_table widefat" cellspacing="0">
	...
	<tbody>
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Is the connection to your store secure?', 'poocommerce' ) ); ?></td>
			<td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Error messages can contain sensitive information about your store environment. These should be hidden from untrusted visitors.', 'poocommerce' ) ); ?></td>
			<td>
...
<table class="wc_status_table widefat" cellspacing="0">
	...
	<tbody>
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Does your site force a SSL Certificate for transactions?', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'What currency prices are listed at in the catalog and which currency gateways will take payments in.', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The position of the currency symbol.', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The thousand separator of displayed prices.', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The decimal separator of displayed prices.', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The number of decimal points shown in displayed prices.', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'A list of taxonomy terms that can be used in regard to order/product statuses.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
				$display_terms = array();
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'A list of taxonomy terms used for product visibility.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
				$display_terms = array();
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Is your site connected to PooCommerce.com?', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Is your site enforcing the use of Approved Product Download Directories?', 'poocommerce' ) ); ?></td>
		...
		foreach ( $wp_pages as $_page ) {
			...
			if ( ! $_page['page_set'] ) {
				...
				if ( ! $_page['shortcode_present'] && ! $_page['block_present'] ) {
					...
					echo '<mark class="error"><span class="dashicons dashicons-warning"></span> ' . ( $_page['block_required'] ? sprintf( esc_html__( 'Page does not contain the %1$s shortcode or the %2$s block.', 'poocommerce' ), esc_html( $_page['shortcode'] ), esc_html( $_page['block'] ) ) : sprintf( esc_html__( 'Page does not contain the %s shortcode.', 'poocommerce' ), esc_html( $_page['shortcode'] ) ) ) . '</mark>';
					$found_error = true;
				}
				...
				if ( $_page['shortcode_present'] && $_page['block_present'] ) {
					/* Translators: %1$s: shortcode text, %2$s: block slug. */
					echo '<mark class="error"><span class="dashicons dashicons-warning"></span> ' . sprintf( esc_html__( 'Page contains both the %1$s shortcode and the %2$s block.', 'poocommerce' ), esc_html( $_page['shortcode'] ), esc_html( $_page['block'] ) ) . '</mark>';
					$found_error = true;
				}
			}
...
<table class="wc_status_table widefat" cellspacing="0">
	...
	<tbody>
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The name of the current active theme.', 'poocommerce' ) ); ?></td>
			<td><?php echo esc_html( $theme['name'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Version"><?php esc_html_e( 'Version', 'poocommerce' ); ?>:</td>
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The installed version of the current active theme.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The theme developers URL.', 'poocommerce' ) ); ?></td>
			<td><?php echo esc_html( $theme['author_url'] ); ?></td>
		</tr>
		<tr>
			<td data-export-label="Child Theme"><?php esc_html_e( 'Child theme', 'poocommerce' ); ?>:</td>
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Displays whether or not the current theme is a child theme.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<?php if ( $theme['is_child_theme'] ) : ?>
			<tr>
				...
				<td class="help"><?php echo wc_help_tip( esc_html__( 'The name of the parent theme.', 'poocommerce' ) ); ?></td>
				<td><?php echo esc_html( $theme['parent_name'] ); ?></td>
			</tr>
			<tr>
				<td data-export-label="Parent Theme Version"><?php esc_html_e( 'Parent theme version', 'poocommerce' ); ?>:</td>
				<td class="help"><?php echo wc_help_tip( esc_html__( 'The installed version of the parent theme.', 'poocommerce' ) ); ?></td>
				<td>
					<?php
			...
			<tr>
				...
				<td class="help"><?php echo wc_help_tip( esc_html__( 'The parent theme developers URL.', 'poocommerce' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Displays whether the current active theme is a block theme or a classic theme.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'Displays whether or not the current active theme declares PooCommerce support.', 'poocommerce' ) ); ?></td>
			<td>
				<?php
...
<table class="wc_status_table widefat" id="status-table-templates" cellspacing="0">
		...
		<?php if ( ! empty( $theme['overrides'] ) ) : ?>
			...
			<tr>
				<td data-export-label="Override">
					<?php if ( 0 === $i ) : ?>
						<?php esc_html_e( 'Overrides', 'poocommerce' ); ?>:
					<?php endif; ?>
				</td>
				<td class="help">&nbsp;</td>
				<?php
				...
				if ( $override['core_version'] && '' === $override['version'] ) {
					...
					printf(
						...
						esc_html__( 'Version header is missing. The core version is %s', 'poocommerce' ),
					...
					printf(
						...
						esc_html__( 'Version %1$s is out of date. The core version is %2$s', 'poocommerce' ),
	...
	<tfoot>
		<tr>
			<td><?php esc_html_e( 'Outdated templates', 'poocommerce' ); ?>:</td>
			<td class="help">&nbsp;</td>
			<td>
				<mark class="error">
