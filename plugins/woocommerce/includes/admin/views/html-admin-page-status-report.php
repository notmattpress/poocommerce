...
<table class="wc_status_table widefat" cellspacing="0" id="status">
	...
	<tbody>
		...
		<tr>
			...
			<td class="help"><?php echo wc_help_tip( esc_html__( 'The current environment type set for this site.', 'poocommerce' ) ); /* phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped */ ?></td>
