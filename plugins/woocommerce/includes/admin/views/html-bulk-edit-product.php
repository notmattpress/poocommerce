		...
		<?php if ( wc_get_container()->get( CostOfGoodsSoldController::class )->feature_is_enabled() ) : ?>
			<div class="inline-edit-group">
				...
				<label class="change-input">
					...
					<input type="text" name="_cogs_value" class="text cogs_value" placeholder="<?php esc_attr( printf( __( 'Enter cost value (%s)', 'poocommerce' ), get_poocommerce_currency_symbol() ) ); ?>" value="" />
