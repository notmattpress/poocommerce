...
<div id="message" class="updated poocommerce-message wc-connect">
	...
	<p>
		<?php
			...
			printf( ' ' . esc_html__( 'The database update process runs in the background and may take a little while, so please be patient. Advanced users can alternatively update via %1$sWP CLI%2$s.', 'poocommerce' ), '<a href="https://developer.poocommerce.com/docs/wc-cli/wc-cli-examples/#upgrading-the-database-using-wp-cli">', '</a>' );
		?>
	</p>
	<p class="submit">
