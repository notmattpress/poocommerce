...
class WC_Meta_Box_Product_Reviews {
	...
	public static function save( $data ) {
		...
		if ( ! isset( $_POST['poocommerce_meta_nonce'], $_POST['rating'] ) || ! wp_verify_nonce( wp_unslash( $_POST['poocommerce_meta_nonce'] ), 'poocommerce_save_data' ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- Save verifies nonce; rating is bounded and cast before storage.
			return $data;
		}
