						...
						<div class="edit_address">
							...
							if ( apply_filters( 'poocommerce_enable_order_notes_field', 'yes' === get_option( 'poocommerce_enable_order_comments', 'yes' ) ) ) :
								...
								<p class="form-field form-field-wide">
									...
									<textarea rows="1" cols="40" name="customer_note" tabindex="6" id="customer_note" placeholder="<?php esc_attr_e( 'Customer notes about the order', 'poocommerce' ); ?>"><?php echo wp_kses( $order->get_customer_note(), array( 'br' => array() ) ); ?></textarea>
								</p>
							<?php endif; ?>
						</div>
