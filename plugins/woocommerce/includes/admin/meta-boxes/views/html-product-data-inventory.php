...
<div id="inventory_product_data" class="panel poocommerce_options_panel hidden">
	<div class="options_group">
		...
		<div class="inline notice poocommerce-message show_if_variable">
			...
			<p>
				<?php esc_html_e( 'Settings below apply to all variations without manual stock management enabled. ', 'poocommerce' ); ?> <a target="_blank" href="https://poocommerce.com/document/variable-product/"><?php esc_html_e( 'Learn more', 'poocommerce' ); ?></a>
			</p>
		</div>
		<?php
		...
		if ( 'yes' === get_option( 'poocommerce_manage_stock' ) ) {
			 ...
			 */
			$default_stock_amount = apply_filters( 'poocommerce_product_stock_default_amount', 1 );
