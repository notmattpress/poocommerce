...
<div id="variable_product_options" class="panel wc-metaboxes-wrapper hidden">
	<div id="variable_product_options_inner">
		...
		<?php else : ?>
			...
			<div class="toolbar toolbar-top">
				...
				<select id="field_to_edit" class="select variation_actions hidden">
					...
					<optgroup label="<?php esc_attr_e( 'Pricing', 'poocommerce' ); ?>">
						...
						<option value="variable_sale_price_from_regular_price"><?php esc_html_e( 'Set sale prices to regular prices decreased by (fixed amount or percentage)', 'poocommerce' ); ?></option>
					...
					<?php if ( wc_get_container()->get( CostOfGoodsSoldController::class )->feature_is_enabled() ) : ?>
						<optgroup label="<?php esc_attr_e( 'Cost of goods', 'poocommerce' ); ?>">
							<option value="variable_unset_cogs_value"><?php esc_html_e( 'Remove custom costs', 'poocommerce' ); ?></option>
						</optgroup>
					<?php endif; ?>
			...
			<?php /* phpcs:disable PooCommerce.Commenting.CommentHooks.MissingHookComment */ ?>
			<div class="poocommerce_variations wc-metaboxes" data-attributes="<?php echo wc_esc_json( wp_json_encode( wc_list_pluck( $variation_attributes, 'get_data' ) ) ); ?>" data-total="<?php echo esc_attr( $variations_count ); ?>" data-total_pages="<?php echo esc_attr( $variations_total_pages ); ?>" data-page="1" data-edited="false"></div>
			<?php /* phpcs:enable */ ?>
		...
		<div class="wc-backbone-modal-content">
			<section class="wc-backbone-modal-main" role="main">
				<header class="wc-backbone-modal-header">
					<h1><?php esc_html_e( 'Set variation prices', 'poocommerce' ); ?></h1>
				...
				<footer>
					<div class="wc-backbone-modal-buttons">
						<button class="modal-close button components-button is-secondary"><?php esc_html_e( 'Cancel', 'poocommerce' ); ?></button>
