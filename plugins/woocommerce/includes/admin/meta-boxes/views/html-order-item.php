		...
		<td class="item_cost_of_goods" width="1%" data-sort-value="<?php echo esc_attr( $item->get_cogs_value() ); ?>">
			...
			>
				...
				if ( $refunded_cost ) {
					 ...
					 */
					echo '<small class="refunded">' . apply_filters( 'poocommerce_order_item_cogs_refunded_html', wc_price( $refunded_cost, $wc_price_arg ), $refunded_cost, $item, $order ) . '</small>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				}
				?>
			</div>
		</td>
