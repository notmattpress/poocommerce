		...
		if ( wc_tax_enabled() ) {
			...
			poocommerce_wp_text_input(
				array(
					...
					'label'     => __( 'Regular price', 'poocommerce' ) . ' (' . get_poocommerce_currency_symbol() . ')' . $tax_label,
					'data_type' => 'price',
				)
			);
			...
			poocommerce_wp_text_input(
				array(
					...
					'data_type'   => 'price',
					'label'       => __( 'Sale price', 'poocommerce' ) . ' (' . get_poocommerce_currency_symbol() . ')' . $tax_label,
			...
			echo '<p class="form-field sale_price_dates_fields">
					<label for="_sale_price_dates_from">' . esc_html__( 'Sale price dates', 'poocommerce' ) . '</label>' . wc_help_tip( __( 'The sale will start at 00:00:00 of "From" date and end at 23:59:59 of "To" date.', 'poocommerce' ) ) . '
					...
					<a href="#" class="description cancel_sale_schedule">' . esc_html__( 'Cancel', 'poocommerce' ) . '</a>
				</p>';
