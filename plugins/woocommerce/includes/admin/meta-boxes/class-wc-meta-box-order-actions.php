	...
	public static function save( $post_id, $post ) {
		...
		if ( ! empty( $_POST['wc_order_action'] ) ) { // @codingStandardsIgnoreLine
			...
			if ( 'send_order_details' === $action ) {
				...
				// Note the event.
				$order->add_order_note( __( 'Order details manually sent to customer.', 'poocommerce' ), false, true, array( 'note_group' => OrderNoteGroup::EMAIL_NOTIFICATION ) );
			...
			} elseif ( ! did_action( 'poocommerce_order_action_' . sanitize_title( $action ) ) ) {
