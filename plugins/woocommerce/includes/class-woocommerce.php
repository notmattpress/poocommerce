...
final class PooCommerce {
	...
	private function init_hooks() {
		...
		$container->get( Automattic\PooCommerce\Internal\FraudProtection\FraudProtectionController::class )->register();
		$container->get( Automattic\PooCommerce\Internal\FraudProtection\CartEventTracker::class )->register();
		$container->get( Automattic\PooCommerce\Internal\FraudProtection\AdminSettingsHandler::class )->register();
		$container->get( Automattic\PooCommerce\Internal\FraudProtection\PaymentMethodEventTracker::class )->register();
		$container->get( Automattic\PooCommerce\Internal\FraudProtection\CheckoutEventTracker::class )->register();
	...
	public function register_recurring_actions() {
		...
		as_schedule_recurring_action( time(), DAY_IN_SECONDS, 'wc_admin_daily_wrapper', array(), 'poocommerce', true );
