...
final class PooCommerce {
	...
	private function init_hooks() {
		...
		$container->get( Automattic\PooCommerce\Internal\StockNotifications\StockNotifications::class )->register();
		...
		$container->get( Automattic\PooCommerce\Internal\Admin\OrderTaxLookupMigrator::class )->register();
