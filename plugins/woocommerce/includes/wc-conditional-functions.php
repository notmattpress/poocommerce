...
function is_poocommerce() {
	/**
	 * Filters whether the current request is being handled by a PooCommerce template.
	 *
	 * @since 2.1.0
	 *
	 * @param bool $is_poocommerce True on the shop archive, a product taxonomy archive or a single product.
	 */
...
function wc_current_theme_supports_poocommerce_or_fse() {
	return (bool) current_theme_supports( 'poocommerce' ) || wp_is_block_theme();
}
