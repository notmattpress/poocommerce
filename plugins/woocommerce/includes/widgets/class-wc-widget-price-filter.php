...
class WC_Widget_Price_Filter extends WC_Widget {
	...
	public function __construct() {
		...
		// This can be removed in PooCommerce 10.5.0.
	...
	protected function get_filtered_price() {
		...
		return $wpdb->get_row( $sql ); // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared -- Core assembles $sql from prepared WP_Meta_Query/WP_Tax_Query clauses and esc_sql'd post types; the poocommerce_price_filter_sql filter lets extensions replace the statement.
	}
}
