...
use Automattic\PooCommerce\Internal\RestApi\Routes\V4\Orders\OrderLineMetaValidator;
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'total'                => array(
					'description' => __( 'Grand total, including tax.', 'poocommerce' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
				...
				'prices_include_tax'   => array(
					'description' => __( 'Whether prices included tax during checkout.', 'poocommerce' ),
					'type'        => 'boolean',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
				...
				'line_items'           => array(
					...
					'items'       => array(
						...
						'properties' => array(
							...
							'subtotal'         => array(
								'description' => __( 'Line subtotal, excluding tax (before discounts).', 'poocommerce' ),
								'type'        => 'string',
								'context'     => array( 'view', 'edit' ),
							),
							'subtotal_tax'     => array(
							...
							'total'            => array(
								'description' => __( 'Line total, excluding tax (after discounts).', 'poocommerce' ),
								'type'        => 'string',
								'context'     => array( 'view', 'edit' ),
							),
							'total_tax'        => array(
							...
							'meta_data'        => array(
								...
								'items'       => array(
									...
									'properties' => array(
										...
										'display_value' => array(
											'description' => __( 'Meta value for UI display. May be a string or, when mirroring a complex meta value, an array or object.', 'poocommerce' ),
											'type'        => array( 'null', 'object', 'string', 'number', 'boolean', 'integer', 'array' ),
											'context'     => array( 'view', 'edit' ),
											'readonly'    => true,
										),
				...
				'shipping_lines'       => array(
					...
					'items'       => array(
						...
						'properties' => array(
							...
							'total'        => array(
								'description' => __( 'Shipping total, excluding tax.', 'poocommerce' ),
								'type'        => 'string',
								'context'     => array( 'view', 'edit' ),
							),
							'total_tax'    => array(
								'description' => __( 'Shipping total tax.', 'poocommerce' ),
								'type'        => 'string',
								'context'     => array( 'view', 'edit' ),
								'readonly'    => true,
							),
				...
				'fee_lines'            => array(
					...
					'items'       => array(
						...
						'properties' => array(
							...
							'total'      => array(
								'description' => __( 'Fee total, excluding tax.', 'poocommerce' ),
								'type'        => 'string',
								'context'     => array( 'view', 'edit' ),
							),
							'total_tax'  => array(
								'description' => __( 'Fee total tax.', 'poocommerce' ),
								'type'        => 'string',
								'context'     => array( 'view', 'edit' ),
								'readonly'    => true,
							),
				...
				'refunds'              => array(
					...
					'items'       => array(
						...
						'properties' => array(
							...
							'total'     => array(
								'description' => __( 'Refund total, including tax.', 'poocommerce' ),
								'type'        => 'string',
								'context'     => array( 'view', 'edit' ),
								'readonly'    => true,
							),
							'total_tax' => array(
								'description' => __( 'Refund total tax.', 'poocommerce' ),
								'type'        => 'string',
								'context'     => array( 'view', 'edit' ),
								'readonly'    => true,
							),
