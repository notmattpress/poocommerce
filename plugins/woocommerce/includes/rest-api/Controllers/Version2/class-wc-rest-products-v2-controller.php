...
class WC_REST_Products_V2_Controller extends WC_REST_CRUD_Controller {
	...
	protected function get_hooks_relevant_to_caching( WP_REST_Request $request, ?string $endpoint_id = null ): array { // phpcs:ignore Squiz.Commenting.FunctionComment.IncorrectTypeHint
		return array(
			'poocommerce_rest_prepare_product_object',
			'poocommerce_product_type_query',
			'poocommerce_product_class',
			'poocommerce_short_description',
			'poocommerce_rest_product_object_query',
		);
	}
			...
			array(
				...
				array(
					...
					'args'                => array(
						...
						'image_size' => array(
							'description'       => __( 'Image size to return. Accepts any registered WordPress image size.', 'poocommerce' ),
							'type'              => 'string',
							'default'           => 'full',
