	...
	public function get_pages() {
		...
		foreach ( $check_pages as $page_name => $values ) {
			...
			if ( $values['shortcode'] && $page ) {
				...
				if ( ! $shortcode_present && ( 'poocommerce/checkout' === $values['block'] || 'poocommerce/cart' === $values['block'] ) ) {
					$shortcode_present = has_block( 'poocommerce/classic-shortcode', $page->post_content );
				}
			}
