...
class WC_Customer extends WC_Legacy_Customer {
	...
	public function has_full_shipping_address() {
		 ...
		 */
		if ( apply_filters( 'poocommerce_shipping_calculator_enable_city', true ) ) {
		 ...
		 */
		if ( apply_filters( 'poocommerce_shipping_calculator_enable_state', true ) ) {
		 ...
		 */
		if ( apply_filters( 'poocommerce_shipping_calculator_enable_postcode', true ) ) {
