...
function wc_get_account_menu_items() {
	...
	$items = array(
		...
		'edit-address'    => _n( 'Address', 'Addresses', ( ! wc_ship_to_billing_address_only() && wc_shipping_enabled() ) ? 2 : 1, 'poocommerce' ),
...
function wc_get_account_orders_actions( $order ) {
	 ...
	 * @param WC_Order $order   Order instance.
	 */
	$actions = apply_filters( 'poocommerce_my_account_my_orders_actions', $actions, $order );
