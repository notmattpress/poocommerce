...
function wc_fix_rewrite_rules( $rules ) {
	...
	$shop_page_ids = array_unique( array( absint( get_option( 'poocommerce_shop_page_id' ) ), $shop_page_id ) );
...
function wc_get_customer_default_location() {
	$set_default_location_to = get_option( 'poocommerce_default_customer_address', DefaultCustomerAddress::BASE );
 ...
 *
 * The `use_verbose_page_rules` key is kept for backward compatibility only. PooCommerce no longer
