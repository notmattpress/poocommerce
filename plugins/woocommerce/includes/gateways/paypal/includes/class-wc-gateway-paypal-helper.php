...
class WC_Gateway_Paypal_Helper {
	...
	public static function is_paypal_gateway_available() {
		wc_deprecated_function( __METHOD__, '10.5.0', 'Automattic\PooCommerce\Gateways\PayPal\Helper::is_paypal_gateway_available()' );
	...
	public static function is_orders_v2_migration_eligible() {
		wc_deprecated_function( __METHOD__, '10.5.0', 'Automattic\PooCommerce\Gateways\PayPal\Helper::is_orders_v2_migration_eligible()' );
	...
	public static function get_wc_order_from_paypal_custom_id( $custom_id ) {
		wc_deprecated_function( __METHOD__, '10.5.0', 'Automattic\PooCommerce\Gateways\PayPal\Helper::get_wc_order_from_paypal_custom_id()' );
	...
	public static function redact_data( $data ) {
		wc_deprecated_function( __METHOD__, '10.5.0', 'Automattic\PooCommerce\Gateways\PayPal\Helper::redact_data()' );
	...
	public static function mask_email( $email ) {
		wc_deprecated_function( __METHOD__, '10.5.0', 'Automattic\PooCommerce\Gateways\PayPal\Helper::mask_email()' );
	...
	public static function update_addresses_in_order( ?WC_Order $order, array $paypal_order_details ): void {
		wc_deprecated_function( __METHOD__, '10.5.0', 'Automattic\PooCommerce\Gateways\PayPal\Helper::update_addresses_in_order()' );
