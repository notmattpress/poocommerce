...
$settings = array(
	...
	'paypal_buttons'   => array(
		'title'       => __( 'PayPal Buttons', 'poocommerce' ),
		'type'        => 'checkbox',
		'label'       => __( 'Enable PayPal Buttons', 'poocommerce' ),
		'default'     => 'yes',
		'description' => __( 'Enable PayPal buttons to offer PayPal, Venmo and Pay Later as express checkout options on product, cart, and checkout pages.', 'poocommerce' ),
	),
...
$legacy_settings = array(
	...
	'api_details'           => array(
		...
		'type'        => 'title',
		/* translators: %s: URL */
		'description' => sprintf( __( 'Enter your PayPal API credentials to process refunds via PayPal. Learn how to access your <a href="%s">PayPal API Credentials</a>.', 'poocommerce' ), 'https://developer.paypal.com/api/nvp-soap/apiCredentials/' ),
		'is_legacy'   => true,
	),
	'api_username'          => array(
