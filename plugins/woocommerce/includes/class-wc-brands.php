...
class WC_Brands {
	...
	public function show_brand() {
		...
		$has_block_template = apply_filters( 'poocommerce_has_block_template', false, 'taxonomy-product_brand' ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingHookComment
