...
class WC_Brands {
	...
	public function register_hooks() {
		...
		add_filter( 'poocommerce_structured_data_product', array( $this, 'add_structured_data' ), 20, 2 );
