...
class WC_Product_Variation_Data_Store_CPT extends WC_Product_Data_Store_CPT implements WC_Object_Data_Store_Interface {
	...
	*/
	...
	protected function load_cogs_data( $product ) {
		 ...
		 */
		$cogs_value_overrides_parent = apply_filters( 'poocommerce_load_product_cogs_overrides_parent_value_flag', $cogs_value_overrides_parent, $product );
	...
	public function update_post_meta( &$product, $force = false ) {
		...
		if ( $this->cogs_feature_is_enabled() ) {
			 ...
			 */
			$cogs_value_overrides_parent = apply_filters( 'poocommerce_save_product_cogs_overrides_parent_value_flag', $cogs_value_overrides_parent, $product );
