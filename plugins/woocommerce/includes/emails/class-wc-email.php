...
class WC_Email extends WC_Settings_API {
	...
	public function get_cc_recipient() {
		 ...
		 * @param WC_Email $email  WC_Email instance managing the email.
		 */
		$cc  = apply_filters( 'poocommerce_email_cc_recipient_' . $this->id, $cc, $this->object, $this );
	...
	public function get_bcc_recipient() {
		 ...
		 * @param WC_Email $email  WC_Email instance managing the email.
		 */
		$bcc  = apply_filters( 'poocommerce_email_bcc_recipient_' . $this->id, $bcc, $this->object, $this );
	...
	private function get_block_email_html_content(): ?string {
		...
		$original_footer_filters = isset( $wp_filter['poocommerce_email_footer'] ) ? clone $wp_filter['poocommerce_email_header'] : null;
