...
class WC_Email extends WC_Settings_API {
	...
	public function get_additional_content() {
		 ...
		 */
		return apply_filters( 'poocommerce_email_additional_content_' . $this->id, $this->format_string( $this->get_option( 'additional_content' ) ), $this->object, $this );
	}
	...
	public function get_subject() {
		return apply_filters( 'poocommerce_email_subject_' . $this->id, $this->format_string( $this->get_option( 'subject', $this->get_default_subject() ) ), $this->object, $this );
	}
	...
	public function get_heading() {
		return apply_filters( 'poocommerce_email_heading_' . $this->id, $this->format_string( $this->get_option( 'heading', $this->get_default_heading() ) ), $this->object, $this );
	}
