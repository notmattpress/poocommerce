...
if ( ! class_exists( 'WC_Email_Customer_Fulfillment_Updated', false ) ) :
	...
	class WC_Email_Customer_Fulfillment_Updated extends WC_Email {
		...
		public function __construct() {
			...
			add_action( 'poocommerce_fulfillment_updated_notification', array( $this, 'trigger' ), 10, 4 );
		...
		private function maybe_init_fulfillment_for_preview( $order ) {
			...
			if ( $is_email_preview ) {
				...
				$this->customer_note = __( 'This is a sample note from the store. Your order has been updated with new tracking information.', 'poocommerce' );
			}
		}
	}
