	...
	class WC_Email_Customer_On_Hold_Order extends WC_Email {
		...
		public function __construct() {
			...
			if ( $this->block_email_editor_enabled ) {
				$this->title       = __( 'Order on hold', 'poocommerce' );
				$this->description = __( 'Notifies customers when their order is on hold while the next required step is completed.', 'poocommerce' );
			}
		}
		...
		public function get_default_heading() {
			if ( $this->block_email_editor_enabled ) {
				return __( 'Your order is on hold', 'poocommerce' );
			}
