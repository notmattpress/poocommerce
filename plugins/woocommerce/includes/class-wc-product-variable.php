...
class WC_Product_Variable extends WC_Product {
	...
	*/
	...
	public function get_available_variations( $return = 'array' ) {
		...
		$hide_out_of_stock_items = ( 'yes' === get_option( 'poocommerce_hide_out_of_stock_items' ) );
	...
	public function has_purchasable_variations() {
		 ...
		 * - The transient breaks backward compatibility. The poocommerce_is_purchasable filter from \WC_Product::is_purchasable is used by
