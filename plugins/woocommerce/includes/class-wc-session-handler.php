...
class WC_Session_Handler extends WC_Session {
	...
	public function __construct() {
		 ...
		 */
		$this->_cookie = (string) apply_filters( 'poocommerce_cookie', 'wp_poocommerce_session_' . COOKIEHASH );
	...
	public function init_session_cookie() {
		 ...
		 * however this caused a conflict with PooCommerce Payments session handler which overrides this class.
		 *
		 * Ref: https://github.com/poocommerce/poocommerce/pull/57652
		 * See also: https://github.com/poocommerce/poocommerce/pull/59530
		 */
	...
	private function migrate_guest_session_to_user_session() {
		...
		$this->_data        = (array) apply_filters(
			'poocommerce_migrate_guest_session_to_user_session',
		 ...
		 */
		do_action( 'poocommerce_guest_session_to_user_id', $guest_session_id, $user_session_id );
	}
	...
	private function restore_session_data() {
		 ...
		 */
		$this->_data = (array) apply_filters( 'poocommerce_restored_session_data', $session_data );
	}
	...
	public function maybe_update_nonce_user_logged_out( $uid, $action ) {
		if ( is_string( $action ) && StringUtil::starts_with( $action, 'poocommerce' ) ) {
