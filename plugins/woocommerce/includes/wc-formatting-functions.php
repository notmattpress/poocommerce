...
function wc_price( $price, $args = array() ) {
	...
	if ( $args['in_span'] ) {
		...
		$return          = '<span class="poocommerce-Price-amount amount"' . $aria_hidden . '><bdi class="poocommerce-Price-bidi">' . $formatted_price . '</bdi></span>';
	} else {
...
function wc_format_sale_price( $regular_price, $sale_price ) {
	...
	// Add the sale price.
	$price .= '<ins class="poocommerce-Price-salePrice" aria-hidden="true">' . $formatted_sale_price . '</ins>';
