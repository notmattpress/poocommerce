...
function wc_price( $price, $args = array() ) {
	...
	if ( $args['in_span'] ) {
		$formatted_price = ( $negative ? '-' : '' ) . sprintf( $args['price_format'], '<span class="poocommerce-Price-currencySymbol" translate="no">' . get_poocommerce_currency_symbol( $args['currency'] ) . '</span>', $price );
