		...
		foreach ( $scripts as $handle => $script ) {
			...
			if ( $exists ) {
				wc_deprecated_argument(
					...
					sprintf( __( 'Please use the new handle %1$s in place of the previous handle %2$s.', 'poocommerce' ), $handle, $script['legacy_handle'] )
				);
			}
		}
	}
	...
	public static function get_styles() {
		...
		$styles = apply_filters(
			...
			array(
				...
				'poocommerce-blocktheme'  => wp_is_block_theme() ? array(
