...
function wc_get_product_types() {
	return (array) apply_filters(
		...
		array(
			'simple'   => __( 'Simple product', 'poocommerce' ),
			'grouped'  => __( 'Grouped product', 'poocommerce' ),
			'external' => __( 'External/Affiliate product', 'poocommerce' ),
			'variable' => __( 'Variable product', 'poocommerce' ),
		)
	);
}
