...
class WC_Install {
	...
	public static function enable_customer_stock_notifications_signups() {
		update_option( 'poocommerce_back_in_stock_allow_signups', 'yes' );
	}
...
<div class="wp-block-poocommerce-product-collection"><!-- wp:heading {"textAlign":"left","style":{"spacing":{"margin":{"bottom":"1rem"}}}} -->
<h2 class="wp-block-heading has-text-align-left" style="margin-bottom:1rem">' . __( 'You may be interested in&hellip;', 'poocommerce' ) . '</h2>
