...
- **Product DRI:** _to be confirmed - see [release roles](https://developer.poocommerce.com/docs/contribution/releases/readiness/#release-roles)_
...
- Please read this issue carefully and familiarize yourself with the [release process documentation](https://developer.poocommerce.com/docs/contribution/releases/).
