# PooCommerce {RELEASE_VERSION}-rc.{RC_PATCH_VERSION}
...
Check the [Release Troubleshooting & Recovery](https://developer.poocommerce.com/docs/contribution/releases/troubleshooting/) page for any issues you may encounter.
